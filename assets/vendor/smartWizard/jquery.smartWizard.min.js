        ...
        _createClass(s, [
          ...
          },
          {
            ...
            value: function (i) {
              ...
              return 0 < n.length
                ? n
                : (this.main.children().each(function (t, e) {
                    var s = v(e).children(i);
                    if (0 < s.length) return (n = s), !1;
                  }),
                  0 < n.length
                    ? n
                    : (this._showError("Element not found " + i), !1));
            },
          },
          {
            key: "_setElements",
            value: function () {
              this.main.addClass("sw"),
                ...
                (!0 === this.options.anchorSettings.enableAllAnchors &&
                  !0 === this.options.anchorSettings.anchorClickable) ||
          ...
          },
          {
            ...
            value: function () {
              ...
              this.main.data("click-init", !0),
                v(this.steps).on("click", function (t) {
                  if (
                    (t.preventDefault(),
                    !1 === s.options.anchorSettings.anchorClickable)
                  )
                    return !0;
                  ...
                  return (
                    e === s.current_index ||
                    !(
                      !1 !== s.options.anchorSettings.enableAnchorOnDoneStep ||
                      !s._isDone(e)
                    ) ||
                    void (
                      (!1 === s.options.anchorSettings.enableAllAnchors &&
                        !s._isDone(e)) ||
                      s._showStep(e)
                    )
                  );
                ...
                this.options.keyboardSettings.keyNavigation &&
                  v(document).keyup(function (t) {
                    s._keyNav(t);
                  }),
                this.options.backButtonSupport &&
                  v(window).on("hashchange", function (t) {
            ...
            value: function (t) {
              ...
              return (
                ...
                this.options.toolbarSettings.toolbarExtraButtons &&
                  0 < this.options.toolbarSettings.toolbarExtraButtons.length &&
                  v.each(
                    this.options.toolbarSettings.toolbarExtraButtons,
                    function (t, e) {
                      s.append(e.clone(!0));
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (
                ...
                !1 ===
                  this._triggerEvent("leaveStep", [t, this.current_index, e, i])
              )
                return !1;
              ...
              o
                ? "object" == _typeof(o)
                  ? o
                      ...
                      .catch(function (t) {
                        console.error(t),
                          s._setStepContent(e, t),
                          s._transitStep(e);
                      })
                  : ("string" == typeof o && this._setStepContent(e, o),
                    this._transitStep(e))
                : this._transitStep(e);
            },
          },
          {
            ...
            value: function (t) {
              ...
              this._doStepAnimation(t, function () {
                e._fixHeight(t),
                  e._triggerEvent("showStep", [s, e.current_index, i, n]);
              }),
                (this.current_index = t),
                this._setButtons(t);
            },
              ...
              switch ((this._stopAnimations(), o)) {
                ...
                case "slide-h":
                  var a,
                    ...
                    l = h,
                    u = -2 * h;
                  t > this.current_index && ((l = -1 * h), (u = h)),
                    null == this.current_index &&
                ...
                case "slide-v":
                  var c,
                    ...
                    f = p,
                    _ = -2 * p;
                  t > this.current_index && ((f = -1 * p), (_ = p)),
                    i &&
                      ((c = i.css("position")),
                      (d = i.css("top")),
                      i
              ...
              this._resetCSSClass(this.current_index, "active"),
                !1 !== this.options.anchorSettings.markDoneStep &&
                  ...
                  !1 !==
                    ...
                    "backward" === this._getStepDirection(t) &&
                    this._resetCSSClass(this.current_index, "done")),
                this._resetCSSClass(t, "done"),
                this._setCSSClass(t, "active");
            },
          },
          {
            key: "_setButtons",
              ...
              if (!this.options.cycleSteps)
                switch (
                  ...
                  case "last":
                    ...
                    break;
                  default:
                    !1 === this._getNextShowable(t) &&
                      this.main.find(".sw-btn-next").addClass("disabled"),
                      !1 === this._getPreviousShowable(t) &&
                        this.main.find(".sw-btn-prev").addClass("disabled");
                }
            },
          },
          ...
          },
          {
            ...
            value: function (t) {
              if (
                -1 < v.inArray(t.which, this.options.keyboardSettings.keyLeft)
              )
                ...
                if (
                  !(
                    -1 <
                    v.inArray(t.which, this.options.keyboardSettings.keyRight)
                  )
                )
                  return;
          ...
          },
          {
            ...
            value: function (t, e) {
              var s = v.Event(t);
              return (
                this.main.trigger(s, e), !s.isDefaultPrevented() && s.result
              );
            },
          },
          {
          ...
          },
          {
            key: "setOptions",
            value: function (t) {
              (this.options = v.extend(!0, {}, this.options, t)),
                this._initOptions();
            },
          },
          {
  ...
  v.fn.smartWizard = function (t) {
    if (void 0 === t || "object" === _typeof(t))
      return this.each(function () {
        v.data(this, "smartWizard") ||
          v.data(this, "smartWizard", new s(this, t));
      });
    if ("string" == typeof t && "_" !== t[0] && "init" !== t) {
      var e = v.data(this[0], "smartWizard");
      return (
        "destroy" === t && v.data(this, "smartWizard", null),
