...
(function (root, factory) {
				...
				return (
					...
					(a = function (t) {
						...
						if (3 === t.nodeType) {
							...
							("highlight" !== t.className || "SPAN" !== t.tagName)
						)
		...
		(o.plugins = {}),
			(o.prototype.initializePlugins = function (t) {
				var e,
					...
					s = [];
				if (
					((o.plugins = { names: [], settings: {}, requested: {}, loaded: {} }),
					isArray(t))
				)
					for (e = 0, n = t.length; e < n; e++)
						"string" == typeof t[e]
							? s.push(t[e])
							: ((o.plugins.settings[t[e].name] = t[e].options),
							  s.push(t[e].name));
				else if (t)
					for (i in t)
			...
			(o.prototype.loadPlugin = function (t) {
				...
				(n.requested[t] = !0),
					(n.loaded[t] = i.fn.apply(e, [e.plugins.settings[t] || {}])),
					n.names.push(t);
			}),
	...
	var Sifter = function (t, e) {
		...
		cmp =
					...
					if (((n = escape_regex(s[r])), this.settings.diacritics))
						for (i in DIACRITICS)
							DIACRITICS.hasOwnProperty(i) &&
								(n = n.replace(new RegExp(i, "g"), DIACRITICS[i]));
					e && (n = "\\b" + n),
			...
			(Sifter.prototype.getScoreFunction = function (t, e) {
				function o(t, e) {
					var n;
					return !t || -1 === (n = (t = String(t || "")).search(e.regex))
						? 0
						: ((e = e.string.length / t.length), 0 === n && (e += 0.5), e);
				}
				var s,
			...
			(Sifter.prototype.getSortFunction = function (t, n) {
				...
				if (c)
					for (e = 0, i = c.length; e < i; e++)
						(!t.query && "$score" === c[e].field) || u.push(c[e]);
				if (t.query) {
				...
				for (a = [], e = 0, i = u.length; e < i; e++)
					a.push("desc" === u[e].direction ? -1 : 1);
				return (s = u.length)
					? 1 === s
						? ((o = u[0].field),
						  (r = a[0]),
						...
						: function (t, e) {
								for (var n, i = 0; i < s; i++)
									if (((n = u[i].field), (n = a[i] * cmp(d(n, t), d(n, e)))))
										return n;
								return 0;
						  }
					: null;
			...
			function (t, e) {
				return "number" == typeof t && "number" == typeof e
					...
					: ((t = asciifold(String(t || ""))),
					  (e = asciifold(String(e || ""))) < t ? 1 : t < e ? -1 : 0);
			}),
		extend = function (t, e) {
		...
		asciifold = (function () {
			...
			for (n in DIACRITICS)
				if (DIACRITICS.hasOwnProperty(n))
					for (
						o += i = DIACRITICS[n].substring(2, DIACRITICS[n].length - 1),
							t = 0,
							e = i.length;
						t < e;
						t++
					...
					(t = t || window.event || {}).metaKey ||
						...
						t.type &&
							...
							((i =
								...
								(186 <= o && o <= 222) ||
								32 === o),
							o === KEY_DELETE || o === KEY_BACKSPACE
								? (n = getInputSelection(s[0])).length
									? (e =
											e.substring(0, n.start) + e.substring(n.start + n.length))
									: o === KEY_BACKSPACE && n.start
									? (e = e.substring(0, n.start - 1) + e.substring(n.start + 1))
									: o === KEY_DELETE &&
									  void 0 !== n.start &&
									  (e = e.substring(0, n.start) + e.substring(n.start + 1))
								: i &&
								  ((o = t.shiftKey),
								  (n = String.fromCharCode(t.keyCode)),
								  (e += n = o ? n.toUpperCase() : n.toLowerCase()))),
						(i = s.attr("readonly") ? 0 : 4),
						(o = (t = s.attr("placeholder")) ? measureString(t, s) + i : 0),
						(i = Math.max(measureString(e, s), o) + i) === r) ||
	...
	var Selectize = function (t, e) {
		...
		(o.settings.mode =
			o.settings.mode || (1 === o.settings.maxItems ? "single" : "multi")),
	...
	MicroEvent.mixin(Selectize),
		...
		$.extend(Selectize.prototype, {
			setup: function () {
				var e = this,
					...
					p = $("<div>")
						...
						.addClass(r),
					l = $("<div>")
						.addClass(t.inputClass + l + " selectize-input items")
						.appendTo(p),
					c = $(
					...
					u =
						...
						!e.settings.splitOn &&
							...
							(e.settings.splitOn = new RegExp("\\s*" + a + "+\\s*"))),
						s.attr("autocorrect") &&
						...
						c.on({
							mousedown: function (t) {
								("" === e.$control_input.val() && !e.settings.openOnFocus) ||
									t.stopPropagation();
							},
							keydown: function () {
						...
						o.on("keydown" + n, function (t) {
							(e.isCmdDown = t[IS_MAC ? "metaKey" : "ctrlKey"]),
								(e.isCtrlDown = t[IS_MAC ? "altKey" : "ctrlKey"]),
				...
				s.replaceWith(u),
					...
					Array.isArray(t.items) &&
						((e.lastValidValue = t.items), e.setValue(t.items), delete t.items),
					SUPPORTS_VALIDITY_API &&
				...
				t.settings.render = $.extend(
					{},
					{
						...
						option: function (t, e) {
							...
							return (
								(n +=
									"" === t[o] ? " selectize-dropdown-emptyoptionlabel" : ""),
								"<div" +
			...
			onMouseDown: function (t) {
				...
				if (
					...
					t !== e.$control_input[0] || "" === e.$control_input.val())
				)
					return (
						"single" === e.settings.mode
							...
							: (n || e.setActiveItem(null),
							  e.settings.openOnFocus ||
									(e.isOpen && t === e.lastOpenTarget
										? (e.close(), (e.lastOpenTarget = !1))
										: (e.isOpen || (e.refreshOptions(), e.open()),
										  (e.lastOpenTarget = t)))),
						!1
					);
			},
			...
			onKeyDown: function (t) {
				...
				if (n.isLocked) t.keyCode !== KEY_TAB && t.preventDefault();
					...
					switch (t.keyCode) {
						...
						case KEY_ESC:
							return void (
								n.isOpen && (t.preventDefault(), t.stopPropagation(), n.close())
							);
						case KEY_N:
						...
						case KEY_DOWN:
							return (
								!n.isOpen && n.hasOptions
									...
									: n.$activeOption &&
									  ((n.ignoreHover = !0),
									  (e = n.getAdjacentOption(n.$activeOption, 1)).length) &&
						...
						case KEY_RETURN:
							return void (
								n.isOpen &&
								n.$activeOption &&
								(n.onOptionSelect({ currentTarget: n.$activeOption }),
								t.preventDefault())
							);
						case KEY_LEFT:
			...
			getValue: function () {
				return this.tagType === TAG_SELECT && this.$input.attr("multiple")
					? this.items
						...
						if (
							...
							for (
								a = l.$control.children(".active:last"),
									a = Array.prototype.indexOf.apply(l.$control[0].childNodes, [
										a[0],
									]),
									(o = Array.prototype.indexOf.apply(l.$control[0].childNodes, [
										t[0],
									])) < a && ((r = a), (a = o), (o = r)),
									i = a;
								i <= o;
								...
								(s = l.$control[0].childNodes[i]),
									-1 === l.$activeItems.indexOf(s) &&
										($(s).addClass("active"), l.$activeItems.push(s));
							e.preventDefault();
						} else
				...
				for (
					...
					for (
						...
						g.optgroups.hasOwnProperty(O) ||
							"function" != typeof g.settings.optionGroupRegister ||
							((C = g.settings.optionGroupRegister.apply(g, [O])) &&
								g.registerOptionGroup(C)),
							g.optgroups.hasOwnProperty(O) || (O = ""),
							o.hasOwnProperty(O) ||
								((o[O] = document.createDocumentFragment()), s.push(O)),
							o[O].appendChild(a);
					}
				for (
					...
					g.optgroups.hasOwnProperty((O = s[e])) && o[O].childNodes.length
						? ((c = document.createDocumentFragment()).appendChild(
						  ...
						  p.appendChild(
								g.render(
									"optgroup",
									$.extend({}, g.optgroups[O], { html: domToString(c), dom: c })
								)
						  ))
						: p.appendChild(o[O]);
				if (
							...
							: i.options.hasOwnProperty(s) &&
							  ...
							  ("multi" === o && i.isFull()) ||
									...
									i.isSetup &&
										...
										i.isPending ||
											((e = i.getOption(s)),
											(e = i.getAdjacentOption(e, 1).attr("data-value")),
											i.refreshOptions(i.isFocused && "single" !== o),
											e && i.setActiveOption(i.getOption(e))),
										!n.length || i.isFull()
											? i.close()
				...
				var e =
						"function" == typeof i.settings.create
							...
							: function (t) {
									...
									if (
										...
										"function" != typeof i.settings.formatValueToKey ||
										(null !=
											(t = i.settings.formatValueToKey.apply(this, [t])) &&
											"object" != typeof t &&
											"function" != typeof t)
									)
					...
					r = once(function (t) {
						...
						return (
							...
							!t ||
							"object" != typeof t ||
							"string" != typeof (e = hash_key(t[i.settings.valueField]))
								? s()
								: (i.setTextboxValue(""),
								  i.addOption(t),
								  i.setCaret(o),
			...
			positionDropdown: function () {
				var t = this.$control,
					e =
						"body" === this.settings.dropdownParent ? t.offset() : t.position(),
					n =
						((e.top += t.outerHeight(!0)),
						"fit-content" === this.$wrapper[0].style.width ||
						"body" === this.settings.dropdownParent
							? "max-content"
							: "100%");
				this.settings.minWidth &&
					this.settings.minWidth > n &&
					(n = this.settings.minWidth),
					"body" !== this.settings.dropdownParent &&
						"max-content" === n &&
						t.outerWidth(!0) >= this.$dropdown.outerWidth(!0) &&
						(n = "100%"),
					this.$dropdown.css({
						width: n,
							...
							(n += a.outerHeight(!0)),
								void 0 === a.data("selectable") &&
									(a.hasClass("optgroup-header") &&
										...
										((i = a.marginTop
											? Number(a.marginTop.replace(/\W*(\w)\w*/g, "$1"))
											: 0),
										(o = a.marginBottom
											? Number(a.marginBottom.replace(/\W*(\w)\w*/g, "$1"))
											: 0),
										(s = a.borderTopWidth
											? Number(a.borderTopWidth.replace(/\W*(\w)\w*/g, "$1"))
											: 0)),
									t++);
						}
						t =
							...
							s +
							"px";
					} else if ("fixedHeight" !== this.settings.dropdownSize.sizeType)
			...
			deleteSelection: function (t) {
				...
				if (
					...
					for (
						s = r.$control.children(".active:" + (0 < a ? "last" : "first")),
				...
				0 !== t &&
					...
					s.isFocused && !s.isInputHidden
						? ((i = s.$control_input.val().length),
						  (t < 0 ? 0 !== o.start || 0 !== o.length : o.start !== i) ||
								i ||
								s.advanceCaret(t, e))
			...
			advanceCaret: function (t, e) {
				...
				0 !== t &&
					(i.isShiftDown
						? (n = i.$control_input[0 < t ? "next" : "prev"]()).length &&
			...
			setCaret: function (t) {
				...
				if (
					...
					for (
						var n, i = e.$control.children(":not(input)"), o = 0, s = i.length;
						o < s;
						o++
					)
						(n = $(i[o]).detach()),
							o < t ? e.$control_input.before(n) : e.$control.append(n);
				e.caretPos = t;
			},
			lock: function () {
				...
				var n,
					...
					p = function (t) {
						...
						return (
							"string" == typeof e &&
								e.length &&
								(isJSON(e) ? Object.assign(n, JSON.parse(e)) : (n[e] = e)),
							Object.assign(n, t),
							n || null
						);
					};
			...
			return this.each(function () {
				if (!this.selectize) {
					var t = $(this),
						...
						i =
							...
							v.allowEmptyOption &&
								...
								t.html('<option value="">' + i + "</option>" + l)),
					...
					if ("select" === e) d(t, i);
						...
						if (n)
							for (
								p.options = JSON.parse(n), o = 0, s = p.options.length;
								o < s;
								o++
							)
		...
		Selectize.define("auto_position", function () {
			...
			r.positionDropdown = function () {
				var t = this.$control,
					...
					i =
						i + n + o > window.innerHeight && 0 <= s - n - o ? a.top : a.bottom,
					s =
						"fit-content" === this.$wrapper[0].style.width ||
						"body" === this.settings.dropdownParent
							? "max-content"
							: "100%",
					n = { width: s, minWidth: t.outerWidth(!0), left: e.left };
				i === a.top
					? ((o = { bottom: e.top, top: "unset" }),
					  "body" === this.settings.dropdownParent &&
							((o.top =
								e.top - this.$dropdown.outerHeight(!0) - t.outerHeight(!0)),
							(o.bottom = "unset")),
					  Object.assign(n, o),
					  this.$dropdown.addClass("selectize-position-top"),
					  this.$control.addClass("selectize-position-top"))
					: (Object.assign(n, { top: e.top, bottom: "unset" }),
					...
					function () {
						t.apply(n, arguments),
							...
							("" !== n.getValue() && 0 !== n.getValue().length) ||
								n.$wrapper.find("." + e.className).css("display", "none"),
							n.on("change", function () {
								"" === n.getValue() || 0 === n.getValue().length
									? n.$wrapper.find("." + e.className).css("display", "none")
									: n.$wrapper.find("." + e.className).css("display", "");
							}),
				...
				l =
					...
					(this.onKeyDown =
						...
						function (t) {
							...
							if (
								!this.isOpen ||
								(t.keyCode !== KEY_LEFT && t.keyCode !== KEY_RIGHT)
							)
								return i.apply(this, arguments);
							(a.ignoreHover = !0),
								(e = (n = this.$activeOption.closest("[data-group]"))
									.find("[data-selectable]")
									.index(this.$activeOption)),
								(n = (n = (n =
									t.keyCode === KEY_LEFT
										? n.prev("[data-group]")
										: n.next("[data-group]")).find("[data-selectable]")).eq(
									Math.min(n.length - 1, e)
			...
			(this.setup =
				...
				function () {
					e.apply(this, arguments),
						this.$dropdown.hasClass("read-only") &&
		...
		Selectize.define("remove_button", function (t) {
			...
			"single" !== this.settings.mode &&
				((t = $.extend(
					{ label: "&#xd7;", title: "Remove", className: "remove", append: !0 },
					t
				)),
				(i = s = this),
				(r =
					...
					return (
						...
						setTimeout(function () {
							i.settings.selectOnTab &&
								i.setActiveOption(i.getFirstItemMatchedByTextContent(e)),
