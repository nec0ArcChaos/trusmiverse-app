  ...
  (window.PR_SHOULD_USE_CONTINUATION = !0),
    (function () {
      function t(e) {
            ...
            if (/\\[bdsw]/i.test(a)) s.push(a);
              ...
              o > r + 2 && "-" === n[r + 1]
                ...
                65 > l ||
                  ...
                  (65 > l ||
                    a > 90 ||
                    e.push([32 | Math.max(65, a), 32 | Math.min(l, 90)]),
                  97 > l ||
                    a > 122 ||
                    e.push([-33 & Math.max(97, a), -33 & Math.min(l, 122)]));
            }
          }
          for (
            e.sort(function (e, t) {
            ...
            for (l = 0; r > l; ++l)
              (c = t[l]),
                ...
                c.length >= 2 && "[" === e
                  ? (t[l] = n(c))
                  : "\\" !== e &&
                    (t[l] = c.replace(/[A-Za-z]/g, function (e) {
                      return (
                        (e = e.charCodeAt(0)),
        ...
        for (var s = 0, o = !1, a = !1, l = 0, h = e.length; h > l; ++l) {
          ...
          if (c.ignoreCase) a = !0;
            ...
            /[a-z]/i.test(
              c.source.replace(/\\u[\da-f]{4}|\\x[\da-f]{2}|\\[^UXux]/gi, "")
            )
          ) {
            (o = !0), (a = !1);
            break;
        ...
        for (
          var u = { b: 8, t: 9, n: 10, v: 11, f: 12, r: 13 },
            d = [],
            l = 0,
            h = e.length;
          h > l;
      ...
      function s(i, r) {
          ...
          for (
            ...
            if (((b = c), (c += g.length), m)) {
              ...
              v[2] && ((x = g.length - v[2].length), (L = x - m.length)),
                (y = y.substring(5)),
                n(t + b, g.substring(0, L), s, i),
                n(t + b + L, m, h(y, m), i),
                n(t + b + x, g.substring(x), s, i);
            } else i.push(t + b, y);
          }
          e.g = i;
        }
        ...
        (function () {
          for (
            var n = i.concat(r), s = [], l = {}, h = 0, c = n.length;
            c > h;
            ++h
          ) {
            var u = n[h],
      ...
      function a(e, t, i) {
          ...
          if (1 != t || s.test(e.className)) {
            if ((3 == t || 4 == t) && i) {
              var l = e.nodeValue,
                h = l.match(o);
              h &&
                ((t = l.substring(0, h.index)),
                (e.nodeValue = t),
                (l = l.substring(h.index + h[0].length)) &&
                  e.parentNode.insertBefore(a.createTextNode(l), e.nextSibling),
                r(e),
        ...
        function r(e) {
          ...
          for (
            var i, e = t(e.nextSibling, 0);
            (i = e.parentNode) && 1 === i.nodeType;
        ...
        for (
          var t = Math.max(0, 0 | (t - 1)) || 0, c = 0, d = h.length;
          d > c;
          ++c
        )
          (l = h[c]),
              ...
              if (1 !== O.nodeType && (C = o.substring(n, b))) {
                ...
                k.replaceChild(E, O),
                  ...
                  w > n &&
                    ...
                    k.insertBefore(O, E.nextSibling));
              }
              (n = b), n >= w && (r += 2), n >= S && (f += 2);
            }
          } finally {
      ...
      l(C, ["default-code"]),
        ...
        l(s([], [["atv", /^[\S\s]+/]]), ["uq.val"]),
        l(o({ keywords: f, hashComments: !0, cStyleComments: !0, types: L }), [
          "c",
          "cc",
          "cpp",
          "cxx",
        ...
        l(o({ keywords: "null,true,false" }), ["json"]),
        l(
          o({
            keywords: g,
            hashComments: !0,
        ...
        l(o({ keywords: m, cStyleComments: !0 }), ["java"]),
        l(o({ keywords: d, hashComments: !0, multiLineStrings: !0 }), [
          "bash",
          "bsh",
          "csh",
          "sh",
        ...
        l(o({ keywords: p, cStyleComments: !0, regexLiterals: !0 }), [
          "javascript",
          "js",
        ]),
        l(
        ...
        l(o({ keywords: b, cStyleComments: !0, multilineStrings: !0 }), [
          "rc",
          "rs",
          "rust",
        ]),
      ...
      var S = (u.PR = {
        ...
        prettyPrint: (u.prettyPrint = function (t, i) {
          function n() {
            for (
              var i = u.PR_SHOULD_USE_CONTINUATION ? f.now() + 250 : 1 / 0;
              l.length > g && i > f.now();
              g++
            ) {
              for (var s = l[g], h = w, d = s; (d = d.previousSibling); ) {
                ...
                if (
                  S
                    ? !/^\??prettify\b/.test(S)
                    : 3 !== p || /\S/.test(d.nodeValue)
                )
                  break;
                if (S) {
                  (h = {}),
                    S.replace(/\b(\w+)=([\w%+\-.:]+)/g, function (e, t, i) {
                      h[t] = i;
                    });
                  break;
                }
                ...
                if (!p) {
                  if (((s.className += " prettyprinted"), (p = h.lang), !p)) {
                    ...
                    !p &&
                      (O = r(s)) &&
                      x.test(O.tagName) &&
                      (p = O.className.match(y)),
                      p && (p = p[1]);
                  }
                  if (L.test(s.tagName)) S = 1;
                  else
                    var S = s.currentStyle,
                      _ = o.defaultView,
                      S =
                        (S = S
                          ? S.whiteSpace
                          : _ && _.getComputedStyle
                          ? _.getComputedStyle(s, e).getPropertyValue(
                              "white-space"
                            )
                          : 0) && "pre" === S.substring(0, 3);
                  (_ = h.linenums),
                    (_ = "true" === _ || +_) ||
                      (_ = (_ = d.match(/\blinenums\b(?::(\d+))?/))
                        ? _[1] && _[1].length
                          ? +_[1]
                          : !0
                        : !1),
