...
`), i) { let { newlinesToAppend: l, newlinesToPrepend: c } = W(o); s += l.length, a = s + r.length, r = l + r + c } return { text: r, selectionStart: s, selectionEnd: a }
    } function re(o) {
        let e = o.split(`
`), t = /^\d+\.\s+/, n = e.every(r => t.test(r)), i = e; return n && (i = e.map(r => r.replace(t, ""))), {
            text: i.join(`
`), processed: n
        }
    } function se(o) {
        let e = o.split(`
`), t = "- ", n = e.every(r => r.startsWith(t)), i = e; return n && (i = e.map(r => r.slice(t.length))), {
            text: i.join(`
`), processed: n
        }
    } function j(o, e) { return e ? "- " : `${o + 1}. ` } function Xe(o, e) { let t, n, i; return o.orderedList ? (t = re(e), n = se(t.text), i = n.text) : (t = se(e), n = re(t.text), i = n.text), [t, n, i] } function Ye(o, e) {
        let t = o.selectionStart === o.selectionEnd, n = o.selectionStart, i = o.selectionEnd; le(o); let r = o.value.slice(o.selectionStart, o.selectionEnd), [s, a, p] = Xe(e, r), d = p.split(`
