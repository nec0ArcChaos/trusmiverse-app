    ...
    _createClass(n, [
      {
        ...
        value: function () {
          (this.p.f = document.createElement("div")),
            ...
            (this.p.d.innerHTML = '<button class="sl-prev">'
              .concat(
      ...
      },
      {
        ...
        value: function () {
          ...
          o.addEventListener("load", function (t) {
            ...
            o.setAttribute(
              "src",
              this.elements[e].getAttribute(this.options.sourceAttr)
            ),
            a.addEventListener("load", function (t) {
              var e = t.target.getAttribute("src");
              -1 === i.q.indexOf(e) && i.q.push(e),
                i.elements[n].dispatchEvent(
                  new Event("prevImageLoaded." + i.o)
                );
            }),
            a.setAttribute(
              "src",
              this.elements[s].getAttribute(this.options.sourceAttr)
            );
        },
      },
      {
        ...
        value: function (e) {
          var i = this;
          this.elements[this.nIndex].dispatchEvent(
            new Event("change." + this.o)
          ),
            this.elements[this.nIndex].dispatchEvent(
              new Event((1 === e ? "next" : "prev") + "." + this.o)
            );
          var t = this.nIndex + e;
          if (
            this.h ||
            ((t < 0 || t >= this.elements.length) && !1 === this.options.loop)
          )
            return !1;
          (this.nIndex =
            t < 0
              ...
              (i.h = !0),
                setTimeout(function () {
                  ...
                  i.n.setAttribute("src", t.getAttribute(i.options.sourceAttr)),
                    -1 === i.q.indexOf(t.getAttribute(i.options.sourceAttr)) &&
                      i.show(i.p.e),
        ...
        value: function (a) {
          ...
          t.setAttribute("src", this.n.getAttribute("src")),
            ...
            t.addEventListener("load", function (t) {
              void 0 !== a &&
                (r.elements[r.nIndex].dispatchEvent(
              ...
              var s,
                o =
                  "self" === r.options.captionSelector
                    ? r.elements[r.nIndex]
                    : r.elements[r.nIndex].querySelector(
              ...
              (s =
                ...
                r.options.loop ||
                  (0 === r.nIndex && r.hide(r.p.d.querySelector(".sl-prev")),
                  r.nIndex >= r.elements.length - 1 &&
                    r.hide(r.p.d.querySelector(".sl-next")),
                  0 < r.nIndex && r.show(r.p.d.querySelector(".sl-prev")),
                  r.nIndex < r.elements.length - 1 &&
                    r.show(r.p.d.querySelector(".sl-next"))),
                1 === r.elements.length &&
                  r.hide(r.p.d.querySelectorAll(".sl-prev, .sl-next")),
                1 === a || -1 === a
      ...
      },
      {
        ...
        value: function (t, e) {
          ...
          try {
            for (
              var o, a = this.elements[Symbol.iterator]();
              !(i = (o = a.next()).done);
              i = !0
            ) {
              var r = o.value;
      ...
      },
      {
        ...
        value: function (t) {
          ...
          try {
            for (
              var s, o = this.elements[Symbol.iterator]();
              !(e = (s = o.next()).done);
              e = !0
            ) {
              var a = s.value,
              ...
              try {
                for (
                  ...
                  var p = v.value;
                  p in a.fullyNamespacedEvents &&
                    a.removeEventListener(p, a.fullyNamespacedEvents[p]);
                }
              } catch (t) {
                (l = !0), (h = t);
              } finally {
