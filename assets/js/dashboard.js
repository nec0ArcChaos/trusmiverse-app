...
$(window).on("load", function () {
  ...
  //       description:
  //         "All the accessible pages should go with this beautifully designed sidebar with two level collapse menu.",
  ...
  //       description:
  //         "Start typing and see result UI with categories. Secondary menu helps to access all other secondary level pages.",
  ...
  //       description:
  //         "There are lot of actions which we thought are small but requires to access it first. Other are global actions like notification, chat. should be kept here.",
  ...
  //       description:
  //         "Mostly in Admin, Dashboard, Analytical app user needs to customize date range, filter data at a priority. Also you can change theme colors by clicking on palette icon.",
