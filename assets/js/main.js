...
$(document).ready(function () {
  ...
  if (header.length > 0) {
    $(".mainheight").css({
      "min-height": Number(maincontentheight - header.outerHeight() - 10),
      "margin-top": header.outerHeight() + 10,
    });
  ...
  if (footer.length > 0) {
    $(".mainheight").css(
      "min-height",
      Number(maincontentheight - footer.outerHeight() - 10)
    );
...
$(window).on("load", function () {
  ...
  if (header.length > 0 && footer.length > 0) {
    setTimeout(function () {
      $(".mainheight").css({
        "min-height":
          maincontentheight - header.outerHeight() - footer.outerHeight() - 10,
      });
    }, 100);
  }
...
function menuclosetablet() {
  if ($(window).width() <= 992) {
    setTimeout(function () {
      if (
        body.hasClass("sidebar-fullscreen") != true &&
        body.hasClass("sidebar-overlay") != true
      ) {
        body.addClass("menu-close");
      }
    }, 1000);
