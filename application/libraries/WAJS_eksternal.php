...
class WAJS_eksternal
{
    ...
    public function __construct()
    {
        ...
        // Load model
        $this->CI->load->model('Model_wajs_notif_eksternal', 'model_wajs_notif_library_eksternal');
    }


    // 7-10-25 lutfiambar
    public function send_wajs_notif_eksternal($contact_number = '', $msg = '', $type = '', $domain = '', $url_image = '')
    {
        ...
        $id_log = $this->CI->model_wajs_notif_library_eksternal->insert_log($data);
        $mpm    = $this->CI->model_wajs_notif_library_eksternal->check_mpm();
