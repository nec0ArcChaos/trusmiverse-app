            ...
            <div class="card border-0">
                <div class="card-header">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-auto ms-auto ps-0">
                            <button type="button" class="btn btn-md btn-outline-info mb-1" onclick="list_plan_mom()"><i class="bi bi-bookmark-star"></i> List Plan MoM</button>
                            <button type="button" class="btn btn-md btn-outline-success mb-1" onclick="add_plan_mom()"><i class="bi bi-journal-plus"></i> Add Plan MoM</button>
                            <button type="button" class="btn btn-md btn-outline-warning mb-1" onclick="list_draft()"><i class="bi bi-bookmark-star"></i> List Draft</button>
                            <button type="button" class="btn btn-md btn-outline-theme mb-1" onclick="add_mom()"><i class="bi bi-journal-plus"></i> Add Notulen</button>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                                    ...
                                                    <table id="dt_mom_result" class="table table-bordered" style="width:100%">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th width="40%" colspan="2">Strategy</th>
...
<!-- Modal Add Plan MoM -->
<div class="modal fade" id="modal_add_plan_mom" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content" style="overflow-y: auto;">
            <div class="modal-header row align-items-center bg-theme">
                                        ...
                                        <div class="col-12 col-md-6 mb-2">
                                            <div class="form-group mb-3 position-relative check-valid tgl_plan">
                                                <div class="input-group input-group-lg">
                                                    <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-calendar-event"></i></span>
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control border-start-0 bg-white" name="tanggal_plan" id="tanggal_plan" placeholder="Date" readonly>
                                                        <label><i class="bi bi-info-circle" title="Date from Created At (Auto Today)"></i> Date (Today)<b class="text-danger small">*</b></label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12 mb-2">
                                            <div class="form-group mb-3 position-relative check-valid note_plan">
                                                <div class="input-group input-group-lg">
                                                    <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-align-top"></i></span>
                                                    <div class="form-floating">
                                                        <textarea type="text" cols="30" rows="10" class="form-control border-start-0" name="note_plan" id="note_plan" placeholder="Note">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-md btn-outline-success" style="margin-right:10px;" id="btn_save_plan" onclick="save_plan()">Save</button>
                    <button type="button" class="btn btn-md btn-outline-secondary" data-bs-dismiss="modal">Close</button>
                </div>
        </div>
    </div>
