        ...
        <?php foreach ($issue as $key) : ?>
          <table width="100%" class="table table-striped" style="margin-top: 8px;">
            ...
            <tr>
              ...
              <?php if ($item->id_kategori == 1 || $item->id_kategori == 6) { ?>
              ...
              <td align="center">
                <span class="info-data">
                  <?php if ( $item->id_status == 1 && ($item->id_kategori == 1 || $item->id_kategori == 6) ) { ?>
                  ...
                  <?php } else if ( $item->id_status == 2 && ($item->id_kategori == 1 || $item->id_kategori == 6) ) { ?>
                  ...
                  <?php } else if($item->id_kategori == 1 || $item->id_kategori == 6) { ?>
