<style>
    ...
    .rc-nav-tabs .nav-link.active {
        color: var(--rc-teal);
        border-bottom-color: var(--rc-teal);
        background: transparent;
    }

    .rc-nav-tabs .nav-link:hover {
        color: var(--rc-teal);
    }
    ...
    .rc-tooltip-detail .rc-tooltip-row:last-child {
        border-bottom: none;
    }

    .rc-tooltip-detail .rc-tooltip-job {
        font-weight: 600;
        color: var(--rc-text);
        flex: 1;
    }

    .rc-tooltip-detail .rc-tooltip-dept {
        color: var(--rc-text-muted);
        font-size: 10px;
    }
