            ...
            <div class="card border-0">
                        ...
                        <div class="col-3">
                            ...
                            <div class="col-auto">
                                ...
                                <div class="col-auto align-self-center">
                                    <h6 class="fw-medium">List Masa Kerja</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-3"></div>
                            ...
                            <div class="row">
                                <div class="col ps-0">
                                    <div class="row">
                                            ...
                                            <div class="form-group mb-3 position-relative check-valid">
                                                <div class="input-group input-group-lg">
                                                    ...
                                                    <div class="form-floating">
                                                        <select class="form-select border-0" id="filter_by" onchange="select_filter()">
                                        ...
                                        <div class="col filter_bulan">
                                            <div class="form-group mb-3 position-relative check-valid">
                                                <div class="input-group input-group-lg">
                                                    <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-calendar-range"></i></span>
                                                    <div class="form-floating">
                                                        <input id="bulan_start" type="number" placeholder="Bulan" value="1" class="form-control border-start-0">
                                                        <label>Bulan</label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col filter_bulan">
                                            <div class="form-group mb-3 position-relative check-valid">
                                                <div class="input-group input-group-lg">
                                                    <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-calendar-range"></i></span>
                                                    <div class="form-floating">
                                                        <input id="bulan_end" type="number" placeholder="Bulan" value="3" class="form-control border-start-0">
                                                        <label>Bulan</label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col filter_date" style="display:none; width:600px;">
                                            <div class="form-group mb-2 position-relative check-valid">
                                                <div class="input-group input-group-lg">
                                                    ...
                                                    <div class="form-floating reportrange">
                                        ...
                                        <div class="col" style="padding-top:15px;">
                                                <button class="btn btn-theme" onclick="show_filter()">
                                                    Show
                ...
                <div class="card-body">
                    <div class="table-responsive" style="padding: 10px;">
                        <table id="dt_list_masa_kerja" class="table table-sm table-striped" style="width:100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>NIP</th>
                                    ...
                                    <th>Remaining</th>
                                    <th>Work Periode</th>
                                    <th>Status Perpanjang <i class=""></i></th>
                                    <th>Lama Perpanjang</th>
                                    <th>Alasan</th>
                                    <th>Perpanjang Oleh</th>
                                </tr>
                            </thead>
                            <tbody></tbody>
