<!-- <div class="card border border-warning bg-light-warning rounded-3 shadow-none">
    <div class="card-body bg-none">
        ...
        <div class="input-group">
            <textarea class="form-control" placeholder="Tanyakan sesuatu..." rows="1" style="resize: none;"></textarea>
            <button class="btn btn-secondary"><i class="bi bi-send-fill fs-5"></i></button>
        </div>
...
<div class="card border border-warning bg-light-warning rounded-3 shadow-none">
    <div class="card-body bg-none">
        <h5 class="fw-bold mb-3"><i class="bi bi-stars me-2"></i> LARAS AI</h5>
