...
<body class="d-flex flex-column h-100 sidebar-pushcontent" data-sidebarstyle="sidebar-pushcontent">
    ...
    <div class="coverimg h-100 w-100 top-0 start-0 position-absolute">
        <img src="<?= base_url() ?>assets/img/404-2.jpg" alt="" />
    </div>
    <!-- background ends  -->
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12 col-md-8 col-lg-7 col-xl-6 col-xxl-4">
                                <div class="position-relative z-index-1">
                                    <img src="<?= base_url() ?>assets/img/404-1.png" alt="" class="mw-400" />
                                </div>
                                <h1 class="error404 mb-4 mtop-100 position-relative text-red">404</h1>

                                <div class="z-index-1 position-relative">
                                    <h1 class="display-5 top-50">Task not found</h1>
                                    <p class="h4 fw-light mb-4">Its looks like you are landed on wrong planet.</p>
                                    <p class="text-secondary mb-4">Kindly check URL, Report us a brocken link or Try after sometime. Go back to "Home" all the other things are working fine and you can continue with your tasks.</p>


                                    <a href="<?= base_url() ?>" class="btn btn-lg btn-theme z-index-5 mb-2"><i class="bi bi-arrow-left"></i> Go back to Home </a>
                                    <!-- <p class="small text-secondary">Don't take it seriously,<br>we just mean with this project "Home" page.</p> -->

                                    <!-- <p class="text-secondary mt-3 mt-lg-4">Stay tuned with us</p> -->
