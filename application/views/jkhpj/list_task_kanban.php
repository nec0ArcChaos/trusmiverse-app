<main class="main mainheight">
    ...
    <input type="hidden" id="kanban_id_task" value="<?= $id_task; ?>">
        ...
        <div class="row flex-nowrap wrapper mt-3">
            ...
            <div class="col-12 col-md-6 col-lg-6 mb-3">
                <div class="card kanban-card">
                    <div class="card-header" style="background-color: #ffc107; color: white;">
                        <h6 class="mb-0">Undone</h6>
                    </div>
                    <div class="card-body kanban-body" id="kolom_belum" style="min-height: 500px;">
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-6 mb-3">
                <div class="card kanban-card">
                    ...
                    <div class="card-body kanban-body" id="kolom_sudah" style="min-height: 500px;">
                    </div>
                </div>
            </div>
