...
<style>
    /* Batasi lebar kolom PIC */
    /* #dt_review_all th:nth-child(5),
        #dt_review_all td:nth-child(5),
        #dt_review_all th:nth-child(6),
        #dt_review_all td:nth-child(6) {
            max-width: 500px;
    ...
    /* Pastikan teks di dalam child row wrap */
    ...
    /* biar Select2 tetep sesuai style HTML */
    #selectKaryawan+.select2-container .select2-selection {
    ...
    #selectKaryawan+.select2-container .select2-selection__arrow {
        top: 6px;
        /* supaya arrow sejajar */
    }

    #selectKaryawan_keluar+.select2-container .select2-selection {
        border: 2px solid #6c63ff !important;
        border-radius: 10px !important;
        padding: 8px 12px !important;
        font-size: 14px !important;
    ...
    #selectKaryawan_keluar+.select2-container .select2-selection__arrow {
        top: 6px;
        /* supaya arrow sejajar */
    }
