...
<script type="text/javascript">
  ...
  function add_mom() {
    ...
    $.ajax({
      url: "<?= base_url('mom_khael/clear_result'); ?>",
      method: "GET",
      dataType: "JSON",
      success: function(res) {
  ...
  function submit_update(id) {
    ...
    if (input[0] == "topik") {
      ...
      $.ajax({
          url: '<?php echo base_url() ?>mom_khael/save_goals',
          type: 'POST',
          dataType: 'json',
          data: {
            id_mom: id_mom,
  ...
  function detail_rekap(user_id, tipe) {
    ...
    tipe_deadline = ['1', '5', '6', '8', '9', '10', '30', '40', '50', '60', '70', '80', 'w1', 'w2', 'w3', 'w4', 'w5'];
  ...
  function get_issue_result(id_mom) {
    ...
    $.confirm({
      ...
      onOpen: function() {
        $.ajax({
            url: '<?php echo base_url() ?>mom_khael/get_issue_result/' + id_mom,
            type: 'GET',
            dataType: 'JSON',
            cache: false,
          })
