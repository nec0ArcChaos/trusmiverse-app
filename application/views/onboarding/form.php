                                    ...
                                    <ul class="nav nav-fill">
                                        <li class="nav-item">
                                            <a class="nav-link inactive active" href="#step-0">
                                                <div class="avatar avatar-40 d-none d-md-inline-block rounded-circle mb-1">
                                    ...
                                    <div class="tab-content mb-4">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-md-6 align-self-center py-4">
                                                            ...
                                                            <p class="text-secondary small mb-4" style="text-align: justify;">
                                                                &nbsp;&nbsp;&nbsp;
                                                                Kepada Saudara/i karyawan yang baru bergabung, <b>Selamat Datang di Trusmi Group. </b>
                                                                <br>
                                                                Kami ingin mengajak Saudara/i untuk melengkapi dokumen-dokumen yang diperlukan untuk <b>memverifikasi data</b> pada inputan Form Registrasi Calon Karyawan.

                                                                Proses ini tidak hanya membantu kami memperoleh informasi yang penting, tetapi juga menunjukkan komitmen Saudara/i terhadap standar perfesionalisme yang tinggi.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div id="step-1" class="tab-pane" role="tabpanel" style="display: none;">
                                            <div class="card border-0">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-6">
                                                            <label for="nama" class="form-label-custom">Nama
                                                                Karyawan</label>
                                                            <input type="text" class="form-control border-custom" id="nama" value="<?= $karyawan['full_name'] ?>" accept="image/*" data-max-files="1" required readonly>
                                                            <input type="hidden" id="type_sales" value="<?= $karyawan['sales_type'] ?>">


                                                        </div>

                                                        <div class=" col-6">
                                                            <label for="departemen" class="form-label-custom">Designation</label>
                                                            <input type="text" class="form-control border-custom" id="departemen" value="<?= $karyawan['designation_name'] ?>" accept="image/*" data-max-files="1" required readonly>

                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                        <div class="col-12">
                                                            <label for="ktp" class="form-label-custom required">KTP</label>
                                                            <?php if ($karyawan['ktp_status'] == null || $karyawan['ktp_status'] == 1) : ?>

                                                                <input type="file" class="form-control border-custom" id="ktp" accept="image/*" data-max-files="1" name="ktp" onchange="cek_file_image('ktp')">
                                                            <?php else : ?>
                                                                ...
                                                                <input type="file" class="form-control border-custom" id="ktp" accept="image/*" data-max-files="1" name="ktp" disabled>
                                                            <?php endif; ?>
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class=" col-12">
                                                            ...
                                                            <?php if ($karyawan['kk_status'] == null || $karyawan['kk_status'] == 1) : ?>
                                                                <input type="file" class="form-control border-custom" id="kk" accept="image/*" data-max-files="1" name="kk" onchange="cek_file_image('kk')">
                                                            <?php else : ?>
                                                                ...
                                                                <input type="file" class="form-control border-custom" id="kk" accept="image/*" data-max-files="1" name="kk" disabled>
                                                            <?php endif; ?>
                                                    ...
                                                    <div class=" row mb-3">
                                                        <div class="col-12">
                                                            <label for="lamaran" class="form-label-custom  <?= ($karyawan['sales_type'] == 'Sales Freelance') ? '' : 'required' ?>">Surat Lamaran</label>
                                                            <?php if ($karyawan['lamaran_status'] == null || $karyawan['lamaran_status'] == 1) : ?>
                                                                <input type="file" class="form-control border-custom" id="lamaran" accept="image/*" data-max-files="1" name="lamaran" onchange="cek_file_image('lamaran')">
                                                            <?php else : ?>
                                                                <small class="text-primary" id="label_lamaran">
                                                                    <li class="fa fa-check-circle"></li>
                                                                    <?= $karyawan['lamaran'] ?>&nbsp;&nbsp;&nbsp;
                                                                </small>
                                                                <input type="file" class="form-control border-custom" id="lamaran" accept="image/*" data-max-files="1" name="lamaran" disabled>
                                                            <?php endif; ?>
                                                            <div class="valid-feedback">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-12">
                                                            <label for="cv" class="form-label-custom <?= ($karyawan['sales_type'] == 'Sales Freelance') ? '' : 'required' ?>">CV</label>
                                                            <?php if ($karyawan['cv_status'] == null || $karyawan['cv_status'] == 1) : ?>
                                                                <input type="file" class="form-control border-custom" id="cv" accept="image/*" data-max-files="1" name="cv" onchange="cek_file_image('cv')">
                                                            <?php else : ?>
                                                                <small class="text-primary" id="label_cv">
                                                                    <li class="fa fa-check-circle"></li>
                                                                    <?= $karyawan['cv'] ?>&nbsp;&nbsp;&nbsp;
                                                                </small>
                                                                <input type="file" class="form-control border-custom" id="cv" accept="image/*" data-max-files="1" name="cv" disabled>
                                                            <?php endif; ?>
                                                            <div class="valid-feedback">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-12">
                                                            <label for="ijazah" class="form-label-custom <?= ($karyawan['sales_type'] == 'Sales Freelance') ? '' : 'required' ?>">Ijazah</label>
                                                            <?php if ($karyawan['ijazah_status'] == null || $karyawan['ijazah_status'] == 1) : ?>
                                                                <input type="file" class="form-control border-custom" id="ijazah" accept="image/*" data-max-files="1" name="ijazah" onchange="cek_file_image('ijazah')">
                                                            <?php else : ?>
                                                                <small class="text-primary" id="label_ijazah">
                                                                    <li class="fa fa-check-circle"></li>
                                                                    <?= $karyawan['ijazah'] ?>&nbsp;&nbsp;&nbsp;
                                                                </small>
                                                                <input type="file" class="form-control border-custom" id="ijazah" accept="image/*" data-max-files="1" name="ijazah" disabled>
                                                            <?php endif; ?>
                                                            <div class="valid-feedback">
                                                    ...
                                                    <?php if ($karyawan['designation_id'] == '731') : ?>
                                                        <div class="row mb-3">
                                                            <div class="col-12">
                                                                ...
                                                                <span class="small" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-content="Export kontak Anda dengan cara : buka Aplikasi <b>Kontak</b> HP anda <b>Setting > Export Kontak > Pilih ke Memori Internal</b> Anda. Setelah mengekspor, unggah file .vcf di sini.">
                                                                    <i class="fa fa-circle-info text-secondary"></i> Help
                                                                </span>

                                                                <?php if ($karyawan['contact'] == null) : ?>
                                                                    <!-- Jika belum ada kontak yang diunggah -->
                                                                    <input type="file" class="form-control border-custom" id="kontak" accept=".vcf" data-max-files="1" name="kontak">
                                                                    <small>Hanya digunakan sebagai keperluan perusahaan dan tidak akan disalahgunakan.</small>
                                                                ...
                                                                <?php else : ?>
                                                                    ...
                                                                    <input type="file" class="form-control border-custom" id="kontak" accept=".vcf" data-max-files="1" name="kontak" disabled>
                                                                <?php endif; ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <small class="text-danger">* Wajib di isi (.jpg | .png)</small>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div id="step-2" class="tab-pane" role="tabpanel" style="display: none;">
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-12">
                                                        ...
                                                        <?php if ($karyawan['transkip_status'] == null || $karyawan['transkip_status'] == 1) : ?>
                                                            <input type="file" class="form-control border-custom" id="transkip" accept="image/*" data-max-files="1" name="transkip" onchange="cek_file_image('transkip')">
                                                        <?php else : ?>
                                                            ...
                                                            <input type="file" class="form-control border-custom" id="transkip" accept="image/*" data-max-files="1" name="transkip" disabled>
                                                        <?php endif; ?>
                                                ...
                                                <div class="row mb-3">
                                                    <div class=" col-12">
                                                        ...
                                                        <?php if ($karyawan['npwp_status'] == null || $karyawan['npwp_status'] == 1) : ?>
                                                            <input type="file" class="form-control border-custom" id="npwp" accept="image/*" data-max-files="1" name="npwp" onchange="cek_file_image('npwp')">
                                                        <?php else : ?>
                                                            ...
                                                            <input type="file" class="form-control border-custom" id="npwp" accept="image/*" data-max-files="1" name="npwp" disabled>
                                                        <?php endif; ?>
                                                        <div class="valid-feedback">
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-12">
                                                        ...
                                                        <?php if ($karyawan['surat_lulus_status'] == null || $karyawan['surat_lulus_status'] == 1) : ?>
                                                            <input type="file" class="form-control border-custom" id="surat_lulus" accept="image/*" data-max-files="1" name="surat_lulus" onchange="cek_file_image('surat_lulus')">
                                                        <?php else : ?>
                                                            ...
                                                            <input type="file" class="form-control border-custom" id="surat_lulus" accept="image/*" data-max-files="1" name="surat_lulus" disabled>
                                                        <?php endif; ?>
                                                        <div class="valid-feedback">
                                                ...
                                                <div class="row mb-3">
                                                    <div class=" col-12">
                                                        <label for="Sertifikat" class="form-label-custom">Sertifikat</label>
                                                        <?php if ($karyawan['sertifikat_status'] == null || $karyawan['sertifikat_status'] == 1) : ?>
                                                            <input type="file" class="form-control border-custom" id="sertifikat" accept="image/*" data-max-files="1" name="sertifikat" onchange="cek_file_image('sertifikat')">
                                                        <?php else : ?>
                                                            ...
                                                            <input type="file" class="form-control border-custom" id="sertifikat" accept="image/*" data-max-files="1" name="sertifikat" disabled>
                                                        <?php endif; ?>
                                                        <div class="valid-feedback">
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-12">
                                                        <label for="verklaring" class="form-label-custom">Paklaring</label>
                                                        <?php if ($karyawan['verklaring_status'] == null || $karyawan['verklaring_status'] == 1) : ?>
                                                            <input type="file" class="form-control border-custom" id="verklaring" accept="image/*" data-max-files="1" name="verklaring" onchange="cek_file_image('verklaring')">
                                                        <?php else : ?>
                                                            ...
                                                            <input type="file" class="form-control border-custom" id="verklaring" accept="image/*" data-max-files="1" name="verklaring" disabled>
                                                        <?php endif; ?>
                                                        <div class="valid-feedback">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-12">
                                                        ...
                                                        <?php if ($karyawan['dokumen_lain_status'] == null || $karyawan['dokumen_lain_status'] == 1) : ?>
                                                            <input type="file" class="form-control border-custom" id="dokumen_lain" accept="image/*" data-max-files="1" name="dokumen_lain" onchange="cek_file_image('dokumen_lain')">
                                                        <?php else : ?>
                                                            ...
                                                            <input type="file" class="form-control border-custom" id="dokumen_lain" accept="image/*" data-max-files="1" name="dokumen_lain" disabled>
                                                        <?php endif; ?>
                                                        <div class="valid-feedback">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-center">
                                                        <div class="col-10 py-2">
                                                            <p><strong>Terimakasih</strong> atas partisipasi dan waktu yang sudah Saudara/i luangkan untuk mengisi Formulir Dokumen Karyawan. Hal tersebut menggambarkan komitmen dan minat Saudara/i untuk menjadi bagian dari tim kami.</p>
                                                            <br>
                                                            <br>
                                                                ...
                                                                <div class="confirm">
                                                                    ...
                                                                    <div class="form-check" style="cursor: pointer;">
                                                                        ...
                                                                        <label class="form-check-label" for="checkSyarat">
                                                                            Dengan ini saya menyatakan bahwa data dan keterangan
                                                                            di atas
                                                                    ...
                                                                    <div class="d-flex justify-content-center mt-4">
                                                                        <button class="btn btn-block btn-success text-white" id="btn-submit-form" type="button" disabled>Submit
                                                                            Formulir</button>
                                                                    </div>
                                                                </div>
                                                            <?php else : ?>
