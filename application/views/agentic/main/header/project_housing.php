                ...
                <div class="input-group gap-2">
                    ...
                    <select name="id" class="form-control px-3 border-custom border-1" id="id" style="min-width: 280px;">
                        ...
                        <?php foreach ($pm as $item): ?>
                            ...
                            <option value="<?= $item->id_user ?>" <?= ($item->id_user == 515 ) ? 'selected' : '' ?>><?= $item->name ?></option>
                        <?php endforeach; ?>
                    </select>
                    <select name="project_tipe" id="project_tipe" class="form-control px-3 border-custom border-1">
