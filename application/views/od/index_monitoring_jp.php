<main class="main mainheight">
    <div class="m-3">
            ...
            <div class="card border-0">
                        ...
                        <div class="col-auto">
                            <div class="row">
                                ...
                                <div class="col-auto align-self-center">
                                    <h6 class="fw-medium">Job Profile</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                ...
                <div class="card-body">
                    <div class="table-responsive" style="padding: 10px;">
                        <table id="dt_job_profile" class="table table-sm table-striped display nowrap" style="width:100%">
                            <thead>
                                <tr>
                            ...
                            <div class="col-sm-6">
                                <ul class="list-group list-group-flush mb-3">
                                    <li class="list-group-item d-flex px-0 justify-content-between">
                                        ...
                                        <span class="mb-0" id="rv_no_jp"></span>
                                    </li>
                                    <li class="list-group-item d-flex px-0 justify-content-between">
                                        <strong>Job Position</strong>
                                        <span class="mb-0" id="rv_desig"></span>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-sm-6">
                                <ul class="list-group list-group-flush mb-3">
                                    <li class="list-group-item d-flex px-0 justify-content-between">
                                        ...
                                        <span class="mb-0" id="rv_dept"></span>
                                    </li>
                                    <li class="list-group-item d-flex px-0 justify-content-between">
                                        <strong>Grade</strong>
                                        <span class="mb-0" id="rv_grade"></span>
                                    </li>
                                </ul>
                            </div>
        ...
        <!-- Modal Add Scope Of Responsibility -->
        ...
        <!-- Modal View Scope Of Responsibility -->
        ...
        <!-- Modal Add Relationship Internal -->
        ...
        <!-- Modal View Relationship Internal -->
        ...
        <!-- Modal Add Relationship External -->
        ...
        <!-- Modal View Relationship External -->
