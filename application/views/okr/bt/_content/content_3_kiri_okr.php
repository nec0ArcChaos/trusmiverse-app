                ...
                <div class="row">
                    <div class="col-5">
                        <div class="progress" style="height: 100%; width: 100%; display: none;">
                            <!-- List Tab -->
                            <div class="progress-bar progress-tab selected" id="progress_list"
                                style="width:33%; background-color: #081226; cursor: pointer;" role="progressbar"
                                data-target="#section_list">
                                <span style="font-size: 12px; font-weight: bold;" class="progress-text"><i
                                        class="bi bi-list"></i> List</span>
                            </div>
                            <!-- Kanban Tab -->
                            <div class="progress-bar progress-tab" id="progress_kanban"
                                style="width:33%; background-color: #ffffff; cursor: pointer;" role="progressbar"
                                data-target="#section_kanban">
                                <span style="font-size: 12px; font-weight: bold;" class="progress-text"><i
                                        class="bi bi-kanban"></i> Kanban</span>
                            </div>
                            <!-- Calendar Tab -->
                            <div class="progress-bar progress-tab" id="progress_calendar"
                                style="width:34%; background-color: #ffffff; cursor: pointer;" role="progressbar"
                                data-target="#section_calendar">
                                <span style="font-size: 12px; font-weight: bold;" class="progress-text"><i
                                        class="bi bi-calendar-date"></i> Calendar</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-3">
                    ...
                    <div class="col-4">
                        <div class="input-group input-group-md reportrange border-custom">
                            <input type="text" class="form-control text-center range px-0" style="cursor: pointer;"
                                id="rangeCalendar">
                            <input type="hidden" name="start" value="" id="startCalendar" />
                            <input type="hidden" name="end" value="" id="endCalendar" />
                            <span class="input-group-text text-secondary" id="titlecalandershow"><i
                ...
                <div id="progressBarContainer">
                    <div class="progress" style="height: 35px; width: 100%;">
                        ...
                        <?php foreach ($goals as $goal): ?>
                            <div class="progress-bar bg-blue_<?= $index ?>" style="width:<?= $goal->done_prs ?>%;"
                                role="progressbar">
                                <span style="font-size: 12px; font-weight: bold;" class="text-white"><?= $goal->nama_goal ?>
                                    (<?= $goal->done_prs ?>%)</span>
                            </div>
                            <?php $index++; ?>
                        <?php endforeach; ?>
                        ...
                        if ($not_started_prs > 0):
                            ?>
                            <div class="progress-bar" style="width:<?= $not_started_prs ?>%; background-color: #D4D4D8;"
                                role="progressbar">
                                <span style="font-size: 12px; font-weight: bold;" class="text-grey">Not Started
                                    (<?= $not_started_prs ?>%)</span>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<div class="modal fade" id="modal_detail_tasklist" tabindex="-1" aria-labelledby="modal_detail_tasklist_label"
            ...
            <div class="modal-header row align-items-center bg-light-blue">
                ...
                <div class="col-auto ps-0">
                    <div class="dropdown d-inline-block">
                        <a class="btn btn-link btn-square dd-arrow-none dropdown-toggle" role="button"
            ...
            <div class="modal-body">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <i
                                            class="comingsoonbi bi bi-list-task h5 avatar avatar-40 bg-light-green text-green text-green rounded "></i>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3 col-md-4 mb-2">
                                        ...
                                        <h6 class="small d-inline" id="t_start"></h6><i
                        ...
                        <div class="row mb-2">
                            <div class="col-12">
                                <ul class="nav detail_tabs nav-WinDOORS">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="javascript:void(0)" id="nav_update"
                                            onclick="activateTab('update')">
                                            Update Progres
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="javascript:void(0)" id="nav_activity"
                                ...
                                <form id="form_update" enctype="multipart/form-data" class="mt-2">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="input-group border-custom">
                                                ...
                                                <input type="number" name="actual" id="actual"
                                                    class="form-control border-custom" value="0">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col">
                                            ...
                                            <div class="input-group border-custom">
                                                ...
                                                <textarea name="note" id="note" class="form-control border-custom"
                                                    required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col" align="right">
                                            <button type="button" class="m-1 btn btn-default"
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12 mb-2">
                                <p class="title"><i class="bi bi-quote"></i> Key Result</p>
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered table-striped" id="table_comp">
                                        <thead class="table-dark">
                                            <tr>
                                                ...
                                                <th class="text-nowrap small text-center" style="min-width: 150px;">
                                                    Reported By</th>
                                                <th class="text-nowrap small text-center" style="min-width: 150px;">
                                                    Verified To</th>
                                                <th class="text-nowrap small text-center" style="min-width: 150px;">
    ...
    $(document).ready(function () {
        ...
        $('#modal_detail_tasklist').on('shown.bs.modal', function () {
            ...
            if (status == '3') { // status Done
                $('#status').prop('disabled', true); // bikin dropdown tidak bisa diganti
                // bikin hidden input supaya value status tetap dikirim
                if ($('#status_hidden').length == 0) {
                    $('<input>').attr({
                        type: 'hidden',
                        id: 'status_hidden',
                        name: 'status',
                        value: status
                    }).appendTo('#form_update');
                } else {
...
<!-- MODAL CHANGE -->
<div class="modal fade" id="modal_change" tabindex="-1" aria-labelledby="modal_change" aria-hidden="true"
            ...
            <form id="request_change">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12 mb-2">
                            <label for="">Detail Key Result</label>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 col-lg-6 mb-2">
                            ...
                            <input type="date" name="start" class="form-control border-custom" value=""
                                required="required">
                        </div>
                        <div class="col-12 col-md-6 col-lg-6 mb-2">
                            <label class="required">End</label>
                            <input type="date" name="end" class="form-control border-custom" value=""
                                required="required">
                        </div>
                    </div>
                    <div class="row">
...
<!-- MODAL DETAIL SI -->
<div class="modal fade" id="modal_detail_si" tabindex="-1" aria-labelledby="modal_detail_si_label" aria-hidden="true"
    data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header row align-items-center bg-light-blue">
                ...
                <div class="col">
                    <h5 class="fw-bold mb-0" id="t_nama_si">Nama Coorporate</h5>
                </div>
                <div class="col-auto ps-0">
                    <div class="dropdown d-inline-block">
                        <a class="btn btn-link btn-square dd-arrow-none dropdown-toggle" role="button"
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-6 col-6 col-lg-6">
                                        <h6 class="fw-medium mb-0" id="t_si_si">Project</h6>
                                        <p class="text-secondary small" id="t_so_si">Objective</p>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row mb-2">
                                    <div class="col-12 mb-2">
                                        <p class="title"><i class="bi bi-quote"></i> Detail Key Result</p>
                                        <p id="t_detail_si"></p>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3 col-md-4 mb-2">
                                        <p class="text-secondary small mb-1">Deadline </p>
                                        <h6 class="small d-inline" id="t_start_si"></h6><i
                                            class="bi bi-arrow-right-short"></i>
                    ...
                    <div class="col-12 col-lg-4 col-sm-12">
                        <div class="row mb-2">
                            <div class="col-12">
                                <ul class="nav detail_tabs nav-WinDOORS">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#tab_update_si"
                                            id="nav_update_si">
                                            Update Progres
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#tab_activity_si"
                                            id="nav_activity_si">
                                            History
                                        </a>
                                    </li>
                                ...
                                <form id="form_update_si" enctype="multipart/form-data" class="mt-2">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-6">
                                            ...
                                            <div class="input-group border-custom">
                                                <span class="input-group-text"><i class="bi bi-alexa"></i></span>
                                                <select name="status" id="status_si" class="form-control border-custom"
                                                    required>
                                                    <?php foreach ($status as $item): ?>
                                                        <option value="<?= $item->id ?>"><?= $item->nama ?></option>
                                                    <?php endforeach; ?>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="input-group border-custom">
                                                <span class="input-group-text"><i
                                                        class="bi bi-hourglass-split"></i></span>
                                                <input type="number" name="actual" id="actual_si"
                                                    class="form-control border-custom" min="0" value="0">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col">
                                            ...
                                            <div class="input-group border-custom">
                                                <span class="input-group-text"><i class="bi bi-journals"></i></span>
                                                <textarea name="note" id="note_si" class="form-control border-custom"
                                                    required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                            ...
                                            <div class="input-group border-custom">
                                                <span class="input-group-text"><i
                                                        class="bi bi-file-earmark-image"></i></span>
                                                <input type="file" name="evidence" id="evidence_si"
                                                    class="form-control border-custom">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                            ...
                                            <div class="input-group border-custom">
                                                <span class="input-group-text"><i class="bi bi-link-45deg"></i></span>
                                                <input type="text" name="evidence_link" id="evidence_link_si"
                                                    class="form-control border-custom">
                                            </div>
                                        </div>
                                    </div>
...
<!-- MODAL DETAIL SO -->
<div class="modal fade" id="modal_detail_so" tabindex="-1" aria-labelledby="modal_detail_so_label" aria-hidden="true"
    data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header row align-items-center bg-light-blue">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3 col-md-4 mb-2">
                                        <p class="text-secondary small mb-1">Deadline </p>
                                        <h6 class="small d-inline" id="t_start_so"></h6><i
                                            class="bi bi-arrow-right-short"></i>
                    ...
                    <div class="col-12 col-lg-4 col-sm-12">
                        <div class="row mb-2">
                            <div class="col-12">
                                <ul class="nav detail_tabs nav-WinDOORS">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#tab_update_so"
                                            id="nav_update_so">
                                            Update Progres
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#tab_activity_so"
                                            id="nav_activity_so">
                                            History
                                        </a>
                                    </li>
                                ...
                                <form id="form_update_so" enctype="multipart/form-data" class="mt-2">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-6">
                                            ...
                                            <div class="input-group border-custom">
                                                <span class="input-group-text"><i class="bi bi-alexa"></i></span>
                                                <select name="status" id="status_so" class="form-control border-custom"
                                                    required>
                                                    <?php foreach ($status as $item): ?>
                                                        <option value="<?= $item->id ?>"><?= $item->nama ?></option>
                                                    <?php endforeach; ?>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="input-group border-custom">
                                                <span class="input-group-text"><i
                                                        class="bi bi-hourglass-split"></i></span>
                                                <input type="number" name="actual" id="actual_so"
                                                    class="form-control border-custom" min="0" value="0">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col">
                                            ...
                                            <div class="input-group border-custom">
                                                <span class="input-group-text"><i class="bi bi-journals"></i></span>
                                                <textarea name="note" id="note_so" class="form-control border-custom"
                                                    required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                            ...
                                            <div class="input-group border-custom">
                                                <span class="input-group-text"><i
                                                        class="bi bi-file-earmark-image"></i></span>
                                                <input type="file" name="evidence" id="evidence_so"
                                                    class="form-control border-custom">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col">
                                            ...
                                            <div class="input-group border-custom">
                                                <span class="input-group-text"><i class="bi bi-link-45deg"></i></span>
                                                <input type="text" name="evidence_link" id="evidence_link_so"
                                                    class="form-control border-custom">
                                            </div>
                                        </div>
                                    </div>
...
<div class="modal fade" id="modal_edit_detail_tasklist" aria-labelledby="modal_edit_detail_tasklist" aria-hidden="true"
    data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        ...
        <div class="modal-content">
            ...
            <form id="form_edit_tasklist" enctype="multipart/form-data">
                ...
                <div class="modal-header row align-items-center bg-blue_2">
                    ...
                    <div class="col">
                        <h5 class="fw-bold mb-0 text-white" id="modal-list-waiting-resignationLabel">Edit Key Result OKR
                        </h5>
                    </div>
                    <div class="col-auto ps-0">
                        <div class="dropdown d-inline-block">
                                    ...
                                    <div class="row">
                                        <div class="col-3 col-md-12 mb-2">
                                            ...
                                            <div class="input-group mb-3 border-custom">
                                                <select name="id_pic" id="edit_id_pic"
                                                    class="form-control border-custom" multiple="">
                                        ...
                                        <?php if ($this->session->userdata('user_id') == 1 || $this->session->userdata('user_id') == 118 || $this->session->userdata('user_id') == 2729 || $this->session->userdata('user_id') == 3690) { ?>
                                            ...
                                            <div class="col-3 col-md-12 mb-2">
                                                <label class="form-label-custom required small mb-1" for="tgl_start">Tanggal
                                                    Mulai</label>
                                                <div class="input-group mb-3 border-custom">
                                                    <input type="text" class="form-control datepicker border-custom"
                                                        name="tgl_start" id="edit_tgl_start" placeholder="Tanggal Mulai">
                                                </div>
                                            </div>

                                            <div class="col-3 col-md-12 mb-2">
                                                <label class="form-label-custom required small mb-1"
                                                    for="tgl_end">Deadline</label>
                                                <div class="input-group mb-3 border-custom">
                                                    <input type="text" class="form-control datepicker border-custom"
                                                        name="tgl_end" id="edit_tgl_end" placeholder="Deadline">
                                                </div>
                                            </div>
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <div class="col-3 col-md-12 mb-2">
                                                <label class="form-label-custom required small mb-1" for="tgl_start">Tanggal
                                                    Mulai</label>
                                                <div class="input-group mb-3 border-custom">
                                                    <input type="text" class="form-control border-custom" name="tgl_start"
                                                        id="edit_tgl_start_pic" placeholder="Tanggal Mulai" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-3 col-md-12 mb-2">
                                                <label class="form-label-custom required small mb-1"
                                                    for="tgl_end">Deadline</label>
                                                <div class="input-group mb-3 border-custom">
                                                    <input type="text" class="form-control border-custom" name="tgl_end"
                                                        id="edit_tgl_end_pic" placeholder="Deadline" readonly>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-3 col-md-12 mb-2">
                                            ...
                                            <div class="input-group border-custom mb-3">
                                                <input type="text" class="form-control border-custom" name="detail"
                                                    id="edit_detail" placeholder="Detail Pekerjaan">
                                                <input type="hidden" class="form-control border-custom"
                                                    name="before_detail" id="before_detail"
                                        ...
                                        <div class="col-3 col-md-12 mb-2">
                                            <label class="form-label-custom required small mb-1"
                                                for="output">Output</label>
                                            <div class="input-group mb-3 border-custom">
                                                <input type="text" class="form-control border-custom" name="output"
                                                    id="edit_output" placeholder="Output Pekerjaan">
                                            </div>
                                        </div>
                ...
                <div class="modal-footer" id="mfoot_div">
                    <button type="button" class="m-1 btn btn-default" data-bs-dismiss="modal">Close</button>
                    <button type="submit" class="m-1 btn bg-blue_2" style="border-radius: 5px; color: white;"
                        onmouseover="this.style.color='black'" onmouseout="this.style.color='white'">Save</button>
                </div>
