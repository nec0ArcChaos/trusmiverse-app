<script>
    ...
    function reload_milestone() {
        fetch("<?= base_url('okr/bt/okr/getMilestones') ?>")
...
<script>
    function get_company() {
        $.ajax({
            url: '<?= base_url() ?>okr/bt/okr/get_company',
            type: 'POST',
            dataType: 'json',
            beforeSend: function () {
    ...
    $('#add_id_divisi').change(function (e) {
        ...
        $.ajax({
            url: '<?= base_url() ?>okr/bt/okr/goal_pic',
            type: 'POST',
            dataType: 'json',
            data: {
    ...
    $('#add_id_goal').change(function (e) {
        ...
        $.ajax({
            url: '<?= base_url() ?>okr/bt/okr/get_so_by_goal',
            type: 'POST',
            dataType: 'json',
            data: {
                id_goal: id_goal
    ...
    $('#add_id_so').change(function (e) {
        ...
        $.ajax({
            url: '<?= base_url() ?>okr/bt/okr/get_si_by_so',
            type: 'POST',
            dataType: 'json',
            data: {
                id_so: id_so
...
<script>
    ...
    $('#mile_id_company').change(function (e) {
        ...
        $.ajax({
            url: '<?= base_url() ?>okr/bt/okr/milestone_pic',
            type: 'POST',
            dataType: 'json',
            data: {
...
<script>
    function save_task() {
        ...
        if (val_id_divisi == "" || val_id_divisi == null) {
        ...
        } else if (!val_id_pic || val_id_pic.length === 0) {
            $.confirm({
                icon: 'fa fa-close',
                title: 'Oops!',
                theme: 'material',
            ...
            $.confirm({
                ...
                theme: 'material',
                type: 'red',
                content: 'Oops, Jenis Key Result must be filled',
                buttons: {
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: function () {
                        ...
                        $.ajax({
                            url: `<?= base_url() ?>okr/bt/okr/save_task`,
                            cache: false,
                            contentType: false,
                            processData: false,
                            ...
                            if (response.save_task == true) {
                                ...
                                setTimeout(() => {
                                    ...
                                    $.confirm({
                                        ...
                                        theme: 'material',
                                        type: 'blue',
                                        content: 'Success! Membuat Key Result GRD',
                                        buttons: {
                                            close: {
                                                actions: function () { }
                                            },
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: function () {
                        ...
                        $.ajax({
                            url: `<?= base_url() ?>okr/bt/okr/save_task_milestone`,
                            cache: false,
                            contentType: false,
                            processData: false,
                            data: form_data_tasklist, // Setting the data attribute of ajax with file_data
...
<script>
    function save_so() {
        ...
        const fields = [
            { value: val_id_company, name: 'Company' },
            { value: val_id_divisi, name: 'Divisi' },
            { value: val_id_goal, name: 'Coorporate' },
            { value: val_id_so, name: 'Project' },
            { value: val_id_pic, name: 'PIC' },
            { value: val_start, name: 'Tanggal Mulai' },
            { value: val_end, name: 'Deadline' },
            { value: val_target, name: 'Target' },
            { value: val_target_type, name: 'Tipe Target Project' },
            { value: val_actual_type, name: 'Tipe Actual Project' },
        ];
        ...
        for (let field of fields) {
            if (!field.value || (Array.isArray(field.value) && field.value.length === 0)) {
                $.confirm({
                    ...
                    theme: 'material',
                    type: 'red',
                    content: `Oops, ${field.name} must be filled`,
                    buttons: { close: { actions: function () { } } }
                });
                return;
            }
        }
        $.confirm({
            ...
            buttons: {
                confirm: function () {
                    ...
                    $.ajax({
                        url: `<?= base_url() ?>okr/bt/okr/save_so`,
                        cache: false,
                        contentType: false,
                        processData: false,
                        ...
                        if (response.save_so == true) {
                            ...
                            setTimeout(() => {
                                ...
                                $.confirm({
                                    ...
                                    theme: 'material',
                                    type: 'blue',
                                    content: 'Success! Membuat Project GRD',
                                    buttons: {
                                        close: {
                                            actions: function () { }
                                        },
    ...
    //     $('#list_grd').DataTable().ajax.reload(null, false);
    // }
</script>
...
<script>
    function save_si() {
        ...
        let val_si_target_output = $('#si_target_output').val();
        let val_si_target_outcome = $('#si_target_outcome').val();
        ...
        const fields = [
            ...
            { value: val_id_goal, name: 'Coorporate' },
            { value: val_id_so, name: 'Project' },
            { value: val_id_si, name: 'Objective' },
            { value: val_id_pic, name: 'PIC' },
            { value: val_start, name: 'Tanggal Mulai' },
            { value: val_end, name: 'Deadline' },
            { value: val_target, name: 'Target' },
            { value: val_si_target_output, name: 'Target Output' },
            { value: val_si_target_outcome, name: 'Target Outcome' },
            { value: val_target_type, name: 'Tipe Target Objective' },
            { value: val_actual_type, name: 'Tipe Actual Objective' },
        ];
        ...
        $.confirm({
            ...
            buttons: {
                confirm: function () {
                    ...
                    form_data_si.append("si_target_output", val_si_target_output);
                    form_data_si.append("si_target_outcome", val_si_target_outcome);
                    ...
                    $.ajax({
                        url: `<?= base_url() ?>okr/bt/okr/save_si`,
                        cache: false,
                        contentType: false,
                        processData: false,
                        ...
                        if (response.save_si == true) {
                            ...
                            setTimeout(() => {
                                ...
                                $.confirm({
                                    ...
                                    theme: 'material',
                                    type: 'blue',
                                    content: 'Success! Membuat Objective GRD',
                                    buttons: {
                                        close: {
                                            actions: function () { }
                                        },
