<main class="main mainheight">
    ...
    <div class="col col-sm-auto">
        <div class="input-group input-group-md reportrange">
            <input type="text"
                   class="form-control range bg-none px-2"
            ...
            <div class="card border-0">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-auto align-self-center">
                            <h6 class="fw-medium mb-0">List <?= $pageTitle ?> Masuk</h6>
                        </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="dt_absen_masuk" class="table nowrap table-striped" width="100%">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Timestamp</th>
