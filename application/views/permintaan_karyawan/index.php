        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_add_permintaan">
                    <!-- Hidden input untuk prefill data dari renewal contract -->
                    <input type="hidden" id="renewal_prefill_data" value="<?= htmlspecialchars(json_encode(isset($prefill) ? $prefill : null), ENT_QUOTES, 'UTF-8') ?>">
