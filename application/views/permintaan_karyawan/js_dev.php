...
<script>
    ...
    function get_permintaan(start, end) {
        let edit = false;
        $.ajax({
            url: "<?= base_url('permintaan_karyawan_dev/get_user_role') ?>",
            method: "get",
            dataType: "json",
                    ...
                    'confirm': {
                        ...
                        action: function() {
                            $.confirm({
                                ...
                                onOpen: function() {
                                    $.ajax({
                                        url: "<?= base_url('permintaan_karyawan_dev/add_permintaan') ?>",
                                        method: "POST",
                                        data: form.serialize(),
                                        dataType: "JSON",
                                        beforeSend: function() {},
    ...
    function check_empty_field() {
        ...
        // $('.input_permintaan, .select_permintaan').each(function() {
        //     if ($(this).val() == null || $(this).val() == '' || $(this).val() == '--Pilih Department--' || $(this).val() == '--Pilih Jabatan / Posisi--' || $(this).val() == '--Pilih Lokasi--') {
        //         $(this).addClass('is-invalid');
        //         $('.nice-select').addClass('invalid');
        //         isEmptyField = true;
        //     } else {
        //         $(this).removeClass('is-invalid');
        //         $('.nice-select').removeClass('invalid');
        //     }
        // })
