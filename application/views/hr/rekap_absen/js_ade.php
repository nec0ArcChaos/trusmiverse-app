...
<script>
    ...
    function rekap_data() {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>hr/rekap_absen_ade/get_rekap_absen',
            type: 'POST',
            dataType: 'html',
            data: {
                company_id: company_id,
                ...
                $('#dt_rekap_absen').DataTable({
                    ...
                    buttons: [{
                            ...
                            action: function(e, dt, node, config) {
                                url_excel = "<?php echo base_url() ?>hr/rekap_absen_ade/excel/" + company_id + "/" + department_id + "/" + employee_id + "/" + periode + "/" + cutoff; // addnew cutoff
                        ...
                        <?php if ($this->session->userdata('user_id') == 1 || $this->session->userdata('user_id') == 778 || $this->session->userdata('user_id') == 979): ?> {
                                ...
                                action: function(e, dt, node, config) {
                                    ...
                                    $.ajax({
                                            url: `<?php echo base_url() ?>hr/rekap_absen_ade/harus_hadir/${company_id}/${department_id}/${employee_id}/${periode}/${cutoff}`,
                                            type: 'GET',
                                            dataType: 'json',
                                        })
