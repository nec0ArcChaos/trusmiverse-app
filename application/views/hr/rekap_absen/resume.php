...
<div class="modal fade" id="modal_detail" tabindex="-1" aria-labelledby="modalDetailLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header row align-items-center">
                ...
                <div class="col">
                    <h6 class="fw-medium mb-0" id="modalDetailLabel">Detail Absen</h6>
                    <p class="text-secondary small">Detail absen karyawan pada periode yang dipilih.</p>
                </div>
                <div class="col-auto ps-0">
                    <div class="dropdown d-inline-block">
                        <a class="btn btn-link btn-square text-secondary dd-arrow-none dropdown-toggle" role="button" aria-expanded="false" data-bs-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <div class="table-responsive" style="padding: 10px;">
                    <table id="dt_rekap_absen_detail" class="table table-sm table-striped table-bordered nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Employee</th>
