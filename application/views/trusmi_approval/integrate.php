                            ...
                            <div class="col-12 col-md-11 col-lg-10 col-xl-8 col-xxl-6">
                                ...
                                <form class="mb-4" id="form_verify">
                                    ...
                                    <div class="form-group mb-2 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-floating">
                                                <input type="text" placeholder="no_app" value="<?= isset($_GET['id']) ? $_GET['id'] : ''; ?>" required class="form-control border-start-0" style="background-color: #F1F1F1;" autofocus id="no_app" readonly>
                                    ...
                                    <div style="text-align: right;">
                                        <button class="btn btn-lg btn-theme mb-2" type="button" id="submitbtn">Integrate <i class="bi bi-arrow-right"></i></button>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.result == 1) {
                            ...
                            setTimeout(function() {
                                no_app = "<?= isset($_GET['id']) ? $_GET['id'] : ''; ?>";
                                window.location.href = "<?php echo base_url() ?>trusmi_approval/integrate_approval?id=" + no_app;
                            }, 1000)
                        } else {
                            new PNotify({
                                title: 'Gagal',
