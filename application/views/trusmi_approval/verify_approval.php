                            ...
                            <div class="col-12 col-lg-12 col-xl-12 mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-8 col-lg-8">
                                        ...
                                        <form action="" id="formApprove" class="mt-3">
                                            <div class="form-group mb-3 position-relative check-valid mt-3">
                                                <div class="input-group input-group-lg">
                            ...
                            <form id="form_resubmit">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6 mb-2">
                                        ...
                                        <input type="hidden" class="form-control" name="string_file_1" id="string_file_1" value="<?= $data->file_1 ?>">
                                        ...
                                        <div class="invalid-feedback mb-3">Add valid data </div>
                                        <small>* Upload untuk mengganti file dokumen</small>
                                    </div>
                                    <div class="col-12 col-md-6 mb-2">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="input-group input-group-lg">
                                        ...
                                        <input type="hidden" class="form-control" name="string_file_2" id="string_file_2" value="<?= $data->file_2 ?>">
