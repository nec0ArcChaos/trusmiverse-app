            ...
            <div class="card border-0">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-auto ms-auto ps-0">
                            <div class="p-3" style="display: flex;justify-content: space-between; gap:8px">
                                <?php if ($this->session->userdata('user_id') == '2063' || $this->session->userdata('user_id') == '61' || $this->session->userdata('user_role_id') == '1' || $this->session->userdata('user_id') == '1' || $this->session->userdata('user_id') == '979') { ?>
                                ...
                                <div id="btn_my_resignation" class="hide">
                                ...
                                <?php if ($this->session->userdata('user_id') == '2063' || $this->session->userdata('user_id') == '61' || $this->session->userdata('user_id') == '979' || in_array($this->session->userdata('user_role_id'), [1, 2, 3, 4, 5, 10])) { ?>
                                    <button type="button" class="btn btn-md btn-outline-theme" data-bs-toggle="modal" data-bs-target="#modalAddHead" onclick="get_employee()"><i class="bi bi-plus"></i> Resignation By Atasan</button>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
                        ...
                        <table id="dt_trusmi_resignation" class="table table-sm table-striped" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th style="display: none;">Q11</th>
                                    <th style="display: none;">Q12</th>
                                    <th style="display: none;">Q13</th>
                                    <th style="display: none;">Q14</th>
                                    <th style="display: none;">Q15</th>
                                    <th style="display: none;">Q16</th>
                                    <th style="display: none;">Q17</th>
                                    <th style="display: none;">Q18</th>
                                </tr>
                            </thead>
                            <tbody></tbody>
                        </table>
                ...
                <div class="card-footer">
                    ...
                    <ul style="font-size: 10pt;text-align: justify;">
                        <li>Q1 : Apakah ada perbandingan gaji dengan perusahaan lain yang membuat Anda mempertimbangkan resign ?</li>
                        <li>Q2 : Apakah Anda merasa perusahaan memiliki struktur gaji yang adil ?</li>
                        <li>Q3 : Apakah ada fasilitas tambahan yang Anda butuhkan namun tidak tersedia ?</li>
                        <li>Q4 : Apakah ada konflik yang tidak terselesaikan di lingkungan kerja ?</li>
                        <li>Q5 : Apakah Anda merasa dihargai oleh tim atau atasan ?</li>
                        <li>Q6 : Apakah Anda merasa lingkungan kerja mendukung produktivitas ?</li>
                        <li>Q7 : Apakah Anda merasa ada tekanan kerja yang berlebihan ?</li>
                        <li>Q8 : Apakah Anda melihat peluang untuk promosi atau naik jabatan di perusahaan ini ?</li>
                        <li>Q9 : Apakah perusahaan memberikan pelatihan atau kursus untuk pengembangan diri Anda ?</li>
                        <li>Q10 : Apakah Anda merasa pekerjaan Anda stagnan tanpa tantangan baru ?</li>
                        <li>Q11 : Apakah atasan Anda memberikan bimbingan yang cukup untuk pengembangan Anda ?</li>
                        <li>Q12 : Apakah deskripsi pekerjaan Anda sesuai dengan tugas yang Anda kerjakan ?</li>
                        <li>Q13 : Apakah Anda merasa kewalahan dengan tenggat waktu yang diberikan ?</li>
                        <li>Q14 : Apakah lokasi kantor memengaruhi keputusan Anda untuk resign ?</li>
                        <li>Q15 : Apakah fasilitas kerja (ruang kerja, teknologi, alat kerja) mendukung Anda ?</li>
                        <li>Q16 : Apakah jam kerja mengganggu kehidupan pribadi Anda ?</li>
                        <li>Q17 : Apakah Anda merasa sulit mengambil cuti atau liburan ?</li>
                        <li>Q18 : Apakah pekerjaan Anda mengganggu kesehatan fisik atau mental Anda ?</li>
                    </ul>
                    <?php if ($this->session->userdata('user_role_id') == 1) { ?>
                        <p>Keterangan (Question) Lama : </p>
                        <ul style="font-size: 10pt;text-align: justify;">
            ...
            <form id="form_add">
                ...
                <div class="modal-body">
                    <div class="col-12 col-lg-12 col-xl-12 mb-4">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <div class="form-floating">
                                            <select name="category" id="category" class="form-control border-start-0">
                                                ...
                                                <?php foreach ($category_reason as $key) { ?>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-person-fill-up"></i></span>
                                        <div class="form-floating">
                                            <select name="detail_reason" id="detail_reason" class="form-control border-start-0">

                                            </select>
                                            <label>Resignation Detail Reason</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="invalid-feedback mb-3">Add valid data </div>
                            </div>
                            <div class="col-12 col-md-12 mb-2" id="note_detail" style="display: none;">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-list-columns"></i></span>
                                        <div class="form-floating">
                                            <textarea name="alasan_lain" id="alasan_lain" class="form-control border-start-0" cols="30" rows="5" style="min-height: 80px;" required></textarea>
                                            <label>Alasan Lainnya (Wajib diisi!)</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="invalid-feedback mb-3">Add valid data </div>
                        ...
                        <div id="interview_exit">
                            <h6 class="title">Required Question</h6>
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                    <div class="form-group">
                                        <label for="" style="text-align: justify;font-size: small;">Apakah ada perbandingan gaji dengan perusahaan lain yang membuat Anda mempertimbangkan resign ?</label>
                                    </div>
                                    <div class="form-group mb-3 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                    <div class="form-group">
                                        <label for="" style="text-align: justify;font-size: small;">Apakah Anda merasa perusahaan memiliki struktur gaji yang adil ?</label>
                                    </div>
                                    <div class="form-group mb-3 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-pencil-square"></i></span>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                    <div class="form-group">
                                        <label for="" style="text-align: justify;font-size: small;">Apakah ada fasilitas tambahan yang Anda butuhkan namun tidak tersedia ?</label>
                                    </div>
                                    <div class="form-group mb-3 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-pencil-square"></i></span>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                    <div class="form-group">
                                        <label for="" style="text-align: justify;font-size: small;">Apakah ada konflik yang tidak terselesaikan di lingkungan kerja ?</label>
                                    </div>
                                    <div class="form-group mb-3 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-pencil-square"></i></span>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                    <div class="form-group">
                                        <label for="" style="text-align: justify;font-size: small;">Apakah Anda merasa dihargai oleh tim atau atasan ?</label>
                                    </div>
                                    <div class="form-group mb-3 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-pencil-square"></i></span>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                    <div class="form-group">
                                        <label for="" style="text-align: justify;font-size: small;">Apakah Anda merasa lingkungan kerja mendukung produktivitas ?</label>
                                    </div>
                                    <div class="form-group mb-3 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-pencil-square"></i></span>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                    <div class="form-group">
                                        <label for="" style="text-align: justify;font-size: small;">Apakah Anda merasa ada tekanan kerja yang berlebihan ?</label>
                                    </div>
                                    <div class="form-group mb-3 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-pencil-square"></i></span>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                    <div class="form-group">
                                        <label for="" style="text-align: justify;font-size: small;">Apakah Anda melihat peluang untuk promosi atau naik jabatan di perusahaan ini ?</label>
                                    </div>
                                    <div class="form-group mb-3 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-pencil-square"></i></span>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                    <div class="form-group">
                                        <label for="" style="text-align: justify;font-size: small;">Apakah perusahaan memberikan pelatihan atau kursus untuk pengembangan diri Anda ?</label>
                                    </div>
                                    <div class="form-group mb-3 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-pencil-square"></i></span>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                    <div class="form-group">
                                        <label for="" style="text-align: justify;font-size: small;">Apakah Anda merasa pekerjaan Anda stagnan tanpa tantangan baru ?</label>
                                    </div>
                                    <div class="form-group mb-3 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-pencil-square"></i></span>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                    <div class="form-group">
                                        <label for="" style="text-align: justify;font-size: small;">Apakah atasan Anda memberikan bimbingan yang cukup untuk pengembangan Anda ?</label>
                                    </div>
                                    <div class="form-group mb-3 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-pencil-square"></i></span>
                                            <div class="form-floating">
                                                <textarea name="pernyataan_11" id="pernyataan_11" class="form-control border-start-0" cols="30" rows="5" style="min-height: 100px;" required></textarea>
                                                <label>Jawab : </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                    <div class="form-group">
                                        <label for="" style="text-align: justify;font-size: small;">Apakah deskripsi pekerjaan Anda sesuai dengan tugas yang Anda kerjakan ?</label>
                                    </div>
                                    <div class="form-group mb-3 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-pencil-square"></i></span>
                                            <div class="form-floating">
                                                <textarea name="pernyataan_12" id="pernyataan_12" class="form-control border-start-0" cols="30" rows="5" style="min-height: 100px;" required></textarea>
                                                <label>Jawab : </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                    <div class="form-group">
                                        <label for="" style="text-align: justify;font-size: small;">Apakah Anda merasa kewalahan dengan tenggat waktu yang diberikan ?</label>
                                    </div>
                                    <div class="form-group mb-3 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-pencil-square"></i></span>
                                            <div class="form-floating">
                                                <textarea name="pernyataan_13" id="pernyataan_13" class="form-control border-start-0" cols="30" rows="5" style="min-height: 100px;" required></textarea>
                                                <label>Jawab : </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                    <div class="form-group">
                                        <label for="" style="text-align: justify;font-size: small;">Apakah lokasi kantor memengaruhi keputusan Anda untuk resign ?</label>
                                    </div>
                                    <div class="form-group mb-3 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-pencil-square"></i></span>
                                            <div class="form-floating">
                                                <textarea name="pernyataan_14" id="pernyataan_14" class="form-control border-start-0" cols="30" rows="5" style="min-height: 100px;" required></textarea>
                                                <label>Jawab : </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                    <div class="form-group">
                                        <label for="" style="text-align: justify;font-size: small;">Apakah fasilitas kerja (ruang kerja, teknologi, alat kerja) mendukung Anda ?</label>
                                    </div>
                                    <div class="form-group mb-3 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-pencil-square"></i></span>
                                            <div class="form-floating">
                                                <textarea name="pernyataan_15" id="pernyataan_15" class="form-control border-start-0" cols="30" rows="5" style="min-height: 100px;" required></textarea>
                                                <label>Jawab : </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                    <div class="form-group">
                                        <label for="" style="text-align: justify;font-size: small;">Apakah jam kerja mengganggu kehidupan pribadi Anda ?</label>
                                    </div>
                                    <div class="form-group mb-3 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-pencil-square"></i></span>
                                            <div class="form-floating">
                                                <textarea name="pernyataan_16" id="pernyataan_16" class="form-control border-start-0" cols="30" rows="5" style="min-height: 100px;" required></textarea>
                                                <label>Jawab : </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                    <div class="form-group">
                                        <label for="" style="text-align: justify;font-size: small;">Apakah Anda merasa sulit mengambil cuti atau liburan ?</label>
                                    </div>
                                    <div class="form-group mb-3 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-pencil-square"></i></span>
                                            <div class="form-floating">
                                                <textarea name="pernyataan_17" id="pernyataan_17" class="form-control border-start-0" cols="30" rows="5" style="min-height: 100px;" required></textarea>
                                                <label>Jawab : </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                    <div class="form-group">
                                        <label for="" style="text-align: justify;font-size: small;">Apakah pekerjaan Anda mengganggu kesehatan fisik atau mental Anda ?</label>
                                    </div>
                                    <div class="form-group mb-3 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-pencil-square"></i></span>
                                            <div class="form-floating">
                                                <textarea name="pernyataan_18" id="pernyataan_18" class="form-control border-start-0" cols="30" rows="5" style="min-height: 100px;" required></textarea>
                                                <label>Jawab : </label>
                                            </div>
                                        </div>
                                    </div>
...
<!-- Modal Add By Atasan-->
<div class="modal fade" id="modalAddHead" tabindex="-1" aria-labelledby="modalAddHeadLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="form_add_head">
                <div class="modal-header row align-items-center">
                    ...
                    <div class="col">
                        <h6 class="fw-medium mb-0" id="modalAddHeadLabel">Form</h6>
                        <p class="text-secondary small">Submission of Resignation </p>
                    </div>
                    <div class="col-auto ps-0">
                        <div class="dropdown d-inline-block">
                ...
                <div class="modal-body">
                    <div class="col-12 col-lg-12 col-xl-12 mb-4">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-info-square"></i></span>
                                        <div class="form-floating">
                                            <select name="company_id" id="company_id_2" class="form-control border-start-0">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-info-square"></i></span>
                                        <div class="form-floating">
                                            <select name="department_id" id="department_id_2" class="form-control border-start-0">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-info-square"></i></span>
                                        <div class="form-floating">
                                            <select name="designation_id" id="designation_id_2" class="form-control border-start-0">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        ...
                                        <div class="form-floating">
                                            <select name="employee_id" id="employee_id_2" class="form-control border-start-0">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-calendar-date"></i></span>
                                        <div class="form-floating">
                                            <input type="text" placeholder="Notice Date" name="notice_date" id="notice_date_2" required class="form-control border-start-0" value="<?= date("Y-m-d"); ?>" readonly>
                                            <label>Notice Date</label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-calendar-date"></i></span>
                                        <div class="form-floating">
                                            <input type="text" placeholder="Resignation Date" name="resignation_date" id="resignation_date_2" required class="form-control border-start-0" readonly style="background-color: white;">
                                            <label>Resignation Date</label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-list"></i></span>
                                        <div class="form-floating">
                                            <select name="category" id="category_2" class="form-control border-start-0">
                                                <option data-placeholder="true"></option>
                                                <?php foreach ($category_reason as $key) { ?>
                                                    <option value="<?= $key->value; ?>"><?= $key->text; ?></option>
                                                <?php } ?>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-person-fill-up"></i></span>
                                        <div class="form-floating">
                                            <select name="reason" id="reason_2" class="form-control border-start-0">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-person-fill-up"></i></span>
                                        <div class="form-floating">
                                            <select name="detail_reason" id="detail_reason_2" class="form-control border-start-0">
                            ...
                            <div class="col-12 col-md-12 mb-2" id="note_detail_2" style="display: none;">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-list-columns"></i></span>
                                        <div class="form-floating">
                                            <textarea name="alasan_lain" id="alasan_lain_2" class="form-control border-start-0" cols="30" rows="5" style="min-height: 80px;" required></textarea>
                                            <label>Alasan Lainnya (Wajib diisi!)</label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-md-12 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-card-text"></i></span>
                                        <div class="form-floating">
                                            <textarea name="note" id="note_2" class="form-control border-start-0" cols="30" rows="5" style="min-height: 80px;" required></textarea>
                                            <label>Note</label>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-md btn-outline-theme" id="btn_save" onclick="save_head()">Save Resignation</button>
                </div>
            </form>
        </div>
    </div>
</div>
<!--End Modal Add By Atasan-->

<!-- Modal Add Confirm By Atasan-->
<div class="modal fade" id="modalAddConfirmHead" tabindex="-1" aria-labelledby="modalAddConfirmHeadLabel" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header row align-items-center">
                <div class="col-auto">
                ...
                <div class="col">
                    <h6 class="fw-medium mb-0" id="modalAddConfirmHeadLabel">Form</h6>
                    <p class="text-secondary small">Submission of Resignation </p>
                </div>
                <div class="col-auto ps-0">
                    <div class="dropdown d-inline-block">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-md btn-outline-secondary" style="margin-right: 10px;" data-bs-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-md btn-outline-theme" id="btn_save_confirm_2" onclick="store_resignation_head()">Yes, Save</button>
            </div>
        </div>
    </div>
</div>
<!--End Modal Add Confirm By Atasan-->