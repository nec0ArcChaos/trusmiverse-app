...
<body class="d-flex flex-column h-100 sidebar-pushcontent theme-blue" data-sidebarstyle="sidebar-pushcontent" data-theme="theme-blue">
                    ...
                    <div class="col-12 col-md-11 col-lg-10 col-xl-7 col-xxl-6">
                        <div class="card bg-blur">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-auto align-self-center text-center">
                                        <h5 class="fw-normal">Formulir Registrasi Calon Karyawan</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                        ...
                                                        <div class="swiper-wrapper">
                                                            <div class="swiper-slide pb-2">
                                                                <div class="border-0 shadow-none">
                                                                    <div class="border-0 shadow-none">
                                                                        <img src="<?= base_url(); ?>assets/img/Pembelajar.png" alt="perusahaan holding company yang begerak di bidang Industri Batik, Pariwisata, Properti, Food and Beverage. Trusmi group maju bersama tim manajemen yang profesional, penuh semangat, mencintai budaya dan berjiwa muda." class="rounded mw-200 lazy-load">
                                                                    </div>
                                                                    <div class="border-0 shadow-none text-start" style="min-height: ;">
                                                                        <div class="row align-items-center">
                                                                            <div class="col text-center">
                                                                                <p>Semakin Tumbuh, Semakin Berilmu Dan Sejahtera</p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="swiper-slide pb-2">
                                                                <div class="border-0 shadow-none">
                                                                    <div class="border-0 shadow-none">
                                                                        <img src="<?= base_url(); ?>assets/img/Proaktif.png" alt="perusahaan holding company yang begerak di bidang Industri Batik, Pariwisata, Properti, Food and Beverage. Trusmi group maju bersama tim manajemen yang profesional, penuh semangat, mencintai budaya dan berjiwa muda." class="rounded mw-200 lazy-load">
                                                                    </div>
                                                                    <div class="border-0 shadow-none text-start" style="min-height: ;">
                                                                        <div class="row align-items-center">
                                                                            <div class="col text-center">
                                                                                <p>Berani Berencana, Berani Aksi</p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="swiper-slide pb-2">
                                                                <div class="border-0 shadow-none">
                                                                    <div class="border-0 shadow-none">
                                                                        <img src="<?= base_url(); ?>assets/img/Penebar-energi-positif.png" alt="perusahaan holding company yang begerak di bidang Industri Batik, Pariwisata, Properti, Food and Beverage. Trusmi group maju bersama tim manajemen yang profesional, penuh semangat, mencintai budaya dan berjiwa muda." class="rounded mw-200 lazy-load">
                                                                    </div>
                                                                    <div class="border-0 shadow-none text-start" style="min-height: ;">
                                                                        <div class="row align-items-center">
                                                                            <div class="col text-center">
                                                                                <p>Ber-mindset Positif, Berperilaku Positif</p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="col-12 col-md-6 align-self-center py-4">
                                                    ...
                                                    <p class="text-secondary small mb-4" style="text-align: justify;">
                                                        &nbsp;&nbsp;&nbsp;<strong>Terima Kasih</strong> sudah mengisi Formulir Registrasi Calon Karyawan kami, Data anda sudah kami rekap, tahap selanjutnya mohon tunggu kabar lebih lanjut dari <strong>Tim HR</strong> kami.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <?php } else { ?>
                                    ...
                                    <div id="smartwizard" class="mb-4 sw sw-theme-default sw-justified">
                                        <ul class="nav nav-fill">
                                            <li class="nav-item">
                                                <a class="nav-link inactive active" href="#step-0">
                                                    <div class="avatar avatar-40 d-none d-md-inline-block rounded-circle mb-1"><i class="bi bi-emoji-smile mb-1"></i></div>
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link inactive" href="#step-6">
                                                    <div class="avatar avatar-40 d-none d-md-inline-block rounded-circle mb-1"><i class="bi bi-check-circle mb-1"></i></div>
                                                    <p class="d-none d-md-block">Persetujuan</p>
                                                </a>
                                            </li>
                                        </ul>
                                        <div class="tab-content mb-4">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                                    ...
                                                                    <div class="swiper-wrapper">
                                                                        <div class="swiper-slide pb-2">
                                                                            <div class="border-0">
                                                                                ...
                                                                                <div class="text-start border-0 shadow-none">
                                                                                    <div class="row align-items-center">
                                                                                        <div class="col text-center">
                                                                                            <p>Semakin Tumbuh, Semakin Berilmu Dan Sejahtera</p>
                                                                                        </div>
                                                            ...
                                                            <div class="col-12 col-md-6 align-self-center py-4">
                                                                <p class="h4 fw-light mb-3">Saudara/i yang Terhormat,</p>
                                                                <p class="text-secondary small mb-4" style="text-align: justify;">
                                                                    &nbsp;&nbsp;&nbsp;Selamat datang dalam proses penerimaan karyawan baru di <b>Trusmi Group</b>. Kami menghargai minat dan waktu yang Anda luangkan untuk menjelajahi peluang karier bersama kami. Informasi yang Anda berikan akan memainkan peran kunci dalam proses seleksi. Jika ada pertanyaan, tim HR kami siap membantu Anda.<br>&nbsp;&nbsp;&nbsp; Sebelum Anda mulai mengisi formulir registrasi, harap isi dengan teliti dan jujur.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="mb-3 col-12 col-md-6">
                                                                ...
                                                                <input type="text" class="form-control border-custom" id="employee_name" value="<?= $ck['full_name'] ?? $profile['full_name']; ?>">
                                                            ...
                                                            <div class="col-12 col-md-6">
                                                                ...
                                                                <select id="nice-select-gender" class="wide mb-3">
                                                                    <option value="" selected disabled>-- Pilih --</option>
                                                                    <option value="Pria" <?= isset($ck['gender']) && $ck['gender'] === 'Pria' ? 'selected' : ''; ?>>Pria</option>
                                                                    <option value="Wanita" <?= isset($ck['gender']) && $ck['gender'] === 'Wanita' ? 'selected' : ''; ?>>Wanita</option>
                                                                </select>
                                                            </div>
                                                            <div class="mb-3 col-12 col-md-6">
                                                                <label for="no_ktp" class="form-label-custom required">No KTP</label>
                                                                <input type="text" class="form-control border-custom only-nummber" id="no_ktp" value="<?= $ck['no_ktp']; ?>">
                                                                <div class="valid-feedback">
                                                            ...
                                                            <div class="mb-3 col-12 col-md-6">
                                                                ...
                                                                <input type="text" class="form-control border-custom only-nummber" id="no_kk" value="<?= $ck['no_kk']; ?>">
                                                                <div class="valid-feedback">
                                                            ...
                                                            <div class="mb-3 col-12 col-md-4">
                                                                ...
                                                                <input type="text" class="form-control border-custom only-nummber" id="no_npwp" value="<?= $ck['no_npwp']; ?>">
                                                                <div class="valid-feedback">
                                                            ...
                                                            <div class="mb-3 col-12 col-md-4">
                                                                ...
                                                                <input type="text" class="form-control border-custom" id="tempat_lahir" value="<?= $ck['tempat_lahir'] ?? ''; ?>">
                                                                <div class="valid-feedback">
                                                            ...
                                                            <div class="mb-3 col-12 col-md-4">
                                                                ...
                                                                <input type="tel" pattern="\d*" class="form-control border-custom" id="tgl_lahir" placeholder="____-__-__" value="<?= $ck['tgl_lahir'] ?? $profile['tgl_lahir']; ?>">
                                                            ...
                                                            <div class="mb-3 col-12 col-md-6">
                                                                ...
                                                                <textarea name="alamat_ktp" id="alamat_ktp" class="form-control border-custom" cols="30" rows="5"><?= $ck['alamat_ktp'] ?? ''; ?></textarea>
                                                                <div class="valid-feedback">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="form-check">
                                                                            ...
                                                                            <input class="form-check-input" type="checkbox" id="sama_dengan_ktp">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <textarea name="alamat_saat_ini" id="alamat_saat_ini" class="form-control border-custom" cols="30" rows="5"><?= $ck['alamat_saat_ini'] ?? $profile['alamat_ktp']; ?></textarea>
                                                            </div>
                                                            <div class="mb-3 col-12 col-md-6">
                                                                <label for="no_hp" class="form-label-custom required">Nomor Telepon/Handphone</label>
                                                                <input type="text" class="form-control border-custom only-nummber" id="no_hp" value="<?= $ck['no_hp'] ?? $profile['no_hp']; ?>">
                                                                <div class="valid-feedback">
                                                            ...
                                                            <div class="mb-3 col-12 col-md-6">
                                                                ...
                                                                <input type="email" class="form-control border-custom" id="email" placeholder="name@example.com" value="<?= $ck['email'] ?? $profile['email']; ?>">
                                                                <div class="valid-feedback">
                                                            ...
                                                            <div class="col-12 col-md-4">
                                                                ...
                                                                <select id="nice-select-agama" name="agama" class="wide mb-3">
                                                            ...
                                                            <div class="col-12 col-md-4">
                                                                ...
                                                                <select id="nice-select-kewarganegaraan" class="wide mb-3">
                                                            ...
                                                            <div class="col-12 col-md-4">
                                                                ...
                                                                <select id="nice-select-status" name="status" id="status" class="wide mb-3">
                                                            ...
                                                            <div class="mb-3 col-12 col-md-4 kondisi-status-menikah">
                                                                ...
                                                                <input type="text" class="form-control border-custom" id="tempat_status">
                                                                <div class="valid-feedback">
                                                            ...
                                                            <div class="mb-3 col-12 col-md-4 kondisi-status-menikah">
                                                                ...
                                                                <input type="text" class="form-control border-custom" id="tgl_status">
                                                            ...
                                                            <div class="mb-3 col-12 col-md-4 kondisi-status-cerai">
                                                                ...
                                                                <input type="text" class="form-control border-custom" id="tahun_status">
                                                                <div class="valid-feedback">
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="file" class="form-label-custom required">Pas Foto</label>
                                                                <input type="file" class="filepond" name="filepond[]" id="pas_foto" data-max-file-size="3MB" data-max-files="1" />
                                                                <input type="hidden" name="" id="pas_foto_temp" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card border-0">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="col-12 text-end">
                                                            <button class="button-4" id="btn-add-keluarga"><i class="bi bi-plus"></i> Keluarga</button>
                                                        </div>
                                                        <div class="col-12">
                                            ...
                                            <div id="step-3" class="tab-pane" role="tabpanel" style="display: none;">
                                                <div class="card border-0">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="col-12 text-end">
                                                            <button class="button-4" id="btn-add-pendidikan"><i class="bi bi-plus"></i> Pendidikan</button>
                                                        </div>
                                                        <div class="col-12">
                                            ...
                                            <div id="step-4" class="tab-pane" role="tabpanel" style="display: none;">
                                                <div class="card border-0">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="col-12 text-end">
                                                            <button class="button-4" id="btn-add-pengalaman-kerja"><i class="bi bi-plus"></i> Pengalaman Kerja</button>
                                                        </div>
                                                        <div class="col-12">
                                                        ...
                                                        <div class="col-12 text-end">
                                                            <button class="button-4" id="btn-add-pengalaman-organisasi"><i class="bi bi-plus"></i> Pengalaman Organisasi</button>
                                                        </div>
                                                        <div class="col-12">
                                            ...
                                            <div id="step-5" class="tab-pane" role="tabpanel" style="display: none;">
                                                <div class="card border-0">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="col-12 text-end">
                                                            <button class="button-4" id="btn-add-bahasa"><i class="bi bi-plus"></i> Bahasa</button>
                                                        </div>
                                                        <div class="col-12">
                                                        ...
                                                        <div class="col-12 text-end">
                                                            <button class="button-4" id="btn-add-training"><i class="bi bi-plus"></i> Training</button>
                                                        </div>
                                                        <div class="col-12">
                                                        ...
                                                        <div class="col-12 text-end">
                                                            <button class="button-4" id="btn-add-pekerjaan-favorit"><i class="bi bi-plus"></i> Pekerjaan Favorit</button>
                                                        </div>
                                                        <div class="col-12">
                                                        ...
                                                        <div class="col-12 mb-3">
                                                            <textarea name="motivasi" id="motivasi" cols="30" rows="4" class="form-control border-custom"><?= $ck['motivasi'] ?? ''; ?></textarea>
                                                        </div>
                                                        <hr>
                                                        <h4><u>Kesediaan</u></h4>
                                                        <p class="required">Kapan Anda dapat memulai pekerjaan baru ?</p>
                                                        <div class="col-12 mb-3">
                                                            <input type="tel" pattern="\d*" name="kesediaan_1" class="form-control border-custom tgl tanggal" id="kesediaan_1" value="<?= $ck['kesediaan_1'] ?? ''; ?>">
                                                        </div>
                                                        <p class="required">Bersediakah Anda menitipkan Ijazah di perusahaan ini ?</p>
                                                        <div class="col-12 mb-3">
                                                            <textarea name="kesediaan_2" id="kesediaan_2" cols="30" rows="4" class="form-control border-custom"><?= $ck['kesediaan_2'] ?? ''; ?></textarea>
                                                        </div>
                                                        <p class="required">Bersediakah membawa kendaraan pribadi/ motor untuk kepentingan pekerjaan ?(Mohon sertakan Nopol)</p>
                                                        <div class="col-12 mb-3">
                                                            <textarea name="kesediaan_3" id="kesediaan_3" cols="30" rows="4" class="form-control border-custom"><?= $ck['kesediaan_3'] ?? ''; ?></textarea>
                                                        </div>
                                                        <p class="required">Bersediakah membawa laptop pribadi untuk kebutuhan pekerjaan ?</p>
                                                        <div class="col-12 mb-3">
                                                            <textarea name="kesediaan_4" id="kesediaan_4" cols="30" rows="4" class="form-control border-custom"><?= $ck['kesediaan_4'] ?? ''; ?></textarea>
                                                        </div>
                                                        <p class="required">Bersediakah Anda ditempatkan di luar kota ?</p>
                                                        <div class="col-12 mb-3">
                                                            <textarea name="kesediaan_5" id="kesediaan_5" cols="30" rows="4" class="form-control border-custom"><?= $ck['kesediaan_5'] ?? ''; ?></textarea>
                                                        </div>
                                                        ...
                                                        <div class="col-12 mb-3">
                                                            <textarea name="hobi" id="hobi" cols="30" rows="4" class="form-control border-custom"><?= $ck['hobi'] ?? ''; ?></textarea>
                                                        </div>
                                                        <hr>
                                                        <h4><u>Referensi (Kecuali Keluarga)</u></h4>
                                                        <div class="col-12 text-end">
                                                            <button class="button-4" id="btn-add-referensi"><i class="bi bi-plus"></i> Referensi</button>
                                                        </div>
                                                        <div class="col-12">
                                            ...
                                            <div id="step-6" class="tab-pane" role="tabpanel" style="display: none;">
                                                <div class="card border-0">
                                                    <div class="card-body">
                                                        <div class="d-flex justify-content-center">
                                                            <div class="col-10 py-2">
                                                                <p><strong>Terima Kasih</strong> atas partisipasi dan waktu yang sudah Anda luangkan untuk mengisi Formulir Registrasi Calon Karyawan kami. Itu akan kami anggap sebgai tindakan yang menunjukkan komitmen dan minat Anda untuk menjadi bagian dari tim kami.</p>
                                                                <br>
                                                                <br>
                                                                <div class="form-check" style="cursor: pointer;">
                                                                    <input class="form-check-input" type="checkbox" value="" id="checkSyarat">
                                                                    <label class="form-check-label" for="checkSyarat">
                                                                        Dengan ini saya menyatakan bahwa data dan keterangan di atas adalah benar, dan saya bersedia mempertanggungjawabkan kebenaran data dan keterangan tersebut.
                                                                    </label>
                                                                </div>
                                                                <div class="d-flex justify-content-center mt-4">
                                                                    <button class="btn btn-block btn-success text-white" id="btn-submit-form" type="button" disabled>Submit Formulir</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <?php $this->load->view('fack/form_js'); ?>
</body>
