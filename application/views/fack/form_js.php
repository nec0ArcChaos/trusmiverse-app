            ...
            $("#smartwizard").on("leaveStep", function(e, anchorObject, stepIndex, nextStepIndex, stepDirection) {
                ...
                if (stepIndex == 1) {
                    if (stepDirection == 'forward' && elmForm) {
                        console.log($('#nice-select-gender').val());
                        ...
                        if ($('#nice-select-gender').val() == "" || $('#nice-select-gender').val() == null) {
                            alert_validation('Anda belum memilih jenis kelamin', 'gender')
                            return false;
                        } else {
                            $('#nice-select-gender').removeClass('is-invalid')
                        ...
                        if (response.done == true) {
                            ...
                            setTimeout(() => {
                                ...
                                $.confirm({
                                    ...
                                    theme: 'material',
                                    type: 'red',
                                    content: 'Gagal submit formulir!' + response.msg,
                                    buttons: {
                                        close: {
                                            actions: function() {}
                                        },
            ...
            $.confirm({
                ...
                content: function() {
                    ...
                    return $.ajax({
                        ...
                        // } else {
                        opt_custom += `${array_status_keluarga.includes('Suami') ? '' : '<option value="Suami">Suami</option>'}`
