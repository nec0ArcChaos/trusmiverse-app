...
<script type="text/javascript">
  ...
  function add_mom()
  {
    ...
    $.ajax({
      url: "<?= base_url('mom_new/clear_result'); ?>",
      method: "GET",
      dataType: "JSON",
      success: function(res){
  ...
  function remove_action(issue_no) {
    ...
    if (no > 1) {
      ...
      $.ajax({
        url: '<?php echo base_url() ?>mom_new/delete_issue_item',
        type: 'POST',
        dataType: 'JSON',
        data: {
          id_mom: id_mom,
  ...
  function add_issue() {
    ...
    <span class="btn btn-md btn-outline-success" onclick="add_action(${next_no})"><i class="bi bi-plus-square"></i> Action</span>
    <span class="btn btn-md btn-outline-danger" id="btn_remove_action_${next_no}" onclick="remove_action(${next_no})" style="display:none;"><i class="bi bi-dash-square"></i> Action</span>
    </td>
    </tr>`;
  ...
  function remove_issue() {
    ...
    if (no > 1) {
      ...
      $.ajax({
        url: '<?php echo base_url() ?>mom_new/delete_issue',
        type: 'POST',
        dataType: 'JSON',
        data: {
          id_mom: id_mom,
  ...
  function add_issue_draft() {
    ...
    <td style="cursor: pointer;" colspan="5">
    <span class="btn btn-md btn-outline-success" onclick="add_action_draft(${next_no})"><i class="bi bi-plus-square"></i> Action</span>
    <span class="btn btn-md btn-outline-danger" id="btn_remove_action_draft_${next_no}" style="display:none;" onclick="remove_action_draft(${next_no})"><i class="bi bi-dash-square"></i> Action</span>
    </td>
    </tr>`;
  ...
  function get_issue_result(id_mom) {
    $.confirm({
      ...
      onOpen: function() {
        $.ajax({
          url: '<?php echo base_url() ?>mom_new/get_issue_result/'+id_mom,
          type: 'GET',
          dataType: 'json'
        })
        .done(function(data) {
