                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-auto ms-auto ps-0">
                            <button type="button" class="btn btn-md btn-outline-warning" onclick="list_draft()"><i class="bi bi-bookmark-star"></i> List Draft</button>
            ...
            <div class="card border-0">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-auto align-self-center">
                            <h6 class="fw-medium mb-0">List Rekap Point</h6>
                        </div>
                                                    ...
                                                    <div class="col-12 col-md-4 mb-2">
                                                        <div class="form-group mb-3 position-relative check-valid tgl">
                                                            <div class="input-group input-group-lg">
                                                                ...
                                                                <div class="form-floating">
                                                                    <input type="text" class="form-control border-start-0" name="tanggal" id="tanggal" placeholder="Date">
                                                    ...
                                                    <div class="col-12 col-md-4 mb-2">
                                                        <div class="form-group mb-3 position-relative check-valid tgl_draft">
                                                            <div class="input-group input-group-lg">
                                                                <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-calendar-event"></i></span>
                                                                <div class="form-floating">
                                                                    <input type="text" class="form-control border-start-0" name="tanggal_draft" id="tanggal_draft" placeholder="Date">
                                                                    <label>Date <b class="text-danger small">*</b></label>
                                                                </div>
                                                            </div>
                                                        </div>
