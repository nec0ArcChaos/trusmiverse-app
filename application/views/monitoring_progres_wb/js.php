...
<script>
    const baseUrl = '<?= base_url('/monitoring_progres_wb') ?>';
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "render": function(data, type, row, meta) {
                        ...
                        return `<a role="button" class="badge bg-${color}" style="cursor:pointer; margin-left:10px;" onclick="show_update_progres_wb('${row['id_wb']}', '${data}')">
                                    ${status_progres}
                                </a>`;
                    },
                    "className": "text-center"
    ...
    // wbdev
    function show_update_progres_wb(id_wb, status) {
    ...
    function list_wb_waiting() {
        ...
        $('#dt_list_wb_waiting').DataTable({
            ...
            "ajax": {
                "dataType": 'json',
                "type": "POST",
                "url": `${baseUrl}/dt_list_wb_waiting`,
                "data": {
                    status: 1
                    // start: '2025-04-01',
                    // end: '2025-04-30'
