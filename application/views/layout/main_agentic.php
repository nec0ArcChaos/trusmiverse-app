...
<body class="d-flex flex-column h-100 sidebar-pushcontent theme-blue menu-close" data-sidebarstyle="sidebar-pushcontent" data-theme="theme-blue">
                            ...
                            <div class="col-auto">
                                <div class="d-none d-md-inline-block mt-1">
                                    <div class="d-flex justify-content-between">
                                        <p class="d-none" id="text-pembelajar" style="font-size: 8pt;margin-right:10px;text-align:justify;margin-bottom: 0px;"><span style="margin-top: 10px;margin-right: 10px;">Pembelajar !!!</span></p>
                                        <p class="d-none" id="text-proaktif" style="font-size: 8pt;margin-right:10px;text-align:justify;margin-bottom: 0px;"><span style="margin-top: 10px;margin-right: 10px;">Proaktif !!!</span></p>
                                        <p class="d-none" id="text-positif" style="font-size: 8pt;margin-right:10px;text-align:justify;margin-bottom: 0px;"><span style="margin-top: 10px;margin-right: 10px;">Penebar Energi Positif !!!</span></p>
                                        <img src="<?= base_url(); ?>assets/img/860398-removebg.png" alt="" class="img-fluid" style="max-height: 35px;">
                                        <p style="font-size: 8pt;margin-left:10px;margin-right:10px;text-align:justify;margin-bottom: 0px;">Fungsi Leader : Plan, Delegasi, Monitoring,<br> Controling, Evaluasi & Problem Solving</p>
                ...
                $ul.children('li').each(function() {
                    ...
                    if ($a.length) {
                        ...
                        if (href !== '#' && href !== 'home.html#' && href !== 'javascript:void(0)') {
                            result.push({ path: newPath.join(' > '), href });
                        }
