        ...
        <div class="row mb-4 align-items-start">
            ...
            <div class="col-12 col-md pt-2">
                ...
                <a role="button" class="badge bg-light-yellow text-dark" data-bs-toggle="modal"
                    data-bs-target="#modal_change_ttd">
                    ...
                    <div class="card-body pb-0">
                        ...
                        <div class="row align-items-center mb-3">
                            ...
                            <div class="col">
                                ...
                                <a class="btn btn-sm rounded btn-success text-white" target="_blank" href="https://api.whatsapp.com/send/?phone=6288971936684&amp;text=/trusmi">Register Notif Whatsapp <i class="bi bi-whatsapp"></i></a>
                        <!-- <p><?= $personal_info->contact_no; ?></p> -->
                            </div>
                        </div>
                        <div class="row align-items-center mb-3">
...
<!-- Floating avatar & panel -->
    <!-- <div class="floating" aria-hidden="false" style="display:none">
    ...
    <div class="panel" id="panel" role="dialog" aria-label="Ella panel" style="display:none">
        <div class="header ms-1">
            <div style="width:44px;height:44px;border-radius:10px;background:aliceblue;display:flex;align-items:center;justify-content:center;color:#061226;font-weight:700">ES</div>
            <div>
                        ...
                        <div class="select-box text-center mb-2"
                            ...
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    ...
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-3.jpg" alt=""
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="select-box text-center mb-2"
                            ...
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    ...
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-4.jpg" alt=""
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="select-box text-center mb-2"
                            ...
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    ...
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-5.jpg" alt=""
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="select-box text-center mb-2"
                            ...
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    ...
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-6.jpg" alt=""
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="select-box text-center mb-2"
                            ...
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    ...
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-7.jpg" alt=""
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="select-box text-center mb-2"
                            ...
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    ...
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-8.jpg" alt=""
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="select-box text-center mb-2"
                            ...
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    ...
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-9.jpg" alt=""
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="select-box text-center mb-2"
                            ...
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    ...
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-10.jpg" alt=""
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="select-box text-center mb-2"
                            ...
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    ...
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-11.jpg" alt=""
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="select-box text-center mb-2"
                            ...
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    ...
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-12.jpg" alt=""
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="select-box text-center mb-2"
                            ...
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    ...
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-13.jpg" alt=""
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="select-box text-center mb-2"
                            ...
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    ...
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-14.jpg" alt=""
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="select-box text-center mb-2"
                            ...
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    ...
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-15.jpg" alt=""
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="select-box text-center mb-2"
                            ...
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    ...
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-16.jpg" alt=""
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="select-box text-center mb-2"
                            ...
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    ...
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-17.png" alt=""
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="select-box text-center mb-2"
                            ...
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    ...
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-18.jpg" alt=""
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="select-box text-center mb-2"
                            ...
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    ...
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-19.jpg" alt=""
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="select-box text-center mb-2"
                            ...
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    ...
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-20.jpg" alt=""
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="select-box text-center mb-2"
                            ...
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    ...
                                    <img src="https://trusmiverse.com/apps/assets/img/bga-1.avif" alt=""
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="select-box text-center mb-2"
                            ...
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    ...
                                    <img src="https://trusmiverse.com/apps/assets/img/batik.jpeg" alt=""
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div>
                    <button id="clear-button" class="btn btn-secondary btn-sm mt-2"><i class="bi bi-bootstrap-reboot"></i> Reset</button>
