<main class="main mainheight">
    ...
    <div class="w-100 py-1 py-md-1 py-lg-1 position-relative bg-theme z-index-0">
        ...
        <div class="text-end top-0 end-0 m-3">
            <a href="<?= base_url(); ?>theme" class="btn btn-light"><i class="bi bi-palette text-gradient btn-link">
                </i> &nbsp;&nbsp;<span class="text-gradient">Theme</span></a>
            <button class="btn btn-light" type="button" data-bs-toggle="modal"
                data-bs-target="#modal_change_profile_background"><i class="bi bi-camera"> </i> &nbsp;&nbsp;Change
                Cover</button>
        </div>
                ...
                <div class="col-12 col-md-12 col-lg-12 position-relative my-4">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-12 col-md-3 col-lg-3 mr-1 ml-1 mb-1">
                                    ...
                                    <select name="employee_id" id="employee_id"
                                        class="wide text-dark <?= $class_none; ?>" style="color: black;">
                                    </select>
                                </div>
                                <div class="col-12 col-md-3 col-lg-3 mr-1 ml-1 mb-1">
                                    <label>Month</label>
                                ...
                                <div class="col-12 <?= $col ?> mr-1 ml-1 mb-1">
                                    <label>Year</label>
                                    <select name="year" id="year" class="wide mr-1 ml-1 text-dark"
                                        style="color: black;">
                                ...
                                <div class="col-12 col-md-2 col-lg-2 mr-1 ml-1 mb-1 <?= $class_none; ?>">
                                    ...
                                    <select name="cutoff" id="cutoff"
                                        class="wide mr-1 ml-1 text-dark <?= $class_none; ?>" style="color: black;">
                                ...
                                <div class="col-12 col-md-2 col-lg-2 mr-1 ml-1 mb-1">
                                    <label>&nbsp;</label>
                                    <button class="button-4 w-100" type="button" id="filter" onclick="filter_detail()"
                                        style="height: 38px;"><i class="fa fa-search"></i> Show</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row text-center align-items-center">
                        ...
                        <div class="col-4 col-md border-start">
                            <p class="text-muted small" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="Click here to see details...">Presence</p>
        ...
        <div class="row mb-4 align-items-start">
            <div class="col-auto position-relative">
                <figure class="avatar avatar-160 coverimg rounded-circle top-80 shadow-md border-3 border-light">
                    <img src="https://trusmiverse.com/hr/uploads/profile/<?= $personal_info->profile_picture; ?>"
                        alt="" />
                </figure>
                <div class="text-end bottom-0 end-0 z-index-1 me-3 mb-1 h-auto">
                    <button class="btn btn-theme btn-44 shadow-sm rounded-circle" data-bs-toggle="modal"
                        data-bs-target="#modal_change_profile_picture"><i class="bi bi-camera"></i></button>
                </div>
            </div>
            <div class="col-12 col-md pt-2">
                ...
                <p><span class="text-secondary"><i
                            class="bi bi-briefcase me-1"></i><?= $personal_info->department_name; ?>,</span>
                    <?= $personal_info->company_name; ?></p>
                <span class="badge bg-light-theme text-theme">
                    <span class="avatar avatar-20 rounded-circle me-1 vm"><i class="bi bi-telephone"></i></span>
                    <?= $personal_info->contact_no; ?>
                </span>
                <span class="badge bg-light-theme text-theme">
                    <span class="avatar avatar-20 rounded-circle me-1 vm"><i class="bi bi-envelope"></i></span>
                    <?= $personal_info->email; ?>
                </span>
                <a role="button" class="badge bg-light-yellow text-dark" data-bs-toggle="modal"
                    data-bs-target="#modal_ttd">
                    <span class="avatar avatar-20 rounded-circle me-1 vm"><i class="fa-solid fa-signature"></i></span>
                    Upload Tanda Tangan
                </a>
            </div>
            <div class="col-12 col-xl-auto py-3">
                <div>
                    ...
                    <a href="<?= base_url(); ?>hr/rekap_absen" class="btn btn-outline-theme me-2"><i
                            class="bi bi-calendar vm me-2"></i> Rekap Absen</a>
                    <a href="<?= base_url(); ?>leave" class="btn btn-theme"><i class="bi bi-person-plus vm me-2"></i>
                        Izin / Cuti</a>
                </div>
                <br>
            </div>
    ...
    <div class="container mb-4 mt-2">
        <nav class="nav nav-pills flex-column flex-sm-row">
            <a class="flex-sm-fill text-sm-center nav-link active-4" aria-current="page" role="button"
                id="btn_personal_details">Personal Details</a>
            <!-- <a class="flex-sm-fill text-sm-center nav-link" role="button" id="btn_manage_leave">Manage Leave</a> -->
            <a class="flex-sm-fill text-sm-center nav-link" role="button" id="btn_history_warning">History Warning
                Lock</a>
                ...
                <div class="card border-0 mb-4 bg-gradient-theme-light">
                    <div class="card-header bg-gradient-theme-light">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <a href="javascrip:void(0)" class="btn btn-link btn-square text-secondary"
                                    data-bs-toggle="modal" data-bs-target="#modal_change_personal_info">
                                    <i class="bi bi-pencil-square"></i>
                                </a>
                                <a href="javascrip:void(0)" class="btn btn-link btn-square text-secondary"
                                    data-bs-toggle="modal" data-bs-target="#modal_change_password">
                    ...
                    <div class="card-body pb-0">
                        ...
                        <div class="row align-items-center mb-3">
                            <div class="col-auto">
                                <i class="bi bi-whatsapp h5 text-theme mb-0"></i>
                            </div>
                            <div class="col">
                                ...
                                <?php if ($personal_info->registered == 0) { ?>
                                    <a class="badge bg-success text-white"
                                        href="<?php echo base_url(); ?>whatsapp_register">Register Notif Whatsapp <i
                        ...
                        <div class="row align-items-center mb-3">
                            <div class="col-auto">
                                <i class="bi bi-envelope-check h5 text-theme mb-0"></i>
                            </div>
                            <div class="col">
                                <p class="text-secondary small mb-1">Email Corporate</p>
                                <p><?= $personal_info->email_corporate; ?></p>
                            </div>
                        </div>
                        <div class="row align-items-center mb-3">
                            <div class="col-auto">
                        ...
                        <div class="row align-items-center mb-3">
                            <div class="col-auto">
                                <?php if ($personal_info->gender == 'Male') { ?>
                                    <i class="bi bi-gender-male h5 text-theme mb-0"></i>
                                <?php } else { ?>
                                    <i class="bi bi-gender-female h5 text-theme mb-0"></i>
                                <?php } ?>
                            </div>
                            <div class="col">
                        ...
                        <div class="row align-items-center mb-3">
                            <div class="col-auto">
                                <i class="bi bi-pen h5 text-theme mb-0"></i>
                            </div>
                            <div class="col">
                ...
                <div class="card bg-gradient-theme-light border-0 mb-4">
                    <div class="card-header bg-gradient-theme-light">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <a href="javascrip:void(0)" class="btn btn-link btn-square text-secondary"
                                    data-bs-toggle="modal" data-bs-target="#modal_change_rekening">
                                    <i class="bi bi-pencil-square"></i>
                                </a>
                                <a href="javascrip:void(0)" class="btn btn-link btn-square text-secondary"
                                    data-bs-toggle="modal" data-bs-target="#modal_change_pin_slip">
                                    <i class="bi bi-person-lock"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="card-body px-0">
                        <div
                            class="swiper-container creditcardsvertical swiper-cards swiper-3d swiper-initialized swiper-horizontal swiper-pointer-events">
                            <div class="swiper-wrapper" id="swiper-wrapper-a9fe8210cf8c8461" aria-live="polite"
                                style="cursor: grab;">
                                <div class="swiper-slide swiper-slide-visible swiper-slide-active" role="group"
                                    aria-label="1 / 3"
                                    style="width: 300px; z-index: 3; transform: translate3d(0px, 0px, 0px) rotateZ(0deg) scale(1);">
                                ...
                                <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 3"
                                    style="width: 300px; z-index: 2; transform: translate3d(calc(-300px + 7.25%), 0px, -100px) rotateZ(2deg) scale(1);">
                                ...
                                <div class="swiper-slide" role="group" aria-label="3 / 3"
                                    style="width: 300px; z-index: 1; transform: translate3d(calc(-600px + 13%), 0px, -200px) rotateZ(4deg) scale(1);">
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-12 col-md-12 col-lg-3 mb-2">
                                <h6 class="fw-medium">
                                    <i
                                        class="bi bi-box-arrow-right h5 me-1 avatar avatar-40 bg-light-theme rounded me-2"></i>
                                    Leave
                                </h6>
                            </div>
                            ...
                            <div class="col-12 col-md-4 col-lg-3 mr-1 ml-1 mb-1">
                                ...
                                <div class="d-flex justify-content-around">
                                    <button class="button-4-icon col-5 ml-1 mr-1" type="button" id="filter-leave"
                                        onclick="filter_manage_leave()" style="height: 38px;"><i
                                            class="fa fa-search"></i></button>
                                    <button class="button-4-icon col-5 ml-1 mr-1" type="button" id="add-leave"
                                        onclick="add_manage_leave()" style="height: 38px;"><i
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-12 col-md-12 col-lg-3 mb-2">
                                <h6 class="fw-medium">
                                    <i
                                        class="bi bi-exclamation-diamond-fill h5 me-1 avatar avatar-40 bg-light-theme rounded me-2"></i>
                            ...
                            <div class="col-12 col-md-4 col-lg-3 mr-1 ml-1 mb-1">
                                <label>&nbsp;</label>
                                <button class="button-4 w-100" type="button" id="filter-history"
                                    onclick="filter_history_warning()" style="height: 38px;"><i
    ...
    <div class="container mt-2" id="container_e_training">
        <div class="row mb-4 py-2">
            <div class="col text-center">
                ...
                <p class="text-secondary">You should learn and explore opportunities. If there is obstacles, try to
                    remove it and improvise.</p>
            </div>
        </div>
...
<!-- Modal -->
<div class="modal fade" id="modal_detail_absen" tabindex="-1" aria-labelledby="modal_detail_absenLabel"
    aria-hidden="true">
                    ...
                    <div class="card mb-1 mt-1">
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    <div class="row">
                                        <p class="text-dark small mb-1 col-12 col-md-6" style="font-weight: bold;">Tgl
                                        </p>
                                        <p class="text-dark small mb-1 col-12 col-md-6">Shift : <span>In</span> s/d
                                            <span>Out</span>
                                        </p>
                                    </div>
                                    <div class="row">
...
<div class="modal fade" id="modal_change_profile_picture" data-bs-backdrop="static" data-bs-keyboard="false"
...
<!-- Modal TTD -->
<div class="modal fade" id="modal_change_ttd" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header d-block">
                    ...
                    <div class="col-12 text-center">
                        <?php if ($personal_info->ttd != "") { ?>
                            ...
                            <img style="height: 150px;"
                                src="https://www.trusmiverse.com/apps/uploads/ttd/<?= $personal_info->ttd; ?>" alt=""
                                srcset="">
                        <?php } else { ?>
                            <p>Belum Ada Ttd</p>
                        <?php } ?>
...
<!-- Modal Cover Picture -->
<div class="modal fade" id="modal_change_profile_background" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div class="row" id="profile-background">
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bg-1.jpg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bg-1.jpg&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-1.jpg" alt="" class="w-100"
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bg-2.jpg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bg-2.jpg&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-2.jpg" alt="" class="w-100"
                                        loading="lazy" style="display: none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bg-3.jpg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bg-3.jpg&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-3.jpg" alt="" loading="lazy"
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bg-4.jpg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bg-4.jpg&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-4.jpg" alt="" loading="lazy"
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bg-5.jpg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bg-5.jpg&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-5.jpg" alt="" loading="lazy"
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bg-6.jpg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bg-6.jpg&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-6.jpg" alt="" loading="lazy"
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bg-7.jpg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bg-7.jpg&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-7.jpg" alt="" loading="lazy"
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bg-8.jpg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bg-8.jpg&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-8.jpg" alt="" loading="lazy"
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bg-9.jpg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bg-9.jpg&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-9.jpg" alt="" loading="lazy"
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bg-10.jpg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bg-10.jpg&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-10.jpg" alt="" loading="lazy"
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bg-11.jpg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bg-11.jpg&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-11.jpg" alt="" loading="lazy"
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bg-12.jpg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bg-12.jpg&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-12.jpg" alt="" loading="lazy"
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bg-13.jpg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bg-13.jpg&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-13.jpg" alt="" loading="lazy"
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bg-14.jpg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bg-14.jpg&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-14.jpg" alt="" loading="lazy"
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bg-15.jpg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bg-15.jpg&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-15.jpg" alt="" loading="lazy"
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bg-16.jpg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bg-16.jpg&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-16.jpg" alt="" loading="lazy"
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bg-17.jpg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bg-17.png&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-17.png" alt="" loading="lazy"
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bg-18.jpg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bg-18.jpg&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-18.jpg" alt="" loading="lazy"
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bg-19.jpg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bg-19.jpg&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-19.jpg" alt="" loading="lazy"
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bg-20.jpg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bg-20.jpg&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-20.jpg" alt="" loading="lazy"
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bga-1.avif')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bga-1.avif&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bga-1.avif" alt="" loading="lazy"
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('batik.jpeg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/batik.jpeg&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/batik.jpeg" alt="" loading="lazy"
                                        style="display: none;">
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-auto">
                        <div class="select-box text-center mb-2"
                            onclick="temporary_change_profile_background('bg-visi-misi.jpeg')">
                            <div class="avatar avatar-100">
                                <span class="avatar avatar-80 bg-blue coverimg"
                                    style="background-image: url(&quot;https://trusmiverse.com/apps/assets/img/bg-visi-misi.jpeg&quot;);">
                                    <img src="https://trusmiverse.com/apps/assets/img/bg-visi-misi.jpeg" alt=""
                                        loading="lazy" style="display: none;">
                                </span>
                            </div>
                        </div>
...
<!-- Modal Personal Info -->
<div class="modal fade" id="modal_change_personal_info" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header d-block">
                ...
                <div class="row mb-2">
                    <div class="col-12 col-md-12 mb-2">
                        <div class="input-group input-group-md border rounded">
                            ...
                            <input class="form-control" type="text" id="u_contact_no" name="u_contact_no"
                                value="<?= $personal_info->contact_no; ?>" placeholder="Phone number">
                        </div>
                    </div>
                    <div class="col-12 col-md-12 mb-2">
                        <div class="input-group input-group-md border rounded">
                            ...
                            <input class="form-control" type="email" id="u_email" name="u_email"
                                value="<?= $personal_info->email; ?>" placeholder="Email">
                        </div>
                    </div>
                    <div class="col-12 col-md-12 mb-2">
                        <div class="input-group input-group-md border rounded">
                            <span class="input-group-text text-theme"><i class="bi bi-envelope-check"></i></span>
                            <input class="form-control" type="email" id="u_email_corporate" name="u_email_corporate"
                                value="<?= $personal_info->email_corporate; ?>" placeholder="Email Corporate">
                        </div>
                    </div>
                    <div class="col-12 col-md-12 mb-2">
                        <div class="input-group input-group-md border rounded">
                            <span class="input-group-text text-theme"><i class="bi bi-calendar2-heart"></i></span>
                            <input class="form-control tgl tanggal" type="text" id="u_date_of_birth"
                                name="u_date_of_birth" value="<?= $personal_info->date_of_birth; ?>"
                    ...
                    <div class="col-12 col-md-12 mb-2">
                        <div class="input-group input-group-md border rounded">
                            ...
                            <select class="form-control simplechosen" id="u_gender" name="u_gender">
                                <option value="Male" <?= $personal_info->gender == "Male" ? "selected" : ""; ?>>Male
                                </option>
                                <option value="Female" <?= $personal_info->gender == "Female" ? "selected" : ""; ?>>Female
                                </option>
                            </select>
                        </div>
                    </div>
...
<!-- Modal Rekening -->
<div class="modal fade" id="modal_change_rekening" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header d-block">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-md-12 mb-2">
                        <div class="input-group input-group-md border rounded">
                            ...
                            <input class="form-control" type="text" id="account_title"
...
<div class="modal fade" id="modal_change_pin_slip" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header d-block">
                ...
                <div class="row mb-2">
                    <div class="col-12 col-md-12 mb-2">
                        <div class="input-group input-group-md border rounded">
                            ...
                            <input class="form-control" type="password" id="old_ctm_pin_slip"
                                placeholder="<?= $personal_info->ctm_pin_slip == "" ? "Pin Slip" : "Pin Lama"; ?>">
                        </div>
                        <small><i><span>Default PIN 1234</span></i></small>
                    </div>
                </div>
                <h6 class="fw-medium mb-2">
                    <?= $personal_info->ctm_pin_slip == "" ? "Confirm New Pin Slip" : "Pin Baru"; ?>:
                </h6>
                <div class="row align-items-center">
                    <div class="col-12 col-md-12 mb-2">
                        <div class="input-group input-group-md border rounded">
                            <span class="input-group-text text-theme"><i class="bi bi-person-lock"></i></span>
                            <input class="form-control" type="password" id="new_ctm_pin_slip"
                                placeholder="<?= $personal_info->ctm_pin_slip == "" ? "Confirm New Pin Slip" : "Pin Baru"; ?>">
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="modal_change_password" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header d-block">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <button type="button" id="btn_close_change_password" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                </div>
            </div>
            <div class="modal-body">
                <h6 class="fw-medium mb-2"><?= $personal_info->password == "" ? "Password" : "Current  Password"; ?>:
                </h6>
                <div class="row mb-2">
                    <div class="col-12 col-md-12 mb-2">
                        <div class="input-group input-group-md border rounded">
                            ...
                            <input class="form-control" type="password" id="old_password"
                                placeholder="<?= $personal_info->password == "" ? "Password" : "Current  Password"; ?>">
                        </div>
                    </div>
                </div>
                <h6 class="fw-medium mb-2"><?= $personal_info->password == "" ? "Confirm Password" : "New Passowrd"; ?>:
                </h6>
                <div class="row align-items-center">
                    <div class="col-12 col-md-12 mb-2">
                        <div class="input-group input-group-md border rounded">
                            ...
                            <input class="form-control" type="password" id="new_password"
                                placeholder="<?= $personal_info->password == "" ? "Confirm Password" : "New Passowrd"; ?>">
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Modal Change Password -->
<div class="modal fade" id="modal_ttd" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header d-block">
                <div class="row align-items-center">
                    ...
                    <div class="col">
                        <h6 class="fw-medium mb-0">Assign Ttd Digital</h6>
                        <p class="small text-secondary">Bubuhkan ttd digital anda</p>
                    </div>
                    <div class="col-auto">
                        <button type="button" id="btn_close_change_password" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
            ...
            <div class="modal-body">
                <div id="signature-pad-container" style="width: 100%; max-width: 500px; border: 2px dashed #ccc;">
                    <canvas id="signature-pad" style="width: 100%; height: 100%; touch-action: none;"></canvas>
                </div>
                <div>
                    <button id="clear-button" class="btn btn-secondary btn-sm mt-2"><i
                            class="bi bi-bootstrap-reboot"></i> Reset</button>
                    <!-- <button class="btn btn-primary btn-sm mt-2">Simpan Tanda Tangan</button> -->
                </div>
            </div>
            <div class="modal-footer text-end">
                <button type="button" class="btn btn-theme" onclick="update_ttd_digital()">Update</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="modal_dont_dos" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-labelledby="staticBackdropLabel" aria-hidden="true" data-easein="swing">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col text-center">
                        ...
                        <!-- <img id="info_banner" src="" alt="-" loading="lazy"> -->
                        <input type="hidden" id="got_it_banner" value="0">
                    </div>
                </div>
            </div>
            <div class="modal-footer text-end">
                <button type="button" class="btn btn-info" data-bs-dismiss="modal" onclick="update_got_it()">Got
                    it!</button>
            </div>
        </div>
    </div>
...
<!-- <div class="modal fade" id="modal_campaign" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered modal-md modal-dialog-scrollable">
        <div class="modal-content">

            <div class="modal-header">
                <h5 class="modal-title">📢 Pengumuman Campaign</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>

            <div class="modal-body">
                <form id="form_campaign" enctype="multipart/form-data">

                    <?php if ($campaign > 0) { ?>
                        <div class="alert alert-success" role="alert">
                            <b>Anda sudah mengikuti campaign.</b>
                        </div>
                    <?php } else { ?>
                        <div class="alert alert-danger" role="alert">
                            <b>Anda belum mengikuti campaign.</b>
                        </div>
                    <?php } ?>

                    <div class="mb-3">
                        <div class="border rounded p-3 bg-light small" style="white-space: pre-line;">
                            📢 <strong>PEMBERITAHUAN</strong>

                            Hai Trusmi People🙌

Pak Ibnu Riyanto (CEO) akan mengunggah konten terbaru di TikTok dan Instagram pada pukul 16:00.

Mohon bantuan teman-teman untuk memberikan dukungan dengan cara <strong>LIKE</strong> dan <strong>COMMENT</strong>.  
Partisipasi dari teman-teman semua sangat membantu agar konten Trusmi Group bisa lebih ramai dan menjangkau lebih banyak audience 😊

📌 <strong>Langkah yang perlu dilakukan:</strong>

1️⃣ Berikan <strong>LIKE</strong> pada konten yang diunggah  
2️⃣ Tulis <strong>COMMENT</strong> pada konten tersebut  
3️⃣ Ambil <strong>screenshot bukti LIKE dan COMMENT</strong>  
4️⃣ Upload bukti tersebut melalui:

⚠️ <strong>Note:</strong>  
Apabila aktivitas tersebut belum dilakukan, maka <strong>absensi pulang akan otomatis ter-LOCK oleh sistem</strong> sampai bukti aktivitas diunggah.
...
Terima kasih atas partisipasi dan dukungannya 🙏
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-control bg-light">
                            <a href="<?= $campaign_link->link_tiktok ?>" target="_blank">
                                <?= $campaign_link->link_tiktok ?>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-control bg-light">
                            <a href="<?= $campaign_link->link_ig ?>" target="_blank">
                                <?= $campaign_link->link_ig ?>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-bold">Upload Screenshoot TikTok</label>
                        <input type="file" name="foto" class="form-control" accept="image/*" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-bold">Upload Screenshoot Instagram</label>
                        <input type="file" name="foto_ig" class="form-control" accept="image/*" required>
                    </div>
            ...
            <?php
            $disable_save = empty($campaign_link->link_tiktok) || empty($campaign_link->link_ig);
            ?>
...
<div class="modal fade" id="modal_reminder_change_password" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-labelledby="staticBackdropLabel" aria-hidden="true" data-easein="swing">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content alert alert-warning">
            ...
            <div class="modal-body">
                <div class="alert alert-warning d-flex align-items-center" role="alert">
                    ...
                    <div style="margin-left: 20px;">
                        <p>Password anda masih default, demi keamanan akun anda kami sarankan untuk segera ganti
                            password!</p>
                    </div>
                </div>
            ...
            <div class="modal-footer text-end">
                ...
                <button type="button" class="btn btn-primary m-1" data-bs-toggle="modal"
                    data-bs-target="#modal_change_password">Change Password</button>
            </div>
        </div>
    </div>
</div>

<div class="modal fade" id="modal_ultah" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-labelledby="staticBackdropLabel" aria-hidden="true" data-easein="swing">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col">
                        <img id="info_banner" src="<?= $personal_info->ultah_url_image; ?>" alt="-" loading="lazy"><br>
                        <div>
                            <?php
