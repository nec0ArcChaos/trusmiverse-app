    ...
    <div class="container mt-2 mt-lg-0">
        ...
        <div class="row mb-4 align-items-start">
            ...
            <div class="col-12 col-xl-auto py-3">
                <div>
                    <?php if (count($cek_pin_slip_pass) > 0) : ?>
                        <button type="button" class="btn btn-outline-theme me-2 text-center notif" data-bs-toggle="popover" data-bs-title="Notifikasi Akun" data-bs-content='<ul>
                    <li ><a href="#" onclick="show_notif(1)">Email belum di isi, Klik disini!</a></li>
                    <li><a href="#">Pin Slip masih default harap rubah!, Klik disini!</a></li>
                    <li><a href="#">Password masih default harap rubah!, Klik sini</a></li>
                </ul>'>
