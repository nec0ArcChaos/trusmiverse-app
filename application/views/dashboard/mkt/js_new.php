...
<script>
    ...
    $(document).ready(function() {
        ...
        //         name: 'Score',
        //         shape_label: {
        //             text: "<span style='fontSize: 23; color: #FF5353; font-family: var(--fontFamilyHGroup);'>48%</span><br/> <span style='fontSize: 23; color: #FF5353; font-family: var(--fontFamilyHGroup); font-weight: 600;'>Problem!</span>",
        //             style: {
        //                 fontSize: 23
        //             }
        //         },
        ...
        $('#chart_bulanan').empty();
        const ctx_bulanan1 = document.getElementById('chart_bulanan');

        new Chart(ctx_bulanan1, {
            type: 'bar',
            data: {
                ...
                datasets: [
                {
                    label: 'Actual',
                    data: [94, 62, 81, 72, 85],
                    backgroundColor: ['#91C300','#F03D4F','#91C300','#FFC107','#91C300'],
                    borderRadius: 20,
...
function chart_event() {
    var options = {
        ...
        colors: ['#016CA5', '#0396C7', '#04BBDF', '#55E3EA'],
...
function chart_displin() {
    var chart_disiplin = c3.generate({
        ...
        gauge: {
            ...
            color: {
                pattern: ['#FF0000', '#F97600', '#F6C600', '#91C300'], // the three color levels for the percentage values.
                threshold: {
        ...
        $.ajax({
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: [
                {
                    ...
                    "id_sub_task": "",
                    "title": "Meeting",
                    "className": "meeting-event cursor-pointer"
                },
                {
                    "start": "2024-05-05",
                    "end": "2024-05-05",
                    "id_sub_task": "",
                    "title": "Sharing Leader",
                    "className": "reminder-event cursor-pointer"
                },
                {
                    "start": "2024-05-07",
                    "end": "2024-05-07",
                ...
                },
                {
                    ...
                    "id_sub_task": "",
                    "title": "Co & Co",
                    "className": "birthday-event cursor-pointer"
                },
                {
                    "start": "2024-05-12",
                    "end": "2024-05-12",
                    "id_sub_task": "",
                    "title": "Breafing",
                    "className": "task-event cursor-pointer"
                }
                ],
