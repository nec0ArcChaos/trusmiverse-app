...
<script>
    ...
    function resume_absen(periode, employee_id, cutoff) {
        $.ajax({
            url: '<?= base_url('dashboard_ade/resume_absen') ?>',
            type: 'POST',
            dataType: 'json',
            data: {
                periode: periode,
            ...
            success: function(response) {
                ...
                animateValue("harus_hadir", 0, response.total_hadir.harus_hadir ?? 0, 3000); // totalx
                ...
                animateValue("late", 0, response.data.menit_telat, 3000); // latex
    ...
    function detail_absen(periode, employee_id, cutoff) { // addnew cutoff detdev
        $.ajax({
            url: '<?= base_url('dashboard_ade/detail_absen') ?>',
            type: 'POST',
            dataType: 'json',
            data: {
                periode: periode,
