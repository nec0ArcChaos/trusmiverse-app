        ...
        <div class="modal-content">            
            ...
            <div class="modal-body">
                <form id="form_problem">
                    <input type="hidden" name="id_mom" id="id_mom" value="">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                            ...
                                            <div class="row">
                                                <div class="col-12 mt-4">
                                                    <div class="form-group">
                                                        ...
                                                        <p class="text-center">Tuliskan permasalahanmu untuk di analis dengan metode 5 WHY</p>
                                                        <div class="row justify-content-between mt-5">
                                                            <div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 mb-3">
                                                                <input type="text" class="form-control" id="input_problem" name="input_problem" placeholder="Tuliskan masalah yang ingin anda selesaikan!">
                                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="why1" role="tabpanel" aria-labelledby="why1-tab">
                                            <div class="row">
                                                <div class="col-12 mt-4">
                                                    <div class="form-group">
                                                        <h6 class="fw-medium">Step 2 - Why 1</h6>
                                                        <div class="d-flex justify-content-center mb-3">
                                                            <div class="rounded p-2" style="background-color: #e5e5e5;">
                                                                <p class="text-center mb-0" id="why1_text">Why Ke 1 ?</p>
                                                            </div>
                                                        </div>
                                                        <p class="text-center">Setelah Anda menjawab pertanyaan pertama, akan terus lanjut sampai kita menemukan akar masalah. Siap? Kami memberikan rekomendasi why yang mungkin relate dengan permasalahan yang anda hadapi, atau anda bisa menentukan sendiri dengan mengisi kolom teks!</p>
                                                        <br>
                                                        <div id="why1_jawaban"></div>
                                                        <br>
                                                        <div class="row justify-content-between mt-5">
                                                            <div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 mb-3">
                                                                <input type="text" class="form-control" id="input_why1" name="input_why1" placeholder="Tuliskan akar masalah dari analisa yang dihasilkan!">
                                                            </div>
                                                            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 text-md-end">
                                        ...
                                        <div class="tab-pane fade" id="why2" role="tabpanel" aria-labelledby="why2-tab">
                                            <div class="row">
                                                <div class="col-12 mt-4">
                                                    <div class="form-group">
                                                        <h6 class="fw-medium">Step 3 - Why 2</h6>
                                                        <div class="d-flex justify-content-center mb-3">
                                                            <div class="rounded p-2" style="background-color: #e5e5e5;">
                                                                <p class="text-center mb-0" id="why2_text">Why Ke 2 ?</p>
                                                            </div>
                                                        </div>
                                                        <p class="text-center">Bagus! Kita lanjutkan ke langkah berikutnya.
                                                        Kami memberikan rekomendasi why yang mungkin relate dengan permasalahan yang anda hadapi, atau anda bisa menentukan sendiri dengan mengisi kolom teks!</p>
                                                        <br>
                                                        <div id="why2_jawaban"></div>
                                                        <br>
                                                        <div class="row justify-content-between mt-5">
                                                            <div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 mb-3">
                                                                <input type="text" class="form-control" id="input_why2" name="input_why2" placeholder="Tuliskan akar masalah dari analisa yang dihasilkan!">
                                                            </div>
                                                            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 text-md-end">
                                        ...
                                        <div class="tab-pane fade" id="why3" role="tabpanel" aria-labelledby="why3-tab">
                                            <div class="row">
                                                <div class="col-12 mt-4">
                                                    <div class="form-group">
                                                        <h6 class="fw-medium">Step 4 - Why 3</h6>
                                                        <div class="d-flex justify-content-center mb-3">
                                                            <div class="rounded p-2" style="background-color: #e5e5e5;">
                                                                <p class="text-center mb-0" id="why3_text">Why Ke 2 ?</p>
                                                            </div>
                                                        </div>
                                                        <p class="text-center">Baik, sekarang kita lanjutkan.
                                                        Kami memberikan rekomendasi why yang mungkin relate dengan permasalahan yang anda hadapi, atau anda bisa menentukan sendiri dengan mengisi kolom teks!</p>
                                                        <br>
                                                        <div id="why3_jawaban"></div>
                                                        <br>
                                                        <div class="row justify-content-between mt-5">
                                                            <div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 mb-3">
                                                                <input type="text" class="form-control" id="input_why3" name="input_why3" placeholder="Tuliskan akar masalah dari analisa yang dihasilkan!">
                                                            </div>
                                                            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 text-md-end">
                                        ...
                                        <div class="tab-pane fade" id="why4" role="tabpanel" aria-labelledby="why4-tab">
                                            <div class="row">
                                                <div class="col-12 mt-4">
                                                    <div class="form-group">
                                                        <h6 class="fw-medium">Step 5 - Why 4</h6>
                                                        <div class="d-flex justify-content-center mb-3">
                                                            <div class="rounded p-2" style="background-color: #e5e5e5;">
                                                                <p class="text-center mb-0" id="why4_text">Why Ke 2 ?</p>
                                                            </div>
                                                        </div>
                                                        <p class="text-center">Oke, kita hampir sampai ke akar masalahnya.
                                                        Kami memberikan rekomendasi why yang mungkin relate dengan permasalahan yang anda hadapi, atau anda bisa menentukan sendiri dengan mengisi kolom teks!</p>
                                                        <br>
                                                        <div id="why4_jawaban"></div>
                                                        <br>
                                                        <div class="row justify-content-between mt-5">
                                                            <div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 mb-3">
                                                                <input type="text" class="form-control" id="input_why4" name="input_why4" placeholder="Tuliskan akar masalah dari analisa yang dihasilkan!">
                                                            </div>
                                                            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 text-md-end">
                                        ...
                                        <div class="tab-pane fade" id="why5" role="tabpanel" aria-labelledby="why5-tab">
                                            <div class="row">
                                                <div class="col-12 mt-4">
                                                    <div class="form-group">
                                                        <h6 class="fw-medium">Step 6 - Why 5</h6>
                                                        <div class="d-flex justify-content-center mb-3">
                                                            <div class="rounded p-2" style="background-color: #e5e5e5;">
                                                                <p class="text-center mb-0" id="why5_text">Why Ke 2 ?</p>
                                                            </div>
                                                        </div>
                                                        <p class="text-center">Bagus, kita sudah makin dekat ke akar penyebabnya. 
                                                        Kami memberikan rekomendasi why yang mungkin relate dengan permasalahan yang anda hadapi, atau anda bisa menentukan sendiri dengan mengisi kolom teks!</p>
                                                        <br>
                                                        <div id="why5_jawaban"></div>
                                                        <br>
                                                        <div class="row justify-content-between mt-5">
                                                            <div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 mb-3">
                                                                <input type="text" class="form-control" id="input_why5" name="input_why5" placeholder="Tuliskan akar masalah dari analisa yang dihasilkan!">
                                                            </div>
                                                            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 text-md-end">
                                            ...
                                            <div class="row">
                                                <div class="col-12 mt-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="d-flex justify-content-center mb-3">
                                                            <div class="rounded p-2" style="background-color: #e5e5e5;">
                                                                <p class="text-center mb-0" id="solving_text">Why Ke 2 ?</p>
                                                            </div>
                                                        </div>
                                                        <p class="text-center">Terima kasih! Kita telah menyelesaikan analisis 5 Why. 
                                                        Kami memberikan rekomendasi solusi yang mungkin relate dengan permasalahan yang anda hadapi, atau anda bisa menentukan sendiri dengan mengisi kolom teks!</p>
                                                        <br>
                                                        <div id="solving_jawaban"></div>
                                                        <br>
                                                        <div class="row justify-content-between mt-5">
                                                            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 mb-3">
                                                                <input type="text" class="form-control" id="input_solving" name="input_solving" placeholder="Tuliskan solusi yang akan kamu lakukan untuk masalah ini!">
                                                            </div>
                                                            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 mb-3 pilihan_status d-none">
