                    ...
                    <div class="row">
                        ...
                        <div class="col-auto-right" align="right">
                            ...
                            <?php if(in_array($user_id,$user_allow)) :?>
                                <button type="button" class="btn btn-md btn-outline-danger mb-2" onclick="list_verif_owner()"><i class="bi bi-bookmark"></i> List Verif Owner</button>
                            <?php endif; ?>
...
<div class="modal fade" id="modal_list_verif_owner" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-fullscreen modal-dialog-scrollable">
        <div class="modal-content" style="overflow-y: auto;">
            <div class="modal-header row align-items-center bg-theme">
                <div class="col-auto">
                ...
                <div class="col-12 col-lg-12 col-xl-12 mb-4">
                    ...
                    <div class="card border-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <table id="dt_list_verif_owner" class="table table-bordered" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th width="15%">Hasil/Topik/Judul</th>
                                                <th width="15%">Issue</th>
