        ...
        <?php foreach ($issue as $key) : ?>
          <table width="100%" class="table table-striped" style="margin-top: 8px;">
            ...
            <tr>
              ...
              <?php if ($item->id_kategori == 1 || $item->id_kategori == 5 || $item->id_kategori == 6 || $item->id_kategori == 8 || $item->id_kategori == 9 || $item->id_kategori == 10 || $item->id_kategori == 11) { ?>
              ...
              <?php } else if ($item->id_kategori == 1) { ?>
                <td align="center"><span class="info-data"><span class="label label-success"><?= $item->kategori; ?></span></span></td>
              <?php } else { ?>
              ...
              <td align="center">
                <span class="info-data">
                  <?php if ( $item->id_status == 1 && ($item->id_kategori == 1 || $item->id_kategori == 5 || $item->id_kategori == 6 || $item->id_kategori == 8 || $item->id_kategori == 9 || $item->id_kategori == 10 || $item->id_kategori == 11) ) { ?>
                  ...
                  <?php } else if ( $item->id_status == 2 && ($item->id_kategori == 1 || $item->id_kategori == 5 || $item->id_kategori == 6 || $item->id_kategori == 8 || $item->id_kategori == 9 || $item->id_kategori == 10 || $item->id_kategori == 11) ) { ?>
                  ...
                  <?php } else if($item->id_kategori == 1 || $item->id_kategori == 5 || $item->id_kategori == 6 || $item->id_kategori == 8 || $item->id_kategori == 9 || $item->id_kategori == 10 || $item->id_kategori == 11) { ?>
