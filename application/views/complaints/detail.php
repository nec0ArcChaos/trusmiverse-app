...
<head>
    ...
    <?php $this->load->view('complaints/detail_css'); ?>
...
<body class="d-flex flex-column h-100 sidebar-pushcontent" data-sidebarstyle="sidebar-pushcontent">
                                ...
                                <div class="col-12 mt-2">
                                    ...
                                    <div class="detail_pages" id="complaints_page">
                                        <div class="card border-0 mb-4">
                                            ...
                                            <div class="card-footer text-start d-none" id="footer-update">
                                                ...
                                                <div id="div_footer">
                                                    ...
                                                    <div class="text-start" id="div_e_timeline">
                                                    ...
                                                    <div class="row g-3 mb-3 align-items-center" id="div_e_pic_note">
                                                        <div class="col-12 col-md-3">
                                                            <label class="form-label-custom small required" for="e_pic_note"><i class="sticky note outline icon"></i> PIC Note</label>
                                                        </div>
                                                        <div class="col-12 col-md-9">
    ...
    <!-- page level script -->
    <?php $this->load->view('complaints/detail_js'); ?>
