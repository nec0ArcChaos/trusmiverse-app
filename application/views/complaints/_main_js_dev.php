...
<script>
    ...
    id_project_element.addEventListener("change", function() {
        ...
        $.ajax({
            url: '<?= base_url() ?>complaints/main_dev/get_blok_by_id_project',
            type: 'POST',
            dataType: 'json',
            data: {
    ...
    $('#pekerjaan').change(function(e) {
        ...
        $.ajax({
            type: "GET",
            url: "<?= base_url('complaints/main_dev/get_sub_pekerjaan'); ?>/" + pekerjaan,
            dataType: "json",
            success: function(response) {
        ...
        if (val_id_project == "" || val_project == "") {
            ...
            $.confirm({
                ...
                onOpen: function() {
                    ...
                    form = $('#form_complaint');
                    $.ajax({
                        url: `<?= base_url() ?>complaints/main_dev/save_task`,
                        // cache: false,
                        // contentType: false,
                        // processData: false,
            ...
            onOpen: function() {
                $.ajax({
                    ...
                    if (response.status == true) {
                        ...
                        user_id = '<?= $this->session->userdata('user_id'); ?>'
                        // console.log(response.detail.verified_user_id);
                        // console.log(user_id);
