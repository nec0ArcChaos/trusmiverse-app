...
<link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/semantic/components/placeholder.css">
<link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/semantic/components/message.css">
<link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/semantic/components/reveal.css">
<link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/semantic/components/segment.css">
<link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/semantic/components/header.css">
...
<style>
    ...
    .active {
        background-color: rgba(var(--WinDOORS-theme-rgb), 0.1) !important;
    }
