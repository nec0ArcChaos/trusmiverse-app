    ...
    <div class="container-fluid mb-4 breadcrumb-theme">
        <div class="row">
            <div class="col-12 mb-4 column-set">
                ...
                <div id="div_cards_resume">
                    <div class="swiper swiperauto">
                        <!-- CARD 1 to 4 -->
                        <div class="swiper-wrapper">
                            <?php foreach ($resume_1_to_4 as $dt_resume) { ?>
                                <div class="swiper-slide">
                                    <div class="card border-0 w-250">
                                        <!-- <div class="card-header"> -->
                                        <!-- <div class="row align-items-center">
                                            <div class="col">
                                                <h6 class="fw-medium mb-0">Developers</h6>
                                                <p class="text-secondary small">12 Restrictions</p>
                                            </div>
                                            <div class="col-auto">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" role="switch" id="userlist1" checked="">
                                        ...
                                        <div class="card-body text-center">
                                            <figure class="avatar avatar-100 coverimg mb-3 rounded-circle">
                                                <img src="https://trusmiverse.com/hr/uploads/profile/<?= $dt_resume->profile_picture ?>" alt="" />
                                            </figure>

                                            <h6 class="mb-1"><span class="avatar avatar-10 bg-green me-1 rounded-circle vm"></span> <?= $dt_resume->employee_name; ?></h6>
                                            <p class="text-secondary small">Komitmen Development</p>
                                            <p><i class="bi bi-star"></i> <?= $dt_resume->total_target_komit; ?> / <?= $dt_resume->total_actual_komit; ?> (<?= $dt_resume->achievement_komit; ?>%)</p>
                                        </div>
                                        <div class="card-footer">
                                            <div class="row align-items-center">
                                                <div class="col-4">
                                                    <p class="text-secondary small mb-0"><i class="bi bi-building"></i> Dev</p>
                                                    <p class="small w-100 text-truncate text-center"><?= $dt_resume->total_dev_done; ?></p>
                                                </div>
                                                <div class="col-4">
                                                    <p class="text-secondary small mb-0"><i class="bi bi-ticket"></i> Ticket</p>
                                                    <p class="small text-center"><?= $dt_resume->total_tiket_done; ?></p>
                                                </div>
                                                <div class="col-4">
                                                    <p class="text-secondary small mb-0"><i classx="bi bi-x"></i>Undone</p>
                                                    <p class="small text-center"><?= $dt_resume->total_all_tiket_undone; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card border-0 w-250">
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" role="switch" id="userlist2" checked="">
                                                <label class="form-check-label" for="userlist2"></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body text-center">
                                    ...
                                    <h6 class="mb-1"><span class="avatar avatar-10 bg-green me-1 rounded-circle vm"></span> Mitali D'Souza</h6>
                                    <p class="text-secondary small">125.125.265.1</p>
                                    <p><i class="bi bi-laptop"></i> Laptop</p>
                                </div>
                                <div class="card-footer">
                                    <div class="row align-items-center">
                                        <div class="col-7">
                                            <p class="text-secondary small mb-0"><i class="bi bi-wifi"></i> Connection</p>
                                            <p class="small w-100 text-truncate">25 Department</p>
                                        </div>
                                        <div class="col-5">
                        ...
                        <!-- CARD 5 to 8 -->
                        <div class="swiper-wrapper">
                            <?php foreach ($resume_5_to_8 as $dt_resume) { ?>
                                <div class="swiper-slide">
                                    <div class="card border-0 w-250">
                                        <div class="card-body text-center">
                                            <figure class="avatar avatar-100 coverimg mb-3 rounded-circle">
                        ...
                        <!-- CARD 9 to 12 -->
                        <div class="swiper-wrapper">
                            <?php foreach ($resume_9_to_12 as $dt_resume) { ?>
                                <div class="swiper-slide">
                                    <div class="card border-0 w-250">
                                        <!-- <div class="card-header">
                                        <div class="row align-items-center">
                        ...
                        <!-- CARD 13 to 14 -->
                        <div class="swiper-wrapper">
                            <?php foreach ($resume_13_to_14 as $dt_resume) { ?>
                                <div class="swiper-slide">
                                    <div class="card border-0 w-250">
                                        <!-- <div class="card-header">
                                        <div class="row align-items-center">
