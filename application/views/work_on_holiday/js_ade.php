            ...
            "columns": [
                ...
                // },
                {
                    ...
                    'render':function(data,type,row){
                        hapus = ``;
                        if(row.is_created == 1){
                            hapus = `<span onclick="hapus('${row.id_pk}')" class="badge bg-danger" style='cursor:pointer'><i class="fa fa-trash"></i></span>`;
                        }
                        return `${data} ${hapus}`;
                    }
                },
                ...
                },
                {
                    ...
                    render: function(data,type,row) {
                        ...
                        return `<a onclick="list_job('${data}')"><span class="badge bg-primary" style="cursor:pointer"><li class="fa fa-eye"></li> List Job</span></a>`;
                    }
                }
                ...
                $.confirm({
                    ...
                    buttons: {
                        confirm: function() {
                            $.ajax({
                                type: "POST",
                                url: "<?= base_url('work_on_holiday_ade/save'); ?>", // revnew
                                data: {
                                    // id: id, // id_user
