				...
				<input type="hidden" id="id_pengajuan_hide" name="id_pengajuan_hide" class="form-control">
					...
					<div class="row">
						<div class="col-lg-4 col-sm-12" style="margin-top:.5rem;">
							...
							<textarea name="keperluan" id="keperluan" cols="30" rows="5" class="form-control" readonly></textarea>
						</div>
						<div class="col-lg-4 col-sm-12" style="margin-top:.5rem;">
							<label>Note</label>
							<!-- <input type="text" id="note" name="note" class="form-control" readonly> -->
							<textarea name="note" id="note" cols="30" rows="5" class="form-control" readonly></textarea>
						</div>
						<div class="col-lg-4 col-sm-12" style="margin-top:.5rem;">
					...
					<div class="row">
						...
						<div class="col-5" align="right"><label>Subtotal </label></div>
						<div class="col">
							<input type="text" id="rupiah" onkeyup="nominal($(this).val(), '#rupiah')" class="form-control nominal" placeholder="Total" name="total" style="background-color: #ffe038">
						</div>
					</div>
					...
					<div class="row">
						<div class="col">
							<label>Note</label>
							<textarea type="text" id="note_approval" name="note_approval" class="form-control" placeholder="Silahkan tambahkan catatan..." style="width: 30%; border: 1px solid #ccc"></textarea>
						</div>
					</div>
                </div>
                <div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-bs-dismiss="modal" style="position:absolute; left: 15px;">Close</button>
						<select name="status" id="status" class="form-control" style="width: 30%; border: 1px solid #ccc">
