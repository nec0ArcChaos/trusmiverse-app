			...
			<div class="card border-0">
				<div class="card-header">
					<div class="row">
						...
						<div class="col-auto align-self-center">
							<h6 class="fw-medium mb-0">Lock Approval EAF</h6>
						</div>
				...
				<div class="card-body">
					<div class="table-responsive" style="padding: 10px;">
						<table id="tbl_list_eaf_lock_apv" class="table table-striped table-bordered nowrap">
							<thead>
								<tr>
									<th>Employee</th>
									<th>Status Lock</th>
			...
			<div class="card border-0">
				<div class="card-header">
					<div class="row">
						...
						<div class="col-auto align-self-center">
							<h6 class="fw-medium mb-0">Lock Verifikasi EAF</h6>
						</div>
						<div class="col-auto ms-auto ps-0">
						</div>
					</div>
				...
				<div class="card-body">
					<div class="table-responsive" style="padding: 10px;">
						<table id="tbl_list_eaf_lock_verif" class="table table-striped table-bordered nowrap">
							<thead>
								<tr>
									<th>Employee</th>
									<th>Status Lock</th>
			...
			<div class="card border-0">
				<div class="card-header">
					<div class="row">
						...
						<div class="col-auto align-self-center">
							<h6 class="fw-medium mb-0">Lock LPJ 1 EAF</h6>
						</div>
						<div class="col-auto ms-auto ps-0">
						</div>
					</div>
				...
				<div class="card-body">
					<div class="table-responsive" style="padding: 10px;">
						<table id="tbl_list_eaf_lock_lpj1" class="table table-striped table-bordered nowrap">
							<thead>
								<tr>
									<th>Employee</th>
									<th>Status Lock</th>
			...
			<div class="card border-0">
				<div class="card-header">
					<div class="row">
						...
						<div class="col-auto align-self-center">
							<h6 class="fw-medium mb-0">Lock LPJ 2 EAF</h6>
						</div>
						<div class="col-auto ms-auto ps-0">
						</div>
					</div>
				...
				<div class="card-body">
					<div class="table-responsive" style="padding: 10px;">
						<table id="tbl_list_eaf_lock_lpj2" class="table table-striped table-bordered nowrap">
							<thead>
								<tr>
									<th>Employee</th>
									<th>Status Lock</th>
