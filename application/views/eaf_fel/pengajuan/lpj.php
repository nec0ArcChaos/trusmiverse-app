                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-auto align-self-center">
                            <h6 class="fw-medium mb-0">Pengajuan LPJ EAF</h6>
                        </div>
...
<!-- Modal Add -->
<div class="modal fade" id="modal_detail_lpj" tabindex="-1" aria-labelledby="modalAddLabel" aria-hidden="true">
            ...
            <form id="form_keperluan" autocomplete="off">
                ...
                <div class="modal-header row align-items-center">
                    ...
                    <div class="col">
                        ...
                        <p class="text-secondary small">Form Pengajuan EAF LPJ</p>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-md btn-outline-theme" id="save_lpj">Save</button>
                </div>
            </form>
        </div>
    </div>
