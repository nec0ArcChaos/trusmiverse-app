						...
						<div class="card-block">
							<ul class="nav navigation">
								...
								<?php if ($detail_pengajuan['no_rek'] != ""): ?>
									<li>
										<a href="#v_1_5">No Rekening <span class="text-muted text-regular pull-right"><?php echo $detail_pengajuan['no_rek']; ?> (<?php echo $detail_pengajuan['nama_bank']; ?>)</span></a>
									</li>
								<?php endif ?>
								<li>
								...
								<?php if ($detail_pengajuan['photo_acc'] == 'ba') { ?>
									<li>
										<a href="#v_1_5">BA Reimbursement 
											<a href="<?php echo base_url() ?>eaf/finance/print_ba_reimburse?id=<?= $detail_pengajuan['id_pengajuan'] ?>" class="pull-right" target="_blank" title="Print BA"><i class="ti-printer"></i></a>
										</a>
									</li>
									...
									<li>
										<a href="#v_1_5">Bukti Nota 
											...
											<?php if ($detail_pengajuan['edit_nota'] == 'edit') { ?>
												<a href="javascript:void(0);" class="label label-warning edit_nota pull-right" data-id_pengajuan="<?= $detail_pengajuan['id_pengajuan']; ?>" data-photo="<?= $detail_pengajuan['photo_acc']; ?>" style="cursor:pointer;" title="Edit Nota LPJ"><i class="fa fa-pencil"></i></a>
											<?php } ?>
										</a>
									</li>
								<?php } ?>
								...
								<?php if ($detail_pengajuan['photo_acc'] == 'ba') { ?>
									<li class="nav-item">
										<a class="nav-link text-dark" href="#v_1_5">BA Reimbursement 
											<a href="<?php echo base_url() ?>eaf/finance/print_ba_reimburse?id=<?= $detail_pengajuan['id_pengajuan'] ?>" class="float-end" target="_blank" title="Print BA"><i class="ti-printer"></i></a>
										</a>
									</li>
								<?php } else if ($detail_pengajuan['photo_acc'] != "") { ?>
									<li class="nav-item">
