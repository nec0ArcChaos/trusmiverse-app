                ...
                <div class="modal-body">
					...
					<div class="row">
                        <div class="col-lg-3 col-sm-2 col-xs-2">
							...
							<input type="text" id="company" name="company" class="form-control" placeholder="-Pilih Pengaju-" style="border: 1px solid #ddd;" readonly><br>
							<input type="hidden" id="company_id" name="company_id" class="form-control" style="border: 1px solid #ddd;" readonly><br>

						</div>
						<div class="col-lg-8 col-sm-2 col-xs-2">
