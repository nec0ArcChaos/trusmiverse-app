        ...
        <div class="modal-content">           
            ...
            <div class="modal-body">
                <form id="form_budget">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-12 col-xl-12 mb-4">
                            <label class="form-label-custom" for="klasifikasi">Nominal Budget :</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text bi bi-cash" style="background-color: #F5F5F5;border: 1px solid #ddd;"></span>
                                <input type="text" class="form-control" name="nominal_budget" id="nominal_budget" placeholder="1000" onkeyup="updateRupiah('nominal_budget')" style="border:1px solid #ced4da;border-top-right-radius:5px;border-bottom-right-radius:5px;">
        ...
        <div class="modal-content">           
            <div class="modal-header row align-items-center">
                ...
                <div class="col">
                    <!-- <h6 class="fw-medium mb-0" id="modal_add_pembelajar_label">Form</h6>
                    <p class="text-secondary small">Sharing Leader </p> -->
                    <h5 class="modal-title">Penambahan Budget <p id="text_nama_biaya2"></h5>
