			...
			<div class="modal-body">
				<form id="form_approval" autocomplete="off">
						...
						<div class="col-lg-6 col-sm-12" style="margin-top:.5rem;">
							...
							<select name="biaya" id="biaya">
								...
								<?php foreach ($biaya as $row) : ?>
									<option value="<?= $row->id_biaya . '|' . $row->id_budget . '|' . $row->budget ?>"><?= $row->nama_biaya ?></option>
								<?php endforeach ?>
							</select>
						</div>
						<div class="col-lg-6 col-sm-12" style="margin-top: 0.5rem;">
							<label>Pilihan Jenis Biaya : </label>
							<select name="subbiaya" id="subbiaya">
					...
					<div class="form-group row">
						...
						<div class="col-lg-3 col-sm-12">
							<label>Note</label>
							<textarea type="text" id="note_approval" name="note_approval" class="form-control" cols="30" rows="5" placeholder="Silahkan tambahkan catatan..."></textarea>
						</div>
					...
					<div class="modal-footer">
						...
						<?php if ($this->session->userdata('id_divisi') == 0 || $this->session->userdata('id_divisi') == 5): ?>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="form_approval_lpj" autocomplete="off">
					...
					<input type="hidden" id="get_id_tipe_biaya" name="get_id_tipe_biaya" class="form-control" readonly>
					<div class="form-group row">
						<div class="col">
					...
					<div class="form-group row">
						<div class="col-lg-4 col-sm-12" style="margin-top:.5rem;">
							<label>Budget</label>
							<input type="text" id="budget_lpj" name="budget_lpj" class="form-control" readonly>
						</div>
						<div class="col-lg-4 col-sm-12" style="margin-top:.5rem;">
