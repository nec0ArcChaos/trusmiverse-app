...
<script type="text/javascript">
  ...
  function approval(id, tgl, name, admin_comp_name, admin_dept_name, admin_desg_name, divisi, kategori, tipe, rekening, penerima, jenis, sisa, keperluan, note, nominal, id_appr, photo, biaya, id_b, id_bud, id_jen, id_pro, nama_approval, note_user_approval, note_verifikatur, note_finance, jumlah_termin, nominal_termin, periode_awal_termin) {
  ...
  function approval_lpj(id, tgl, name, admin_comp_name, admin_dept_name, admin_desg_name, divisi, kategori, penerima, jenis, sisa, keperluan, note, nominal, id_appr, photo, biaya, note_peng, lpj_pertama) {
