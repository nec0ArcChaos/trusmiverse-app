...
<script type="text/javascript">
  ...
  function get_subbiaya(id) {
    $.ajax({
      url: '<?php echo base_url() ?>eaf/finance_tes/get_subbiaya/',
      type: 'POST',
      data: {
        id_jenis: id
      },
  ...
  function tabel_history(id) {
    $('#dt_history').DataTable({
      ...
      "ajax": {
        ...
        "url": "<?= base_url('eaf/finance_tes/get_history') ?>"
  ...
  function tabel_list_eaf() {
    $('#dt_list_eaf').DataTable({
      ...
      "ajax": {
        ...
        "url": "<?= base_url() ?>eaf/finance_tes/get_list_eaf_my_approval/<?php echo $this->uri->segment(4); ?>"
        // "success": function(data) {
  ...
  $('#subbiaya_new').change(function() {
    ...
    $.ajax({
      url: '<?php echo base_url() ?>eaf/finance_tes/get_biaya',
      type: 'POST',
      dataType: 'html',
      data: {
        id_jenis: $(this).val()
  ...
  function approval(id, tgl, name, divisi, kategori, tipe, rekening, penerima, jenis, sisa, keperluan, note, nominal, id_appr, photo, biaya, id_b, id_bud, id_jen, id_pro, nama_approval, note_user_approval, note_verifikatur, note_finance) {
    ...
    if ($('#subbiaya_new').val() == "0" || $('#subbiaya_new').val() == "" || $('#subbiaya_new').val() == null) {
      ...
      swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
            $.ajax({
              url: '<?php echo base_url() ?>eaf/finance_tes/insert_approval_finance',
              type: 'post',
              dataType: 'json',
  ...
  function approval_lpj(id, tgl, name, divisi, kategori, penerima, jenis, sisa, keperluan, note, nominal, id_appr, photo, biaya, note_peng, lpj_pertama) {
    ...
    if (photo == 'null') {
      $('#bukti_lpj').empty();
      $('#bukti_lpj').append('<a href="<?= base_url('eaf/finance_tes/print_ba?id='); ?>' + id + '" target="_blank" title="Print BA"><i class="ti-printer"></i></a>');
    } else {
      $('#bukti_lpj').empty();
  ...
  function tabel_lpj(id) {
    $('#dt_lpj').DataTable({
      ...
      "ajax": {
        ...
        "url": "<?= base_url('eaf/finance_tes/get_lpj') ?>"
        // "success": function(data) {
        //   console.log(data.data);
        // },
        // "error": function(xhr, error, code) {
    ...
    if ($('#status_lpj').val() == "0" || $('#status_lpj').val() == "" || $('#status_lpj').val() == null) {
      ...
      swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
            $.ajax({
              url: '<?php echo base_url() ?>eaf/finance_tes/insert_approval_lpj',
              type: 'post',
              dataType: 'json',
  ...
  function get_coa() {
        ...
        $.ajax({
            'url': '<?= site_url('eaf/finance_tes/get_coa') ?>',
            'type': 'GET',
            'dataType': 'json',
            'success': function(response) {
    ...
    function get_rekanan() {
        ...
        $.ajax({
            'url': '<?= site_url('eaf/finance_tes/get_rekanan') ?>',
            'type': 'GET',
            'dataType': 'json',
            'success': function(response) {
                for (i = 0; i < response.length; i++) {
    ...
    function get_rekening() {
        ...
        $.ajax({
            'url': '<?= site_url('eaf/finance_tes/get_rekening') ?>',
            'type': 'POST',
            data: {
                tipe: type
            },
