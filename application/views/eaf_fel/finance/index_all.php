		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="form_approval" autocomplete="off">
					...
					<div class="form-group row" id="form_reject">
						<div class="col-lg-4 col-sm-12" style="margin-top:.5rem;">
							<label>Note Cancel</label>
							<textarea name="note_reject" id="note_reject" cols="30" rows="5" class="form-control"></textarea>
						</div>
						<div class="col-lg-4 col-sm-12" style="margin-top:.5rem;">
							<button type="button" class="btn btn-danger" onclick="reject()">Cancel Approval</button>
						</div>
					</div>
...
<div class="modal fade" id="modal_edit_blok" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
		...
		<form id="form_edit_blok">
			...
			<div class="row">
				<div class="col-12">
					...
					<input type="hidden" id="list_blok" name="list_blok">
				</div>
			</div>
		</form>
      </div>
      <div class="modal-footer">
		  <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" onclick="simpan_edit_blok()">Save changes</button>
      </div>
    </div>
  </div>
</div>
