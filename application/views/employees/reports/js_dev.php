...
<script>
    ...
    function download_report() {
        ...
        window.location = "https://trusmiverse.com/apps/employees_dev/report_export_excel?company=" + encodeURIComponent(company) + "&department=" + encodeURIComponent(department) + "&designation=" + encodeURIComponent(designation);
    }
    ...
    function dt_employees_report() {
        ...
        $('#dt_employees_report').DataTable({
            ...
            "destroy": true,
            "language": {
                loadingRecords: '<img src="https://trusmiverse.com/apps/assets/icon/gif_find.gif" alt="Loading">'
            },
            ...
            "ajax": {
                ...
                "url": "<?= base_url(); ?>employees_dev/dt_employees_report_new",
            },
            "columns": [{
                    "data": "employee_id",
                },
                ...
                // },
                {
                    ...
                    render:function(data,type,row){
                        ...
                        return '<span class="badge bg-success">Sudah terdaftar</span>';
                            ...
                            return '<span class="badge bg-danger">Belum terdaftar</span>';
                        }
                    }
                }
            ],
            initComplete: function() {
                $('#text_btn_find').text('Find');
                $('#btn-download-report').removeClass('d-none');
            }
        });
    }
