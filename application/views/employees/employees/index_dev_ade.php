                                    ...
                                    <form id="update_employee_form">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col">
                                                ...
                                                <input type="date" class="form-control border-custom" id="date_of_leaving" name="date_of_leaving">
                                            </div>
                                            <div class="col">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <!-- addnew -->
                                            <div class="col">
                                                <label class="form-label-custom required small" for="cutoff">Cutoff</label>
                                                <select name="cutoff" id="cutoff" class="slim-select form-control border-custom">
                    ...
                    <div id="basic-info">
                        <form id="add_employee_form">
                            ...
                            <div class="row mb-2">
                                ...
                                <!-- addnew -->
                                <div class="col-lg-3 col-sm-12">
                                    <label class="form-label-custom required small" for="add_cutoff">Cutoff</label>
                                    <select name="add_cutoff" id="add_cutoff" class="slim-select form-control border-custom">
                                        <option value="1">21-20</option>
                                        <option value="2">16-15</option>
                                        <option value="3">01-30</option>
                                    </select>
