            ...
            <div class="modal-body">
                <form id="form_blast">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                        <!-- <select class="form-control select2" name="no_hp" id="select_employee">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            ...
                            <textarea type="text" id="message" name="message" value="" class="form-control" placeholder="isi pesan anda..." rows="3" style="border-width:1.5px; border-color: #D1CCCF; border-radius:20px; height:auto"></textarea>
                        </div>
                    </div>
