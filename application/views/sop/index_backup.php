            ...
            <div class="card-header">
                ...
                <div class="col-6">
                    <button type="button" class="btn btn-rounded btn-primary btn-sm" data-bs-toggle="modal"
                        data-bs-target="#modal_add" style="float:right;margin-left:4px">
            ...
            <div class="modal-body">
                <form id="form_sop">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control select2" name="designation" id="select_designation">
                                <option value="" disabled selected>-- Select Designation --</option>
                            </select>
                            <input type="hidden" id="tot_ssd">
                        </div>

                        <label class="col-sm-2 col-form-label multi_department">Department</label>
                        <div class="col-sm-4 multi_department">
                            <select class="form-control select2" name="department_multi[]" id="select_department_multi"
                                multiple>
                            </select>
                        </div>
                ...
                <form id="form_request">
                    ...
                    <div class="form-group row mb-3 row_dept"  style="display:none">
                        ...
                        <div class="col-sm-4 multi_department_req">
                            ...
                            <select class="form-control select2" name="department_multi_req[]" id="select_department_multi_req"
                                multiple>
                                <!-- <option value="" disabled selected>Select Department</option> -->
                            </select>
                        </div>
                    ...
                    <div class="row penjelasan mb-3" style="display:none">
                        <div class="col-sm-12">
                            <label class="me-sm-2" for="#penjelasan"><b>Penjelasan</b> <span data-bs-toggle="popover"
                                    data-bs-title="Penjelasan" data-bs-content="Jelaskan dokumen apa yang sedang di ajukan">
                                    <li class="fa fa-info-circle"></li>
                                </span></label>
                    ...
                    <div class="row jobprofile mb-3" style="display:none">
                        <div class="col-sm-6">
                            <label class="me-sm-2" for="#tujuan"><b>Jumah Bawahan</b> </label>
                            <input type="text" id="tujuan" name="jumah_bawahan" class="form-control" value=""
                                style="border-width:1.5px; border-color: #D1CCCF; border-radius:20px"
                                placeholder="contoh: >2">
                        </div>
                        <div class="col-sm-6">
                            <label class="me-sm-2" for="#tujuan"><b>Area Coverage</b> </label>
                            <input type="text" id="area" name="jumah_bawahan" class="form-control" value=""
                                style="border-width:1.5px; border-color: #D1CCCF; border-radius:20px"
                    ...
                    <div class="row jobprofile mb-3" style="display:none">
                        ...
                        <div class="col-sm-6">
                            <div>
                                ...
                                <h4 class="me-sm-2" for="#relation_in">Scope Of Relationship Internal <span
                                        class="fa fa-info-circle text-secondary" data-bs-toggle="popover"
                                        data-bs-title="Cakupan hubungan internal"
                                        data-bs-content="Gambaran tentang hubungan dan interaksi antara berbagai unit, departemen, atau bagian dalam suatu organisasi."></span>
                                </h4>
                                <button class="btn btn-xs btn-success" onclick="view_internal()">
                                    <li class="fa fa-eye"></li> View
                                </button> |
                                <button class="btn btn-xs btn-primary" onclick="add_internal()">
                                    <li class="fa fa-plus-circle"></li> Add Data
                                </button>
                            </div>
                            <div class="mt-4">
    
                                <h4 class="me-sm-2" for="#relation_ex">Scope Of Relationship External <span
                                        class="fa fa-info-circle text-secondary" data-bs-toggle="popover"
                                        data-bs-title="Cakupan hubungan external"
                                        data-bs-content="keterlibatan perusahaan dengan entitas di luar organisasi, termasuk pelanggan, pemasok, mitra bisnis, regulator, dan masyarakat."></span>
                                </h4>
                                <button class="btn btn-xs btn-success" onclick="view_external()">
                                    <li class="fa fa-eye"></li> View
                                </button> |
                                <button class="btn btn-xs btn-primary" onclick="add_external()">
                                    <li class="fa fa-plus-circle"></li> Add Data
                                </button>
                            </div>
                            <div class="mt-4">
    
                                <h4 class="me-sm-2" for="#responsifb">Scope Of Responsibilites <span
                                        class="fa fa-info-circle text-secondary" data-bs-toggle="popover"
                                        data-bs-title="Cakupan tanggung jawab"
                                        data-bs-content="Rentang tanggung jawab yang dimiliki oleh individu atau departemen dalam perusahaan."></span>
                                </h4>
                                <button class="btn btn-xs btn-success" onclick="view_job_task()">
                                    <li class="fa fa-eye"></li> View
                                </button> |
                                <button class="btn btn-xs btn-primary" onclick="add_job_task()">
                                    <li class="fa fa-plus-circle"></li> Add Data
                                </button>
                            </div>
                            <div class="mt-4">
    
                                <h4 class="me-sm-2" for="#responsifb">Scope Of KPI <span
                                        class="fa fa-info-circle text-secondary" data-bs-toggle="popover"
                                        data-bs-title="Cakupan Key Performance Indicators"
                                        data-bs-content="sekumpulan indikator kinerja kunci yang digunakan untuk mengukur pencapaian tujuan dan performa bisnis perusahaan.."></span>
                                </h4>
                                <button class="btn btn-xs btn-success" onclick="view_kpi()">
                                    <li class="fa fa-eye"></li> View
                                </button> |
                                <button class="btn btn-xs btn-primary" onclick="add_kpi()">
                                    <li class="fa fa-plus-circle"></li> Add Data
                                </button>
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_edit_sop">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label multi_department_edit"
                            style="display: none;">Department</label>
                        <div class="col-sm-4 multi_department_edit" style="display: none;">
                            <select class="form-control select2" name="department_multi[]"
                                id="select_department_multi_edit" multiple>
                            </select>
                        </div>

                        <label class="col-sm-2 col-form-label single_department_edit">Department</label>
                        ...
                        <label class="col-sm-2 col-form-label">Designation</label>
                        <div class="col-sm-4">
                            <select class="form-control select2" name="designation" id="select_designation_edit">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Word</label>
                        <div class="col-sm-10">
                            <input type="file" class="form-control" name="word" id="word">
                        </div>
                    </div>
                </form>
            </div>
...
<div class="modal fade" id="modal_link">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a id="add_link" class="btn btn-sm btn-primary" href="javascript:void(0)" onclick="add_link()"
                    style="padding-right: 11px; padding-top: 11px; padding-bottom: 11px; padding-left: 11px; font-size: 15px;"><i
                        class="ti-plus"></i></a>
                <a id="del_link" class="btn btn-sm btn-danger" href="javascript:void(0)" onclick="del_link()"
                    style="padding-right: 11px; padding-top: 11px; padding-bottom: 11px; padding-left: 11px; font-size: 15px;"><i
                        class="ti-minus"></i></a>
                <button class="btn" data-bs-dismiss="modal">Close</button>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-footer">
                <div class="col">
                    <div class="progress">
                        <div class="progress-bar" id="bar_upload_1" role="progressbar" aria-valuemin="0"
