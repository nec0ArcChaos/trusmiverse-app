...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#type_department_edit').change(function() {
            ...
            if (type == 1) {
                ...
                console.log('type_department_edit change type 2');
    ...
    $('#select_company').change(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var html_multi = '';
                var i;
                html += '<option value="" disabled selected>-- Select Department-singlejs --</option>';
                for (i = 0; i < data.length; i++) {
    ...
    $('#save_add').on('click', function() {
        ...
        // }
            ...
            url = "<?php echo site_url('sop_ade/insert') ?>";
    ...
    $('#select_department_edit').change(function() {
        ...
        if (type_department == 1) {
            console.log('req sop/get_designations');
            $.ajax({
                url: "<?php echo site_url('sop/get_designations'); ?>",
                method: "POST",
                data: {
                ...
                success: function(data1) {
                    ...
                    // di sini by ade
                    // console.log('designation html1_multi: ', html1_multi);
    ...
    $('#save_edit').on('click', function() {
        ...
        if (containsAllFalse(validate) == true) {
            ...
            url = "<?php echo site_url('sop_ade/update') ?>";
