    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_sop">
                    <div class="form-group row">
                        ...
                        <label class="col-sm-2 col-form-label">Type Department add</label>
                        <div class="col-sm-4">
                            <select class="form-control select2" name="type_department" id="type_department">
                                <option value="1" selected>Single Department add</option>
                                <option value="2">Multi Department add</option>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label single_designation">Designation single</label>
                        ...
                        <label class="col-sm-2 col-form-label multi_department d-none">Department multi add</label>
                        ...
                        <div class="col-sm-4 single_department">
                            <select class="form-control select2" name="department" id="select_department">
                                <option value="" disabled selected>-- Select Department-single --</option>
                            </select>
                            <input type="hidden" id="tot_sd">
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" id="save_add">Save add</button>
            </div>
        </div>
    </div>
</div>
