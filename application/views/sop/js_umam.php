...
<script type="text/javascript">
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        if ("<?php echo $this->session->userdata('user_id') ?>" == 2774 || "<?php echo $this->session->userdata('user_id') ?>" == 2843 || "<?php echo $this->session->userdata('user_id') ?>" == 2903 || "<?php echo $this->session->userdata('user_id') ?>" == 1 || "<?php echo $this->session->userdata('user_id') ?>" == 4498 ||  "<?php echo $this->session->userdata('user_id') ?>" == 68 ||  "<?php echo $this->session->userdata('user_id') ?>" == 2521){
                            if (data == null) {
                                return `<a class="del_sop label label-danger"` +
                                    ...
                                    `data-dokument="https://trusmicorp.com/od/assets/files/`+ row['word'] +`"` +
    ...
    function send_notifikasi_request(nama_dokumen, jadwal, designation, department, penjelasan, company) {
        ...
        if (company == 5 || company == 4 || company == 1) { //bt, fbt, holding
            list_phone = [
                '081802338736' //Nining Sandra Aeni
    ...
    $('#save_blast').click(function (e) { 
        ...
        if (no_hp.val() == null) {
            ...
            url = "<?php echo site_url('sop_umam/blast') ?>";
