<div class="content mt-0">
    ...
    <!-- Task Overview Row -->
    <div class="summary-row anim a1" id="section-task-overview" style="grid-template-columns: 1fr 1fr 1fr; margin-bottom: 0px;">

        <!-- Rata-rata Progres Mingguan -->
        <div class="panel stage-card" style="grid-column: span 1; padding: 10px; display:flex; flex-direction:column;">
            <div class="stage-header" style="margin-bottom: 6px;">
                <div class="stage-icon si-blue" style="font-size:12px; width:28px; height:28px;">📋</div>
                <div>
                    <div class="stage-name" style="font-size: 12.5px;">Rata-rata Progres Mingguan</div>
                    <div class="stage-desc" style="font-size: 11px;">Tren penyelesaian tugas mingguan</div>
                </div>
            </div>
            <div style="margin-bottom: 8px;">
                <div class="d-flex justify-content-between align-items-center mb-1">
                    <span class="sm-label mb-0" style="font-size: 11px;">Avg%</span>
                    <span class="cpr-value" id="val-weekly-avg" style="font-size:12px;">0%</span>
                </div>
                <div style="background:#e9ecef; border-radius:6px; height:8px; overflow:hidden;">
                    <div id="bar-weekly-avg" style="height:100%; border-radius:6px; background:linear-gradient(90deg,#22c55e,#16a34a); width:0%; transition:width 0.8s ease;"></div>
                </div>
            </div>
            <div id="weekly-breakdown" style="display:flex; flex-direction:column; gap:2px; margin-top:2px;">
                <!-- dynamic weeks generated by JS -->
            </div>
        </div>
        ...
        <div class="panel stage-card" style="grid-column: span 1; padding: 10px; display:flex; flex-direction:column;">
            <div class="stage-header" style="margin-bottom: 6px;">
                <div class="stage-icon si-purple" style="font-size:12px; width:28px; height:28px;">📊</div>
                <div>
                    <div class="stage-name" style="font-size: 13px;">Ringkasan Pekerjaan</div>
                    <div class="stage-desc" style="font-size: 11px;">Akumulasi seluruh Task</div>
                </div>
            </div>
            <div class="d-flex align-items-end" style="margin-bottom:2px; gap:8px;">
                <div id="val-ontime-pct" style="font-family: var(--head);font-size:32px; font-weight:700; line-height:1; color:#111;">0%</div>
                <div class="sm-label mb-1" style="font-size: 11px;">Ontime Task</div>
            </div>
            <hr style="margin: 6px 0;">
            <div style="display:flex; flex-direction:column; gap:8px;">
                <div>
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <span class="sm-label mb-0" style="font-size: 11px;">Ontime: <strong id="val-task-ontime">0</strong></span>
                        <span class="cpr-value" id="val-task-ontime-pct" style="color:var(--green); font-size:11px;">0%</span>
                    </div>
                    <div style="background:#e9ecef; border-radius:6px; height:8px; overflow:hidden;">
                        <div id="bar-task-ontime" style="height:100%; border-radius:6px; background:linear-gradient(90deg,#22c55e,#16a34a); width:0%; transition:width 0.8s ease;"></div>
                    </div>
                </div>
                <div>
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <span class="sm-label mb-0" style="font-size: 11px;">Late: <strong id="val-task-late">0</strong></span>
                        <span class="cpr-value" id="val-task-late-pct" style="color:#f97316; font-size:11px;">0%</span>
                    </div>
                    <div style="background:#e9ecef; border-radius:6px; height:8px; overflow:hidden;">
                        <div id="bar-task-late" style="height:100%; border-radius:6px; background:linear-gradient(90deg,#fb923c,#ea580c); width:0%; transition:width 0.8s ease;"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="panel stage-card" style="grid-column: span 1; padding: 10px; display:flex; flex-direction:column;">
            <div class="stage-header" style="margin-bottom: 6px;">
                <div class="stage-icon si-teal" style="font-size:12px; width:28px; height:28px;">⚙️</div>
                <div>
                    <div class="stage-name">Task by Status</div>
                    <div class="stage-desc">Proporsi tugas berdasarkan status pengerjaannya</div>
                </div>
            </div>
            <div class="d-flex align-items-center justify-content-center" style="flex:1; gap:24px; padding: 4px 0;">
                <div class="circle-task-status" style="flex-shrink:0;">
                    <canvas id="chartTaskByStatus"></canvas>
                </div>
                <div style="display:flex; flex-direction:column; gap:6px; font-size:11px;">
                    <div class="d-flex align-items-center gap-2"><span style="width:10px;height:10px;border-radius:50%;background:#9ca3af;display:inline-block;"></span> Not Started</div>
                    <div class="d-flex align-items-center gap-2"><span style="width:10px;height:10px;border-radius:50%;background:#3b82f6;display:inline-block;"></span> Progress</div>
                    <div class="d-flex align-items-center gap-2"><span style="width:10px;height:10px;border-radius:50%;background:#10b981;display:inline-block;"></span> Done</div>
                    <div class="d-flex align-items-center gap-2"><span style="width:10px;height:10px;border-radius:50%;background:#a855f7;display:inline-block;"></span> QA</div>
                    <div class="d-flex align-items-center gap-2"><span style="width:10px;height:10px;border-radius:50%;background:#eab308;display:inline-block;"></span> Need Data</div>
                    <div class="d-flex align-items-center gap-2"><span style="width:10px;height:10px;border-radius:50%;background:#ef4444;display:inline-block;"></span> Cancelled</div>
                </div>
            </div>
        </div>
    </div>
    <!-- End Task Overview Row -->
    ...
    <div class="anim a3" id="gantt-page">
        <div class="gantt-panel anim a1">
            ...
            <div class="gantt-filter-bar">
                ...
                <select id="g-filter-pic" class="gf-select">
            ...
            <div class="gantt-body" id="gantt-body">
                ...
                <div class="gantt-grid" id="gantt-grid">
                    <div class="gantt-grid-scroll" id="gantt-grid-scroll">
                        ...
                        <button class="add-row-btn" id="g-add-project-btn2" style="position: sticky; bottom: 0; left: 0; z-index: 100; border-top: 1px solid #e2e8f0; background: #fff; width: fit-content; min-width: 100%;">
