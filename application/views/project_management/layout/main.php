...
<head>
    ...
    <title>Trusmiverse - Project Management System</title>
    ...
    <!-- chosen css -->
    <link rel="stylesheet" href="<?= base_url() ?>assets/main_theme/vendor/chosen_v1.8.7/chosen.min.css">

    <!-- date range picker -->
    <link rel="stylesheet" href="<?= base_url() ?>assets/main_theme/vendor/daterangepicker/daterangepicker.css">

    <!-- swiper carousel css -->
    <link rel="stylesheet" href="<?= base_url() ?>assets/main_theme/vendor/swiper-7.3.1/swiper-bundle.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>assets/main_theme/vendor/dragula/dragula.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>assets/main_theme/vendor/dropzone5-9-3/dropzone.min.css">


    <!-- style css for this template -->
    <link href="<?= base_url() ?>assets/main_theme/scss/style.css" rel="stylesheet">
    <link rel="stylesheet" href="<?= base_url() ?>assets/main_theme/css/dataTables.bootstrap5.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>assets/main_theme/css/rowReorder.dataTables.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>assets/main_theme/css/responsive.dataTables.min.css">

    <link rel="stylesheet" href="<?= base_url('assets/project_management/css/jquery-comments.css') ?>">
...
<body class="d-flex flex-column h-100 sidebar-pushcontent menu-close" data-sidebarstyle="sidebar-pushcontent" data-base_url="<?= base_url() ?>">
    ...
    <div class="coverimg h-100 w-100 top-0 start-0 main-bg">
        ...
        <img src="<?= base_url() ?>assets/main_theme/img/bg-14.jpg" alt="" />
    </div>
    <!-- background ends  -->
                    ...
                    <a class="navbar-brand ms-2" href="https://trusmiverse.com/apps/">
                        <div class="row">
                            ...
                            <div class="col ps-0 align-self-center d-none d-sm-block">
                                <h5 class="fw-bold text-dark mb-0">PROJECT</h5>
            ...
            <div class="container">
                    ...
                    <div class="col-12">
                        <div class="avatar avatar-100 rounded-circle shadow-sm mb-3 bg-white">
                            <figure class="avatar avatar-90 rounded-circle coverimg">
                                <img src="<?= $this->session->userdata('profile_picture') ? 'https://trusmiverse.com/hr/uploads/profile/' . $this->session->userdata('profile_picture') : 'https://trusmiverse.com/hr/uploads/profile/anonim.jpg' ?>"
                ...
                <div class="row mb-4">
                    <div class="col-12 px-0">
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a class="nav-link menus_btn active" href="javascript:void(0)"
                                    onclick="switchTab('menus','Beranda')" data-value="beranda">
                                    <div class="avatar avatar-40 icon"><i class="bi bi-house-door-fill"></i></div>
                                    <div class="col">Beranda</div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link menus_btn" href="javascript:void(0)"
                                    onclick="switchTab('menus','capaian')" data-value="capaian">
                                    <div class="avatar avatar-40 icon"><i class="bi bi-megaphone"></i></div>
                                    <div class="col">Capaian & Profil</div>
                                </a>
                            </li>
                            <!-- <li class="nav-item">
                                <a class="nav-link menus_btn active" href="javascript:void(0)"
                                    onclick="switchTab('menus','gantt')" data-value="gantt">
                                    <div class="avatar avatar-40 icon"><i class="bi bi-calendar-week"></i></div>
                                    <div class="col">Gantt</div>
                                </a>
                            </li> -->
                        </ul>
                    </div>
    ...
    <main class="main mainheight">
        ...
        <div class="container-fluid">
            <!-- <div class="row align-items-center page-title">
                <div class="col-12 col-md mb-2 mb-sm-0">
                    <h5 class="mb-0 fw-bold">Selamat Pagi, <?= $this->session->userdata('nama') ?> <img src="<?= base_url() ?>assets/main_theme/img/cloud-sun.png" style="height: 35px; width: 35px; object-fit: contain;" class="ms-1 floating-icon" alt="Sun"></h5>
                    <p class="text-secondary">Lets kick off the day and get all your stuff done!</p>
                </div>
            </div> -->
            ...
            <div class="row">
                <div class="col-12 mt-2">
                    <nav aria-label="breadcrumb" class="breadcrumb-theme py-2 px-3 rounded-3 mb-2" style="background: rgba(var(--WinDOORS-theme-rgb), 0.04);">
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="#" class="small text-decoration-none opacity-75">Trusmiverse</a></li>
                            <li class="breadcrumb-item active small" id="active-breadcrumb">Beranda</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <!-- content -->
        <div class="container-fluid" id="menus_content">
        </div>
                        ...
                        <ul class="list-group list-group-flush bg-none rounded-0 ">
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <figure class="avatar avatar-44 coverimg rounded-circle">
                                            <img src="<?= base_url() ?>assets/main_theme/img/user-2.jpg"
                                                alt="" />
                                        </figure>
                                    </div>
                            ...
                            <li class="list-group-item">
                                <div class="row">
                                    <div class="col-auto">
                                        <figure class="avatar avatar-44 coverimg rounded-circle">
                                            <img src="<?= base_url() ?>assets/main_theme/img/user-4.jpg"
                                                alt="" />
                                        </figure>
                                    </div>
                                    <div class="col-9 align-self-center ps-0">
                            ...
                            <li class="list-group-item">
                                <div class="row">
                                    <div class="col-auto">
                                        <figure class="avatar avatar-44 coverimg rounded-circle">
                                            <img src="<?= base_url() ?>assets/main_theme/img/user-1.jpg"
                                                alt="" />
                                        </figure>
                                    </div>
                                    <div class="col-9 align-self-center ps-0">
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <figure class="avatar avatar-44 coverimg rounded-circle bg-theme">
                                            <img src="<?= base_url() ?>assets/main_theme/img/favicon72.png"
                                                alt="" />
                                        </figure>
                                    </div>
                                    <div class="col-9 align-self-center ps-0">
    ...
    <div class="chatboxes w-auto align-right mb-2">
        ...
        <div class="dropstart">
            <div class="dd-arrow-none dropdown-toggle" id="thefirstchat" data-bs-display="static"
                ...
                <figure class="avatar avatar-40 coverimg rounded-circle shadow">
                    <img src="<?= base_url() ?>assets/main_theme/img/user-2.jpg" alt="">
                </figure>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="mw-100 position-relative mb-2 figure">
                                                ...
                                                <img src="<?= base_url() ?>assets/main_theme/img/news-4.jpg"
                                                    alt="" class="mw-100">
                                            </div>
        ...
        <div class="dropstart">
            <div class="dd-arrow-none dropdown-toggle" data-bs-display="static" data-bs-toggle="dropdown"
                ...
                <figure class="avatar avatar-40 coverimg rounded-circle shadow">
                    <img src="<?= base_url() ?>assets/main_theme/img/user-4.jpg" alt="">
                </figure>
            </div>
            <div class="dropdown-menu dropdown-menu-middle w-300 mb-2 p-0">
                <!-- chat box here  -->
        ...
        <div class="dropup">
            <div class="dd-arrow-none dropdown-toggle" data-bs-display="static" data-bs-toggle="dropdown"
                ...
                <figure class="avatar avatar-40 coverimg rounded-circle shadow bg-primary">
                    <img src="<?= base_url() ?>assets/main_theme/img/favicon72.png" alt="">
                </figure>
            </div>
    ...
    <script src="<?= base_url() ?>assets/main_theme/js/jquery-3.3.1.min.js"></script>
    <script src="<?= base_url() ?>assets/main_theme/js/popper.min.js"></script>
    <script src="<?= base_url() ?>assets/main_theme/vendor/bootstrap-5/dist/js/bootstrap.bundle.js"></script>

    <!-- Customized jquery file  -->
    <script src="<?= base_url() ?>assets/main_theme/js/main.js"></script>
    <script src="<?= base_url() ?>assets/main_theme/js/color-scheme.js"></script>

    <!-- PWA app service registration and works -->
    <script src="<?= base_url() ?>assets/main_theme/js/pwa-services.js"></script>

    <!-- date range picker -->
    <script src="<?= base_url() ?>assets/project_management/js/moment-with-locales.min.js"></script>
    <script src="<?= base_url() ?>assets/main_theme/vendor/daterangepicker/daterangepicker.js"></script>

    <!-- chosen script -->
    <script src="<?= base_url() ?>assets/main_theme/vendor/chosen_v1.8.7/chosen.jquery.min.js"></script>

    <!-- Chart js script -->
    <script src="<?= base_url() ?>assets/main_theme/vendor/chart-js-3.3.1/chart.min.js"></script>

    <!-- Progress circle js script -->
    <script src="<?= base_url() ?>assets/main_theme/vendor/progressbar-js/progressbar.min.js"></script>

    <!-- swiper js script -->
    <script src="<?= base_url() ?>assets/main_theme/vendor/swiper-7.3.1/swiper-bundle.min.js"></script>

    <!-- Simple lightbox script -->
    <script
        src="<?= base_url() ?>assets/main_theme/vendor/simplelightbox/simple-lightbox.jquery.min.js"></script>

    <!-- app tour script-->
    <script src="<?= base_url() ?>assets/main_theme/vendor/Product-Tour-Plugin-jQuery/lib.js"></script>

    <!-- Footable table master script-->
    <script src="<?= base_url() ?>assets/main_theme/vendor/fooTable/js/footable.min.js"></script>

    <!-- dragula script-->
    <script src="<?= base_url() ?>assets/main_theme/vendor/dragula/dragula.js"></script>
    <script src="<?= base_url() ?>assets/main_theme/vendor/dragula/example.js"></script>

    <!-- page level script here -->
    <script src="<?= base_url() ?>assets/main_theme/js/header-title.js"></script>

    <link rel="stylesheet"
        href="<?= base_url(); ?>assets/main_theme/vendor/datetimepicker/jquery.datetimepicker.min.css" />
    <script
        src="<?= base_url(); ?>assets/main_theme/vendor/datetimepicker/jquery.datetimepicker.full.min.js"></script>
    <script src="<?= base_url(); ?>assets/project_management/js/overtype.min.js"></script>
    <script src="<?= base_url(); ?>assets/project_management/js/jquery.mask.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script src="https://unpkg.com/showdown/dist/showdown.min.js"></script>
    <script src="<?= base_url() ?>assets/main_theme/vendor/dropzone5-9-3/dropzone.min.js"></script>
    <script src="<?= base_url() ?>assets/main_theme/js/jquery.dataTables.min.js"></script>
    <script src="<?= base_url() ?>assets/main_theme/js/dataTables.rowReorder.min.js"></script>
    <script src="<?= base_url() ?>assets/main_theme/js/dataTables.responsive.min.js"></script>
    <script src="<?= base_url() ?>assets/main_theme/js/dataTables.bootstrap5.min.js"></script>
    <script src="<?= base_url() ?>assets/main_theme/js/jszip.min.js"></script>
    <script src="<?= base_url() ?>assets/main_theme/js/dataTables.buttons.min.js"></script>
    <script src="<?= base_url() ?>assets/main_theme/js/buttons.html5.min.js"></script>
    <script type="text/javascript"
        src="https://cdnjs.cloudflare.com/ajax/libs/jquery.textcomplete/1.8.0/jquery.textcomplete.js"></script>
    <script src="<?= base_url('assets/project_management/js/jquery-comments.js') ?>"></script>
...
<script>
    ...
    const CURRENT_USER_PROFILE_URL = "<?= $this->session->userdata('profile_picture') ? 'https://trusmiverse.com/hr/uploads/profile/' . $this->session->userdata('profile_picture') : 'https://trusmiverse.com/hr/uploads/profile/anonim.jpg' ?>";
    ...
    const STATE = {
        ...
        tabs: {
            activeTab: 'tasklist_project',
            prevTab: null
        },
    };

    // GLOBAL PERIOD STATE
    let GLOBAL_PERIOD = new Date().toISOString().slice(0, 7); // Default YYYY-MM
    ...
    function refreshActiveTab() {
        const mainTab = STATE['tabs'].activeTab;
        const subTabGroup = mainTab + '_tabs';

        // Refresh the deepest active tab
        if (STATE[subTabGroup]) {
            const subTab = STATE[subTabGroup].activeTab;
            loadTab(subTabGroup, subTab);
        } else {
            loadTab('tabs', mainTab);
        }
    }
    ...
    function switchTab(group_tab, tabName) {
        prevTab = tab;
        tab = tabName;
        tabSC = toSnakeCase(tabName);

        // Update tab buttons
        updateTabButton(group_tab, tabSC);
        updateBreadcrumb(group_tab, tabName);

        // Update content
        loadTab(group_tab, tabSC);
    }

    function updateTabButton(group_tab, tabName) {
        const buttons = document.querySelectorAll(`.${group_tab}_btn`);
        buttons.forEach(btn => {
            // console.log(btn);
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let tabQuery = '<?= $menu ?? "beranda" ?>';
        tab = tabQuery || 'beranda';
        switchTab('menus', tab);
    });
...
<script>
    ...
    async function loadTab(group_tab, name, options = {}) {
        ...
        if (target) {
            ...
            container = document.getElementById(`${group_tab}_content`);
            showLoader({
                target: `#${group_tab}_content`,
                position: 'replace',
                overlay: false
            });
        }

        STATE[group_tab].prevTab = STATE[group_tab].activeTab;
        STATE[group_tab].activeTab = name;

        const nextLevel = getAllNextLevels(group_tab);
        if (nextLevel.length > 0) {
            nextLevel.forEach(level => {
                document.querySelectorAll(`script[src*="/assets/project_management/js/${level}"]`).forEach(el => el.remove());
                document.querySelectorAll(`link[href*="/assets/project_management/css/${level}"]`).forEach(el => el.remove());
            });
        }
        ...
        try {
            ...
            // Pass the period so the backend can render specific content if needed
            const res = await fetch(`${BASE_URL}project_management/load/${group_tab}/${name}?period=${GLOBAL_PERIOD}`);
            ...
            let prevTabJS = `<?= base_url('assets/project_management/js/') ?>${group_tab}/${prevTabSC}.js`;
            // Attempt to find and remove scripts that match the previous tab
            document.querySelectorAll(`script[src*="/assets/project_management/js/${group_tab}"]`).forEach(el => el.remove());
            document.querySelectorAll(`link[href*="/assets/project_management/css/${group_tab}"]`).forEach(el => el.remove());
            ...
            if (data.modal) {
                ...
                const seen = new Set();
                [...document.querySelectorAll('.modal')].reverse().forEach(el => {
            ...
            // Optional: call init function with global period
    ...
    function getNextLevel(group_tab) {
        const keys = Object.keys(STATE.hierarchy);

        const index = keys.findIndex(k => {
            const v = STATE.hierarchy[k];
            return group_tab === v || (Array.isArray(v) && v.includes(group_tab));
        });

        return STATE.hierarchy[keys[index + 1]] || [];
    }

    function getAllNextLevels(group_tab) {
        const keys = Object.keys(STATE.hierarchy);
        const index = keys.findIndex(k => {
            const v = STATE.hierarchy[k];
            return group_tab === v || (Array.isArray(v) && v.includes(group_tab));
        ...
        return index === -1 ? [] : keys.slice(index + 1).flatMap(k => STATE.hierarchy[k]);
    }
</script>
<script>
    function updateBreadcrumb(group_tab, text) {
        if (group_tab != 'menus') {
            return;
        }
        const el = document.getElementById('active-breadcrumb');
        const menu = document.querySelector('.menus_btn.active');
        if (el) {
            ...
            if (text.toLowerCase() == 'detail') {
                ...
                el.onclick = () => switchTab('menus', el.textContent);
                ...
                el.textContent = menu?.textContent;
...
<script>
    ...
    function get_summary(text, length = 50) {
        if (!text) return '';
