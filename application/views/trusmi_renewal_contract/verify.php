                                    ...
                                    <div class="form-group mb-2 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-floating">
                                                <input type="text" placeholder="id_renewal" value="<?= isset($_GET['id']) ? $_GET['id'] : ''; ?>" required class="form-control border-start-0" style="background-color: #F1F1F1;" autofocus id="id_renewal" readonly>
                                                <label>No. Renewal Contract</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group mb-2 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-floating">
                                                <?php
                                                $uid = $_GET['uid'];
                                                $user = $this->db->query("SELECT username FROM xin_employees WHERE user_id = $uid LIMIT 1")->row_array();
                                                ?>
                                                <input type="text" placeholder="Username" value="<?= isset($_GET['uid']) ? $user['username'] : ''; ?>" required class="form-control border-start-0" style="background-color: #F1F1F1;" autofocus id="username" readonly>
