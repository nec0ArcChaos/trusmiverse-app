            ...
            <div class="card border-0">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-auto align-self-center">
                            <h6 class="fw-medium mb-0">List Renewal Contract</h6>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive" style="padding: 10px;">
                        <table id="dt_renewal" class="table table-sm table-striped" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Employee Name</th>
                ...
                <div class="card-footer">
                    ...
                    <ul style="font-size: 10pt;text-align: justify;">
                        <li>PR1 : Memiliki Kemauan untuk terus belajar</li>
                        <li>PR2 : Melakukan evaluasi dari setiap yang sudah dilakukan</li>
                        <li>PR3 : Mampu beradaptasi dengan budaya perusahaan dan menunjukan performa kerja yang baik</li>
                        <li>PA1 : Berani untuk mengambil suatu keputusan/tanggung jawab</li>
                        <li>PA2 : Berjuang untuk menyelesaikan pekerjaan</li>
                        <li>PA3 : Melakukan suatu hal baik tanpa perlu diminta</li>
                        <li>PE1 : membangun iklim kerja yang harmonis</li>
                        <li>PE2 : Memberikan motivasi kepada rekan kerja</li>
                        <li>PE3 : Berusaha menjadi tauladan bagi karyawan lain</li>
