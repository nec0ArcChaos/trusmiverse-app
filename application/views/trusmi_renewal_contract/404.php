...
<body class="d-flex flex-column h-100 sidebar-pushcontent" data-sidebarstyle="sidebar-pushcontent">
    ...
    <div class="coverimg h-100 w-100 top-0 start-0 position-absolute">
        <img src="<?php echo base_url(); ?>assets/img/404-2.jpg" alt="" class="w-100" />
    </div>
    <!-- background ends  -->
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12 col-md-8 col-lg-7 col-xl-6 col-xxl-4">
                                <div class="position-relative z-index-1 text-center">
                                    <img src="<?php echo base_url(); ?>assets/img/404-1.png" alt="" class="mw-400" />
                                </div>
                                <h1 class="error404 mb-4 mtop-100 position-relative text-red">404</h1>

                                <div class="z-index-1 position-relative text-center">
                                    <div>
                                        <h1 class="display-5 top-50">Upps...</h1>
                                        <p class="h4 fw-light mb-4">Maaf anda tidak dapat verifikasi renewal contract ini.</p>
                                        <p class="text-secondary mb-4">Keterangan lebih lanjut hubungi HR.</p>
    ...
    <script type="text/javascript">
        ...
        $('#submitbtn').on('click', function() {
            id_renewal = $('#id_renewal').val();
            username = $('#username').val();
            password = $('#password').val();
            if (id_renewal == '' || username == '' || password == '') {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.result == 1) {
                            ...
                            setTimeout(function() {
                                id_renewal = "<?= isset($_GET['id']) ? $_GET['id'] : ''; ?>";
                                window.location.href = "<?php echo base_url() ?>trusmi_renewal_contract/verify?id=" + id_renewal;
                            }, 1000)
                        } else {
                            new PNotify({
                                title: 'Gagal',
