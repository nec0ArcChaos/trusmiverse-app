...
<script>
    ...
    function dt_renewal() {
        $('#dt_renewal').DataTable({
            ...
            "ajax": {
                "dataType": 'json',
                "type": "GET",
                "url": "<?= base_url(); ?>trusmi_renewal_contract/list_renewal",
                // "data": {
                //     start: start,
                //     end: end,
                // }
    ...
    function send_renewal(response) {
        ...
        if (response.data.company_id == 2) {
            ...
            Form evaluasi kerja : https://forms.gle/V83e1hoNXsjPysXXA
        ...
        // === Kirim WA pakai sistem internal ===
        $.ajax({
            ...
            success: function (res) {
                ...
                console.log("✅ WA terkirim ke " + phone, res);
            },
            error: function (xhr) {
                Swal.fire({
                    title: "Gagal!",
                ...
                console.error("❌ Gagal kirim WA ke " + phone, xhr);
            }
        });
