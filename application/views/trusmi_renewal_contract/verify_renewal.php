                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 text-right">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 text-right <?= ($data['company_id'] == 2) ? 'mt-2' : '' ?>">
                                            ...
                                            <div class="form-group mb-3 position-relative check-valid" id="input_membuat_fpk" style="display: <?= ($data['status'] == '2') ? 'block' : 'none' ?>;">
                                                <div class="input-group input-group-lg">
                                                    <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-file-earmark-plus"></i></span>
                                                    <div class="form-floating">
                                                        <select name="membuat_fpk" class="form-select border-0" id="membuat_fpk" <?= $data['status'] != '' ? 'disabled' : ''; ?>>
                                                            <option value="tidak" selected>Tidak</option>
                                                            <option value="ya">Ya (Membuat fpk)</option>
                                                        </select>
                                                        <label for="membuat_fpk">Pengajuan FPK</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group mb-3 position-relative check-valid">
                                            ...
                                            <div class="form-group mb-3 position-relative check-valid" id="input_lama_kontrak">
                                                <div class="input-group input-group-lg">
                                                    <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-calendar2-check"></i></span>
                                                    <div class="form-floating">
                                                        <select name="lama_kontrak" class="form-select border-0" id="lama_kontrak" onchange="select_lama_kontrak()" <?= $data['renewal']!=''?'readonly':''; ?>>
