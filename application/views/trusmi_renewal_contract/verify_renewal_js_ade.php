...
<script>
    ...
    function updateContractRenewal(){
        ...
        $.ajax({
            url: '<?= base_url(); ?>trusmi_renewal_contract_ade/save_renewal',
            type: 'POST',
            dataType: 'json',
            // data: form.serialize(),
            cache: false,
            ...
            success: function(response) {
                ...
                // send_comben = send_wa(comben, msg_keputusan);

                // if(send_comben.wa.length == send_comben.total_done){
                //     if(id_status == '1'){
                //         send_employee = send_wa(employee, msg_perpanjangan);
