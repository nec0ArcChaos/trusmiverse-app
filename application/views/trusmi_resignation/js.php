...
<script>
    ...
    function get_profil_user() {
        user_id = "<?= $this->session->userdata("user_id"); ?>";
        $.ajax({
            url: '<?= base_url('trusmi_resignation/get_profile') ?>',
            type: 'POST',
            dataType: 'json',
            data: {
                user_id: user_id
    ...
    $('#category').change(function() {
        ...
        $.ajax({
            url: '<?= base_url() ?>trusmi_resignation/get_data_reason',
            type: 'POST',
            dataType: 'json',
            data: {
    ...
    function dt_trusmi_resignation(start, end) {
        ...
        $('#dt_trusmi_resignation').DataTable({
            ...
            "ajax": {
                "dataType": 'json',
                "type": "POST",
                "url": "<?= base_url(); ?>trusmi_resignation/dt_trusmi_resignation",
                "data": {
                    start: start,
                    end: end,
                    user_id: user_id,
...
https://trusmiverse.com/apps/login/verify_resignation?u=${pic}&id=${id_resignation}`;
                    ...
                    window.setTimeout(function() {
                        window.location = `<?= base_url() ?>trusmi_resignation/detail_resignation?id=${id_resignation}`;
                    }, 1500);
