                    ...
                    success: function(response) {
                        ...
                        if (response.result == 1) {
                            ...
                            setTimeout(function() {
                                ...
                                if (type == 'hrd') {
                                    window.location.href = "<?php echo base_url() ?>trusmi_resignation/verify_hrd?id=" + id_resignation;
                                } else {
                                    window.location.href = "<?php echo base_url() ?>trusmi_resignation/verify_resignation?id=" + id_resignation;
                                }
                            }, 1000)
                        } else {
                            new PNotify({
