...
<script>
    ...
    function get_profile_resignation() {
        ...
        $.ajax({
            url: '<?= base_url(); ?>trusmi_resignation_ade/get_profile_resignation',
            type: 'POST',
            dataType: 'json',
            data: {
                id_resignation: id_resignation
                ...
                if (response.company_id == '2') {
                    $.ajax({
                        ...
                        success: function(response_atasan) {
                            ...
                            $("#nama_spv").html(response_atasan.nama_spv == null ? '<i class="small">*no data available</i>' : response_atasan.nama_spv);
                            $("#nama_mng").html(response_atasan.nama_mng == null ? '<i class="small">*no data available</i>' : response_atasan.nama_mng);
                        },
