...
<script type="text/javascript">
  ...
  function add_issue() {
    ...
    <span id="deadline_${next_no}_1">&nbsp;</span>
        ...
        <td class="kolom_modif" id="td_ekspektasi_${next_no}_1" data-id="ekspektasi_${next_no}_1">
            ...
            <textarea class="form-control excel" id="ekspektasi_${next_no}_1" rows="1"
  ...
  function add_action_draft(issue_no) {
    ...
    <td class="kolom_modif" id="td_ekspektasi_${issue_no}_${next_no}" data-id="ekspektasi_${issue_no}_${next_no}">
        <span id="ekspektasi_${issue_no}_${next_no}">&nbsp;</span>
        <textarea class="form-control" id="val_ekspektasi_${issue_no}_${next_no}" style="display: none;" class="excel" rows="1" onfocusin="expandTextarea_draft('val_ekspektasi_${issue_no}_${next_no}')" onfocusout="submit_update_draft('ekspektasi_${issue_no}_${next_no}')"></textarea>
    </td>
