...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#smartwizard2").on("leaveStep", function(e, anchorObject, currentStepIndex, nextStepIndex, stepDirection) {
      ...
      if (nextStepIndex == 2 && stepDirection == "forward") {
        $("#btn_finish").show();
        $.ajax({
          "url": "<?= base_url('mom_faisal/check_validasi_result/') ?>" + $("#id_mom_global").val(),
          "type": "GET",
          "dataType": 'JSON',
          "success": function(res) {
            // console.log(res);    
    ...
    $("#smartwizard3").on("leaveStep", function(e, anchorObject, currentStepIndex, nextStepIndex, stepDirection) {
      ...
      if (nextStepIndex == 2 && stepDirection == "forward") {
        $("#btn_finish_e").show();
        $.ajax({
          "url": "<?= base_url('mom_faisal/check_validasi_result/') ?>" + $("#id_mom_global_draft").val(),
          "type": "GET",
          "dataType": 'JSON',
          "success": function(res) {
            // console.log(res);    
  ...
  function add_mom() {
    ...
    $.ajax({
      url: "<?= base_url('mom_faisal/clear_result'); ?>",
      method: "GET",
      dataType: "JSON",
      success: function(res) {
