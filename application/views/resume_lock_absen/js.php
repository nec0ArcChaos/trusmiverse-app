...
<script>
    $(document).ready(function () {
        ...
        // Load DataTable
        var tableMasuk = $('#dt_lock_absen').DataTable({
            "searching": true,
            "info": true,
            "lengthChange": false,
            "paging": true,
            ...
            "ajax": {
                "url": baseurl2 + "/resume_lock_absen/lock_absen",
                "type": "POST",
                "dataType": "json"
            },
            "columns": [
                ...
                { "data": "jumlah_lock" },
                { "data": "lock_tidak_absen" },
                { "data": "jumlah_lock_mom" },
                { "data": "mom_sesuai" },
                { "data": "persen_sesuai_vs_lock_mom" },
                { "data": "mom_tidak_sesuai" },
                { "data": "persen_tidak_vs_lock_mom" },
                { "data": "jumlah_lock_non_mom" }
            ]
        });
