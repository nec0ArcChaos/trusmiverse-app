...
<script>
    const base_url = '<?= base_url('grd/bt/grd_bahrul/'); ?>';
</script>

<?php $this->load->view('grd/bt_bahrul/_content/content_1_js'); ?>
<?php $this->load->view('grd/bt_bahrul/_content/content_2_js'); ?>
<?php $this->load->view('grd/bt_bahrul/_content/content_3_js_kiri'); ?>
<?php $this->load->view('grd/bt_bahrul/_content/content_3_js_kanan'); ?>
<?php $this->load->view('grd/bt_bahrul/_content/kanban_js'); ?>
