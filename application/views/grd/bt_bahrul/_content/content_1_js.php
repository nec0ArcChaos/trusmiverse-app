<script>
    ...
    function reload_milestone() {
        fetch("<?= base_url('grd/bt/grd_bahrul/getMilestones') ?>")
...
<script>
    function get_company() {
        $.ajax({
            url: '<?= base_url() ?>grd/bt/grd_bahrul/get_company',
            type: 'POST',
            dataType: 'json',
            beforeSend: function() {
    ...
    $('#add_id_divisi').change(function(e) {
        ...
        $.ajax({
            url: '<?= base_url() ?>grd/bt/grd_bahrul/goal_pic',
            type: 'POST',
            dataType: 'json',
            data: {
    ...
    $('#add_id_goal').change(function(e) {
        ...
        $.ajax({
            url: '<?= base_url() ?>grd/bt/grd_bahrul/get_so_by_goal',
            type: 'POST',
            dataType: 'json',
            data: {
                id_goal: id_goal
    ...
    $('#add_id_so').change(function(e) {
        ...
        $.ajax({
            url: '<?= base_url() ?>grd/bt/grd_bahrul/get_si_by_so',
            type: 'POST',
            dataType: 'json',
            data: {
                id_so: id_so
...
<script>
    ...
    $('#mile_id_company').change(function(e) {
        ...
        $.ajax({
            url: '<?= base_url() ?>grd/bt/grd_bahrul/milestone_pic',
            type: 'POST',
            dataType: 'json',
            data: {
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: function() {
                        ...
                        $.ajax({
                            url: `<?= base_url() ?>grd/bt/grd_bahrul/save_task`,
                            cache: false,
                            contentType: false,
                            processData: false,
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: function() {
                        ...
                        $.ajax({
                            url: `<?= base_url() ?>grd/bt/grd_bahrul/save_task_milestone`,
                            cache: false,
                            contentType: false,
                            processData: false,
                            data: form_data_tasklist, // Setting the data attribute of ajax with file_data
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: function() {
                        ...
                        $.ajax({
                            url: `<?= base_url() ?>grd/bt/grd_bahrul/save_so`,
                            cache: false,
                            contentType: false,
                            processData: false,
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: function() {
                        ...
                        $.ajax({
                            url: `<?= base_url() ?>grd/bt/grd_bahrul/save_si`,
                            cache: false,
                            contentType: false,
                            processData: false,
