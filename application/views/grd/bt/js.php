...
<script>
    const base_url = '<?= base_url('grd/bt/grd/'); ?>';
</script>

<?php $this->load->view('grd/bt/_content/content_1_js'); ?>
<?php $this->load->view('grd/bt/_content/content_2_js'); ?>
<?php $this->load->view('grd/bt/_content/content_3_js_kiri'); ?>
<?php $this->load->view('grd/bt/_content/content_3_js_kanan'); ?>
<?php $this->load->view('grd/bt/_content/kanban_js'); ?>
