<script>
    ...
    function reload_milestone() {
        fetch("<?= base_url('grd/bt/okr/getMilestones') ?>")
...
<script>
    function get_company() {
        $.ajax({
            url: '<?= base_url() ?>grd/bt/okr/get_company',
            type: 'POST',
            dataType: 'json',
            beforeSend: function () {
    ...
    $('#add_id_divisi').change(function (e) {
        ...
        $.ajax({
            url: '<?= base_url() ?>grd/bt/okr/goal_pic',
            type: 'POST',
            dataType: 'json',
            data: {
    ...
    $('#add_id_goal').change(function (e) {
        ...
        $.ajax({
            url: '<?= base_url() ?>grd/bt/okr/get_so_by_goal',
            type: 'POST',
            dataType: 'json',
            data: {
                id_goal: id_goal
    ...
    $('#add_id_so').change(function (e) {
        ...
        $.ajax({
            url: '<?= base_url() ?>grd/bt/okr/get_si_by_so',
            type: 'POST',
            dataType: 'json',
            data: {
                id_so: id_so
...
<script>
    ...
    $('#mile_id_company').change(function (e) {
        ...
        $.ajax({
            url: '<?= base_url() ?>grd/bt/okr/milestone_pic',
            type: 'POST',
            dataType: 'json',
            data: {
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: function () {
                        ...
                        let val_evidence = $('#evidence_si')[0].files[0];
                        if (val_evidence) {
                            form_data_tasklist.append("evidence", val_evidence);
                        }


                        $.ajax({
                            url: `<?= base_url() ?>grd/bt/okr/save_task`,
                            cache: false,
                            contentType: false,
                            processData: false,
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: function () {
                        ...
                        $.ajax({
                            url: `<?= base_url() ?>grd/bt/okr/save_task_milestone`,
                            cache: false,
                            contentType: false,
                            processData: false,
                            data: form_data_tasklist, // Setting the data attribute of ajax with file_data
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: function () {
                        ...
                        $.ajax({
                            url: `<?= base_url() ?>grd/bt/okr/save_so`,
                            cache: false,
                            contentType: false,
                            processData: false,
...
<script>
    function save_si() {
        ...
        let val_target_output = $('#si_target_output').val();
        let val_target_outcome = $('#si_target_outcome').val();
        ...
        } else if (val_target_output == "") {
            $.confirm({
                icon: 'fa fa-close',
                title: 'Oops!',
                theme: 'material',
                type: 'red',
                content: 'Oops, Target Output must be filled',
                buttons: {
                    close: {
                        actions: function () { }
                    },
        ...
        } else if (val_target_outcome == "") {
            $.confirm({
                icon: 'fa fa-close',
                title: 'Oops!',
                theme: 'material',
                type: 'red',
                content: 'Oops, Target Outcome must be filled',
                buttons: {
                    close: {
                        actions: function () { }
                    },
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: function () {
                        ...
                        form_data_si.append("si_target_output", val_target_output);
                        form_data_si.append("si_target_outcome", val_target_outcome);
                        ...
                        $.ajax({
                            url: `<?= base_url() ?>grd/bt/okr/save_si`,
                            cache: false,
                            contentType: false,
                            processData: false,
