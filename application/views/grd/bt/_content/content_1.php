    ...
    <div class="col-9">
        <div class="card" style="border-radius: 25px; margin-right: -10px;">
            <div class="card-header d-flex justify-content-center align-items-center text-center" style="border-radius: 25px 25px 0 0; background-color: #081226;">
                <h5 class="text-white mt-3 fw-bold"><i class="bi bi-substack"></i>Misi & Milestone 2025 | Batik Trusmi</h5>
            </div>
            <div class="card-body" style="border-radius: 0 0 25px 25px; background-color: #081226;">
                ...
                <div class="gantt-container">
                    ...
                    <!-- <div class="gantt-row mt-3">
                        <div></div>
                        <div class="col-3">
                            <div class="progress" style="height: 20px;">
                                <div class="progress-bar bg-green text-black" style="width: 80%;">Project A</div>
                            </div>
                        </div>
                        <div></div>
                    </div>
                    ...
                    <div class="gantt-row">
                        ...
                        <div class="col-5">
                            <div class="progress" style="height: 20px;">
                                <div class="progress-bar bg-blue_4 text-black" style="width: 50%;">Project B</div>
                            </div>
                        </div>
                        <div></div>
                    </div>
                    ...
                    <div class="gantt-row">
                        ...
                        <div class="col-4">
                            <div class="progress" style="height: 20px;">
                                <div class="progress-bar bg-yellow text-black" style="width: 60%;">Project C</div>
                            </div>
                        </div>
                        <div></div>
                    </div> -->
                            ...
                            <div class="progress mb-2" style="height: 45px; width: 80%;">
                                <div class="progress-bar bg-blue_1 text-white text-start" id="eaf_pengeluaran_bar" style="width: 80%; font-size: 12px;">
                                    <span style="margin-left: 10px;">
                                        ...
                                        <br>
                                        <!-- <p id="eaf_pengeluaran">Rp.4.479.147 / 7.080.500</p> -->
