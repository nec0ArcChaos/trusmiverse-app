                    ...
                    dt_goal.sos.forEach((so, index) => {
                        ...
                        so.data_si.forEach((subtask, index) => {
                            ...
                            <tr class="bg-light-yellow">
                                ...
                                <td class="fw-bold"><span class="badge bg-info" onclick="detail_si('${subtask.id_si}','${subtask.id_so}')" style='cursor:pointer'>${Number(subtask.actual).toLocaleString()}</span></td>
                                <td class="fw-bold"><span style="cursor: not-allowed;" class="badge bg-${subtask.warna_si}">${subtask.progress_si_satuan}%</span></td>
                                <td class="fw-bold"></td>
                                <td class="fw-bold"></td>
                                <td class="fw-bold"></td>
                                <td class="fw-bold"></td>
                                        ...
                                        <div id="accordion-${so.id_so}" class="mb-2">
                                            <div class="row" id="heading-${so.id_so}">
                                                ...
                                                <p style="font-size: 14px; font-weight: bold;">
                                                    ...
                                                    <span class="text-grey small fw-bold mt-0 ml-4">Actual <span class="badge bg-info" onclick="detail_so('${so.id_so}')" style='cursor:pointer'>${Number(so.actual).toLocaleString()}</span></span>
                                                </p>
