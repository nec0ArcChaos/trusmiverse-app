<main class="main mainheight">
    ...
    <div class="container-fluid">
        <?php $this->load->view('grd/bt/_content/content_1'); ?>
    </div>
    <div class="container-fluid">
        <?php $this->load->view('grd/bt/_content/content_2'); ?>    
    </div>
                    ...
                    <div class="mb-2 col-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <label class="form-label-custom required small mb-1" for="actual_so_type">Tipe Actual SO</label>
                                <div class="input-group border-custom mb-3">
                                    <span class="input-group-text bi bi-file-earmark-font"></span>
                                    <select name="so_actual_so_type" id="so_actual_so_type" class="form-control form-control-lg border-custom">
                                        <option value="" selected disabled>- Tipe Actual SO -</option>    
                    ...
                    <div class="mb-2 col-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <label class="form-label-custom required small mb-1" for="actual_si_type">Tipe Actual si</label>
                                <div class="input-group border-custom mb-3">
                                    <span class="input-group-text bi bi-file-earmark-font"></span>
                                    <select name="si_actual_si_type" id="si_actual_si_type" class="form-control form-control-lg border-custom">
                                        <option value="" selected disabled>- Tipe Actual si -</option>    
                                        <option value="up">Up (Semakin besar, semakin baik)</option>
                                        <option value="down">Down (Semakin kecil, semakin baik)</option>
                                    </select>
                                </div>
