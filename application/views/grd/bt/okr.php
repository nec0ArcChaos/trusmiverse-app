...
<!-- 
        ...
        <?php $this->load->view('grd/bt/_content/content_3_kiri_okr'); ?>
                    ...
                    <div class="mb-2 col-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <label class="form-label-custom small mb-1" for="so">Project</label>
                                <div class="input-group mb-3 border-custom">
                                    <span class="input-group-text bi bi-pin"></span>
                                ...
                                <label class="form-label-custom required small mb-1" for="actual_so_type">Tipe Actual
                                    Project</label>
                                <div class="input-group border-custom mb-3">
                                    <span class="input-group-text bi bi-file-earmark-font"></span>
                    ...
                    <div class="mb-2 col-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <label class="form-label-custom small mb-1" for="s1">Objective</label>
                                <div class="input-group mb-3 border-custom">
                                    <span class="input-group-text bi bi-pin"></span>
                                ...
                                <label class="form-label-custom small mb-1" for="s1">Target Output</label>
                                <div class="input-group mb-3 border-custom">
                                    <span class="input-group-text bi bi-pin"></span>
                                ...
                                <label class="form-label-custom small mb-1" for="s1">Target Outcome</label>
                                <div class="input-group mb-3 border-custom">
                                    <span class="input-group-text bi bi-pin"></span>
