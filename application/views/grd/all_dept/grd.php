<main class="main mainheight">
    ...
    <div class="container-fluid">
        <?php $this->load->view('grd/all_dept/_content/content_1'); ?>
    </div>
    <div class="container-fluid">
        <?php $this->load->view('grd/all_dept/_content/content_2'); ?>    
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row mb-2">
                    ...
                    <div class="col-12 col-md-6 col-lg-6 mb-2">
                        <label class="required">Batas Tasklist</label>                       
                        <select name="tasklist_target_batas" id="tasklist_target_batas" class="form-control form-control-lg border-custom">
                            <option value="" selected disabled>- Batas Target Tasklist -</option>
                            <option value="up">Lebih besar lebih baik</option>
                            <option value="down">Lebih kecil lebih baik</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-6 mb-2">
                        ...
                        <input type="text" class="form-control form-control-lg border-custom" name="start" id="start" />
                    </div>
                    <div class="col-12 col-md-6 col-lg-6 mb-2">
                        <label class="required">Deadline</label>
                        <input type="text" class="form-control form-control-lg border-custom" name="end" id="end" />
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="input-group mb-3 border-custom">
                                    ...
                                    <input type="text" class="form-control border-custom" name="target[]" id="target" placeholder="Target Pencapaian Pekerjaan, contoh: 100" oninput="hanyaAngka('target',0)">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <div class="row mb-2">
                    ...
                    <div class="col-12 col-md-6 col-lg-6 mb-2">
                     ...
                     <div class="col-12 col-md-12 col-lg-12 mb-2">
                       <label class="required">Batas Milestone</label>                       
                        <select name="milestone_target_batas" id="milestone_target_batas" class="form-control form-control-lg border-custom">
                            <option value="" selected disabled>- Batas Target Milestone -</option>
                            <option value="up">Lebih besar lebih baik</option>
                            <option value="down">Lebih kecil lebih baik</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-2 col-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="input-group mb-3 border-custom">
                                    <span class="input-group-text bi bi-pin"></span>
                                    <input type="text" class="form-control border-custom" name="target" id="mile_target" placeholder="Target Pencapaian Pekerjaan, contoh: 100" oninput="hanyaAngka('mile_target',0)">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <label class="form-label-custom required small mb-1" for="so_target_so_type">Tipe Target SO</label>
                                    ...
                                    <!-- Jenis Target SO -->
                                    <div class="col-md-6 mb-2">
                                        <label class="form-label-custom required small mb-1" for="so_target_so_batas">Jenis Target SO</label>
                                        <div class="input-group border-custom">
                                            <span class="input-group-text bi bi-diagram-3"></span>
                                            <select name="so_target_so_batas" id="so_target_so_batas" class="form-control form-control-lg border-custom">
                                                <option value="" selected disabled>- Jenis Target SO -</option>
                                                <option value="up">Lebih besar lebih baik</option>
                                                <option value="down">Lebih kecil lebih baik</option>
                                            </select>
                                        </div>
                                ...
                                <div class="input-group mb-3 border-custom">
                                    <span class="input-group-text bi bi-pin"></span>
                                    <input type="text" class="form-control border-custom" name="so_target" id="so_target" placeholder="Target Pencapaian Pekerjaan, contoh: 100" oninput="hanyaAngka('so_target',0)">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <!-- Jenis Target SI -->
                                    <div class="col-md-6 mb-2">
                                        <label class="form-label-custom required small mb-1" for="detail">Jenis Target SI</label>
                                        <div class="input-group border-custom">
                                            <span class="input-group-text bi bi-diagram-3"></span>
                                            <select name="si_target_si_batas" id="si_target_si_batas" class="form-control form-control-lg border-custom">
                                                <option value="" selected disabled>- Jenis Target SI -</option>
                                                <option value="up">Lebih besar lebih baik</option>
                                                <option value="down">Lebih kecil lebih baik</option>
                                            </select>
                                        </div>
                                ...
                                <div class="input-group mb-3 border-custom">
                                    <span class="input-group-text bi bi-pin"></span>
                                    <input type="text" class="form-control border-custom" name="si_target" id="si_target" placeholder="Target Pencapaian Pekerjaan, contoh: 100" oninput="hanyaAngka('si_target',0)">
                                </div>
                            </div>
                        </div>
                    </div>
