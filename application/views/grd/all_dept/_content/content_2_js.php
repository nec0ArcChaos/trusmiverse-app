    ...
    function get_data_poin_check_bt(divisi, start,end)
    {
        $.ajax({
            ...
            success: function(response) {
                ...
                // operasional
                // if(divisi == 'HR'){
                //     $('#sales').text(formatAngka(0) + ' / ' + formatAngka(0));
                //     $('#sales').css('width', 0 + '%');
                //     $('#sales').addClass(get_color_progress(0));
                //     $('#basket_size').text(0 + ' / '+0);
                //     $('#basket_size').css('width', 0 + '%');
                //     $('#basket_size').addClass(get_color_progress(0));
                //     $('#transaksi').text(0 + ' / '+0);
                //     $('#transaksi').css('width', 0 + '%');
                //     $('#transaksi').addClass(get_color_progress(0));
                //     // $('#sales_s').text(response.bt.m_act_sales + ' / '+response.bt.m_tgt_sales);
                //     $('#sales_m').text(formatAngka(0) + ' / ' + formatAngka(0));
                //     $('#sales_m').css('width', 0 + '%');
                //     $('#sales_m').addClass(get_color_progress(0));
                //     $('#sales_l').text(formatAngka(0) + ' / ' + formatAngka(0));
                //     $('#sales_l').css('width', 0 + '%');
                //     $('#sales_l').addClass(get_color_progress(0));
                //     $('#sales_y').text(formatAngka(0) + ' / ' + formatAngka(0));
                //     $('#sales_y').css('width', 0 + '%');
                //     $('#sales_y').addClass(get_color_progress(0));
                // } else {
                ...
                // operasional
                // if(divisi == 'HR'){
                //     $('#prs_sales').text('Sales | ' + 0 + '%');
                //     $('#prs_basket').text('Basket Size | ' + 0 + '%');
                //     $('#prs_transaksi').text('Transaksi | ' + 0 + '%');
                //     $('#prs_sales_l').text('Sales Last Month | ' + 0 + '%');
                //     $('#prs_sales_y').text('Sales Last Year | ' + 0 + '%');
                //     $('#prs_sales_m').text('Sales This Year | ' + 0 + '%');
                // } else {
                ...
                // hr
                // if(divisi == 'HR'){
                //     $('#prs_recruitment').text('% Pemenuhan Karyawan On-time | ' + 0 + '%');
                //     $('#prs_training').text('% Kepuasan Training | ' + 0 + '%');
                //     $('#prs_od').text('Jumlah Temuan Audit | ' + 0 + '%');
                // } else {
                    $('#prs_recruitment').text('% Pemenuhan Karyawan On-time | ' + 0 + '%');
                    $('#prs_training').text('% Kepuasan Training | ' + 0 + '%');
                    $('#prs_od').text('Jumlah Temuan Audit | ' + 0 + '%');
