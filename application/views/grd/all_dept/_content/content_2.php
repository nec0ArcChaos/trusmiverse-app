...
<div class="row">
    ...
    <div class="col-md-9 col-sm-12">
        ...
        <?php 
        $this->load->view('grd/all_dept/_content/content_3_kiri');
        ?>
    </div>

    <div class="col-md-3 col-sm-12" id="div_part_support">
        <!-- Card Support -->
        ...
        <?php 
        $this->load->view('grd/all_dept/_content/content_3_kanan');
        ?>
    </div>
