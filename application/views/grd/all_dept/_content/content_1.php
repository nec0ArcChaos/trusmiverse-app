...
<div class="row mb-3">
    ...
    <div class="col-md-3 col-sm-12 mb-2" id="div_budget" style="display: none">
            ...
            <div class="card-body bg-white" style="border-radius: 0 0 25px 25px;">
                <div class="row">
                    ...
                    <div class="col-7">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="progress mb-2" style="height: 45px; width: 80%;"  id="div_eaf_sdm">
                        ...
                        <div class="d-flex align-items-center" >
                            <div class="progress" style="height: 45px; width: 80%;" id="div_eaf_produksi">
