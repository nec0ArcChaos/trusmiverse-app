                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-12">
                        ...
                        <select class="form-control form-control-md border-custom" id="select_divisi">
                            <option value="" disabled <?= ($divisi_select == 0) ? 'selected' : '' ?>>-- Pilih Divisi --</option>
                            <?php foreach ($divisi as $d) : ?>
                                <option value="<?= $d->divisi ?>" <?= ($divisi_select == $d->divisi) ? 'selected' : '' ?>>
                                    <?= $d->divisi ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header row align-items-center bg-light-blue">
                ...
                <div class="col">
                    <h5 class="fw-bold mb-0" id="t_nama_goal">Nama Goal</h5>
                </div>
                            ...
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-6 col-6 col-lg-6">
                                        <h6 class="fw-medium mb-0" id="t_so">SO</h6>
                                        <p class="text-secondary small" id="t_si">SI</p>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row mb-2">
                                    <div class="col-12 mb-2">
                                        <p class="title"><i class="bi bi-quote"></i> Detail Tasklist
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="input-group border-custom">
                                                ...
                                                <input type="text" name="actual" id="actual" class="form-control border-custom" max="100" min="0" placeholder="0" oninput="hanyaAngka('actual',0)">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                ...
                                <form id="form_update_si" enctype="multipart/form-data" class="mt-2">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="input-group border-custom">
                                                <span class="input-group-text"><i class="bi bi-hourglass-split"></i></span>
                                                <input type="text" name="actual" id="actual_si" class="form-control border-custom" min="0" value="0" oninput="hanyaAngka('actual_si',0)">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                ...
                                <form id="form_update_so" enctype="multipart/form-data" class="mt-2">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="input-group border-custom">
                                                <span class="input-group-text"><i class="bi bi-hourglass-split"></i></span>
                                                <input type="text" name="actual" id="actual_so" class="form-control border-custom" min="0" value="0" oninput="hanyaAngka('actual_so',0)">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
