                            ...
                            <div class="row">
                                ...
                                <div class="col" style="; padding-right:20px; padding-top:10px">
                                    ...
                                    if ($user_id == '1') { ?>
                                        ...
                                        <!-- <button class="btn btn-success" style="float:right; color:white" onclick="test_notif()">
                                            Test Notif
                            ...
                            <form id="form_blast">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 mb-2">
                                    <div class="form-group row">
                                        ...
                                        <div class="form-group mb-3 position-relative attachment_preview">
                                            <div class="input-group input-group-lg">
                                                <div class="form-control" id="attachment_preview">
