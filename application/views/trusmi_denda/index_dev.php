                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-auto ms-auto ps-0">
                            <!-- addnew -->
                            <button type="button" class="btn btn-md btn-outline-theme" id="btn_rekomendasi_denda"><i class="bi bi-list"></i> Rekomen Denda</button>
                            <button type="button" class="btn btn-md btn-outline-theme" data-bs-toggle="modal" data-bs-target="#modal_add_lock"><i class="bi bi-plus"></i> Add</button>
                        </div>
                    </div>
                </div>
                <div class="card-body">
            ...
            <form id="form_denda" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="col-12 col-lg-12 col-xl-12 mb-4">
                        <h6 class="title">Detail Denda <span class="text-danger" style="font-size: 9pt;">(*Wajib diisi)</span></h6>
                        <div class="row">
                                        ...
                                        <div class="form-floating">
                                            <select name="karyawan" id="karyawan" class="form-control">
                                                ...
                                                <?php foreach ($karyawan as $row) : ?>
                                                    <option value="<?= $row->user_id ?>" data-department_name="<?php echo $row->department_name ?>" data-designation_name="<?php echo $row->designation_name ?>"><?= $row->employee_name ?></option>
                                                <?php endforeach; ?>
                                            </select>
                            ...
                            <div class="col-12 col-md-6 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        ...
                                        <div class="form-floating">
                                            <input type="text" name="department_name" id="department_name" class="form-control border-start-0" required readonly>
                            ...
                            <div class="col-12 col-md-6 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        ...
                                        <div class="form-floating">
                                            <input type="text" name="designation_name" id="designation_name" class="form-control border-start-0" required readonly>
                            ...
                            <div class="col-12 col-md-6 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-wallet2"></i></span>
                                        <div class="form-floating">
                                            <input type="text" name="periode_denda" id="periode_denda" class="form-control border-start-0" value="<?php echo date('Y-m') ?>" required>
                            ...
                            <div class="col-12 col-md-6 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-wallet2"></i></span>
                                        <div class="form-floating">
                                            <input type="text" name="nominal_denda" id="nominal_denda" class="form-control border-start-0" onkeyup="updateRupiah('nominal_denda')" required>
                                            <label>*Nominal</label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-md-12 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        ...
                                        <div class="form-floating">
                                            <input type="file" name="dokumen" id="dokumen" class="form-control border-start-0">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group mb-3 position-relative check-valid">
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-wallet2"></i></span>
                                            <div class="form-floating">
                                    <select class="form-control slim-select border-custom" name="status_denda" id="status_denda_rekom">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 mt-2" id="div_reject_note" style="display: none;">
                                    <div class="form-group mb-3 position-relative check-valid">
                                            <div class="input-group input-group-lg">
                                                <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-card-text"></i></span>
                                                <div class="form-floating">
                                                    <textarea name="reject_note" id="reject_note" class="form-control border-start-0" cols="30" rows="5" style="min-height: 80px;" required=""></textarea>
                                    ...
                                    <div class="col-12 col-md-12 mb-2">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="input-group input-group-lg">
                                                <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-wallet2"></i></span>
                                                <div class="form-floating">
                                                    <input type="text" name="periode_denda_rekom" id="periode_denda_rekom" class="form-control border-start-0" value="2025-03" required="">
                                                    <label>*Periode Denda</label>
                    </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12 col-md-12 mb-2">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="input-group input-group-lg">
                                                <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-wallet2"></i></span>
                                                <div class="form-floating">
                                                    <input type="text" name="nominal_denda_rekom" id="nominal_denda_rekom" class="form-control border-start-0" onkeyup="updateRupiah('nominal_denda_rekom')" required="">
                                    ...
                                    <div class="col-12 col-md-12 mb-2">
                                        <div class="form-group mb-3 position-relative check-valid">
                                            <div class="input-group input-group-lg">
                                                <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-card-text"></i></span>
                                                <div class="form-floating">
                                                    <textarea name="alasan_rekom" id="alasan_rekom" class="form-control border-start-0" cols="30" rows="5" style="min-height: 80px;" required=""></textarea>
                                                    <label>*Reason</label>
                                </div>
                            </div>
                                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btn_save_denda_rekom" onclick="save_denda_rekom()" class="btn btn-md btn-primary" style="display: none;">Save
