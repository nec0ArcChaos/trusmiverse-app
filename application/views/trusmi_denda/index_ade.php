                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-auto align-self-center">
                                <h6 class="fw-medium mb-0">List Denda</h6>
                            </div>
                            <div class="col-auto ms-auto ps-0">
                                ...
                                <button type="button" class="btn btn-md btn-outline-theme" data-bs-toggle="modal" data-bs-target="#modal_add_lock"><i class="bi bi-plus"></i> Add Denda</button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
