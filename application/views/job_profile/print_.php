...
<body class="A4" style="background-color: transparent;">
    ...
    <tr>
      <td width=30%>
        <div class="text-center">
          <img src="<?php echo base_url('assets/images/logo-trusmi.png') ?>" style="" height="45" width="auto">
        </div>
      </td>
  ...
  <table class="table table-bordered pagebreak">
    <thead>
      <tr class="header_row">
        <th colspan="2">4. TANGGUNG JAWAB UTAMA</th>
      </tr>
  ...
  <table class="table table-bordered">
    <thead>
      <tr class="header_row">
        <th colspan="2">5. KEY PERFORMANCE INDICATOR</th>
      </tr>
      <tr style="background: #d9d6d6a3;">
  ...
  <table class="table table-bordered">
    <thead>
      <tr class="header_row">
        <th colspan="2">6. HUBUNGAN KERJA</th>
      </tr>
      <tr style="background: #d9d6d6a3;">
