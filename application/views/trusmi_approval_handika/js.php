...
<script>
    ...
    function dt_trusmi_approval(id_tabel, id_status, start, end, modal = '') {
        url = "<?= base_url(); ?>trusmi_approval_handika/dt_trusmi_approval";
        $(id_tabel).DataTable({
            "searching": true,
            "info": true,
            "paging": true,
    ...
    function save() {
        if ($('#subject').val() == '') {
            ...
            $.ajax({
                url: '<?php echo base_url() ?>trusmi_approval_handika/save',
                type: 'POST',
                dataType: 'JSON',
...
https://trusmiverse.com/apps/login/verify?u=${user_id_approve_to}&id=${no_app}`;
    ...
    function reject() {
        ...
        $.ajax({
            url: '<?php echo base_url() ?>trusmi_approval_handika/reject',
            type: 'POST',
            dataType: 'JSON',
...
`;
    ...
    function approve() {
        ...
        $('#btn_approve').prop('disabled', true);
        $.ajax({
            url: '<?php echo base_url() ?>trusmi_approval_handika/approve',
            type: 'POST',
            dataType: 'JSON',
            data: $('#formApprove').serialize(),
            success: function(response) {
...
Note : ${note}`;
    ...
    function get_approve_to() {
        ...
        $.ajax({
            'url': '<?= site_url('trusmi_approval_handika/get_approve_to') ?>',
            'type': 'GET',
            'dataType': 'json',
            'success': function(response) {
    ...
    function resend_wa() {
        ...
        $.ajax({
            url: '<?php echo base_url() ?>trusmi_approval_handika/resend_wa',
            type: 'POST',
            dataType: 'JSON',
            data: {
                no_app: no_app_val
