        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_job">
                    ...
                    <div class="row">
                        <div class="col-3">
                            <label class="form-label-custom small">Pertanyaan sebelum lamar : </label>
                        </div>
                            ...
                            <?php foreach ($question as $item) : ?>
                                ...
                                <div class="form-check me-3">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input checkbox-question" name="question[]" value="<?= $item->id ?>">
                                        <?= $item->label ?>
                                    </label>
                                </div>
                            <?php endforeach; ?>
