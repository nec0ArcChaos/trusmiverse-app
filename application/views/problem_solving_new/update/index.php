            ...
            <form id="form_problem" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="col-12 col-lg-12 col-xl-12 mb-4">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        ...
                                        <div class="form-floating">
                                            <input type="file" accept="application/pdf, .pdf, .csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel, image/jpg, image/png, image/jpeg" id="file_problem" class="form-control lampiran" name="file_problem">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="link_problem" id="link_problem" class="form-control" placeholder="https://example.com">
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="form-floating">
                                            <select name="department_id" id="department_id" class="form-control">
                                                ...
                                                <?php foreach ($department as $depa) { ?>
                                                    <option value="<?= $depa->department_id; ?>"><?= $depa->department_name; ?></option>
                                                <?php } ?>
                                            </select>
                        ...
                        <h6 class="title"><input type="checkbox" name="addition_area" id="addition_area"> <label for="addition_area">Berkaitan dengan Area ?</label></h6>
                    ...
                    <hr>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <div class="bd-callout bg-warning"> <h6 id="problem_desc">..</h6> </div>
                            </div>
                            <div class="col-md-12 mb-2">
                                <p>Yang sudah dilakukan</p>
                                <div class="bd-callout bg-warning"> <h6 id="solving_desc">..</h6> </div>
                            </div>
                            <div class="col-md-12 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
