...
<script type="text/javascript">
  ...
  function get_list_mom(start, end) {
    ...
    var tabel_mom = $('#dt_list_mom').DataTable({
      ...
      "ajax": {
        "dataType": 'json',
        "type": "POST",
        "url": "<?= base_url("mom_jobdesk/get_list_mom") ?>",
        "data": {
          datestart: start,
          dateend: end,
          closed: 1
    ...
    var tabel_rekap =
      $('#dt_list_rekap').DataTable({
        ...
        "ajax": {
          ...
          "url": "<?= base_url("mom_jobdesk/get_list_rekap") ?>"
          // "success": function (res){
          //   console.log(res);
          // },
          // "error": function (jqXHR){
  ...
  function detail_rekap(user_id, tipe) {
    ...
    $('#dt_detail_rekap').DataTable({
      ...
      "ajax": {
        "url": "<?= base_url("mom_jobdesk/get_detail_rekap") ?>",
        "type": "POST",
        "dataType": 'JSON',
        "data": {
          datestart: $("#start").val(),
  ...
  function list_eskalasi() {
    ...
    var tabel_mom = $('#dt_list_eskalasi').DataTable({
      ...
      "ajax": {
        "dataType": 'json',
        "type": "POST",
        "url": "<?= base_url("mom_jobdesk/list_eskalasi") ?>",
        "dataSrc": ""
  ...
  function generate_head_resume_v3() {
    ...
    // let end = $('#end').val();
    $.ajax({
      url: '<?= base_url() ?>mom_jobdesk/generate_head_resume_v3',
      type: 'POST',
      dataType: 'json',
      // data: {
      //     start: start,
