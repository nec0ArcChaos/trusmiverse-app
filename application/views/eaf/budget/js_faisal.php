    ...
    $(document).ready(function() {
        ...
        $('#btn_penambahan').on('click', function() {
            ...
            if (nominal_tambah.val() == '') {
                ...
                // var formdata = new FormData($('#form_penambahan')[0]);
                ...
                //         //table_penambahan.ajax.reload();

                //         alert('ok berhasil');
                //         //Swal.fire("Success!", "budget berhasil ditambah", "success");
    ...
    var table_budget = $('#dt_budget').DataTable({
        ...
        "columns": [{
            ...
            "render": function(data, type, row) {
                ...
                //     return `${data}`;
                // } else {
                    return '<a href="javascript:void(0)" class="label label-success penambahan_biaya" data-id_biaya="' + row['id_biaya'] + '" data-budget="' + row['budget'] + '" data-bulan="' + row['bulan'] + '" data-tahun_nih="' + row['tahun_budget'] + '" data-nama_biaya="' + row['nama_biaya'] + '">' + data + '</a>';
                // }
            }
        },
        {
