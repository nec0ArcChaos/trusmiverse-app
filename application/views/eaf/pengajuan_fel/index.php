	...
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			<form id="form_keperluan" autocomplete="off">
				<input type="hidden" id="ocr_result" name="ocr_result">
                <!-- Hidden untuk simpan ID temp_nota -->
                <input type="hidden" id="temp_nota_id" name="temp_nota_id">
					...
					<div class="row d-flex">
						...
						<div class="col-lg-2 col-md-2 col-sm-12 col-xs-2">
							...
							<input 
								type="text" 
								id="rupiah" 
								oninput="nominal($(this).val(), '#rupiah')" 
							...
							<span>
								<small class="text-secondary">
									<span style="color:red">*</span> Untuk DLK input 0 terlebih dahulu.
								</small>
							</span>
							<input type="hidden" id="tipe_budget">
							<input type="hidden" id="sisa_budget">
					...
					<div class="row">
						...
						<div class="col col-sm pilihan_ba_hide">
							...
							<small id="emailHelp" class="form-text text-muted">
								Diperbolehkan : .pdf, .jpg, .jpeg, .png (Jika lampiran lebih dari 1, gabungkan jadi 1 file pdf)
							</small>

							<input type="hidden" class="form-control" name="nota" id="string">
							<input type="hidden" id="temp_nota_id" name="temp_nota_id">

							<button type="button" id="upload_nota_wrap" class="btn btn-sm btn-info mt-2" >
								Upload
							</button>

							<div id="preview-nota" class="mt-2"></div>
