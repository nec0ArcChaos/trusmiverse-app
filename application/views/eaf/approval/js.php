...
<script type="text/javascript">
  ...
  function approval(id, tgl, name, adm_cn, adm_dn, adm_dsn, divisi, kategori, tipe, penerima, jenis, sisa, keperluan, note, nominal, id_appr, photo, biaya, id_biaya, id_user_verified, note_verified, tgl_jtp) {
    // console.log("id_biaya : " + id_biaya + "jtp : " + tgl_jtp);
