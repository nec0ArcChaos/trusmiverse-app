				...
				<div class="card-body">
					<div class="row mb-2">
						...
						<div class="col text-end">
							<?php if (in_array($this->session->userdata('user_id'), array(1, 61, 162, 495, 344, 1161, 1709, 488, 4405, 390))) { ?>
						...
						<table id="dt_list_jenis_biaya" class="table table-striped dt-responsive" style="width:100%">
							<thead>
								<tr>
									...
									<th>Nominal Approve User 1</th>
									<th>Max Approve User 1</th>
			...
			<div class="modal-body">
				<form id="form_jenis_biaya" autocomplete="off">
					...
					<div class="form-group row">
						...
						<div class="col-lg-12 col-sm-12" style="margin-bottom: 10px; margin-top: 10px;">
							<label>Nominal Approval <small class="text-secondary">(User 1)</small></label>
							<input type="text" class="form-control" id="nominal_app" name="nominal_app" onkeyup="updateRupiah('nominal_app')" style="border:1px solid #ced4da;border-top-right-radius:5px;border-bottom-right-radius:5px;" placeholder="1.000">
						</div>
						<div class="col-lg-12 col-sm-12" style="margin-bottom: 10px; margin-top: 10px;">
							<label>Max Nominal Approval <small class="text-secondary">(User 1)</small></label>
							<input type="text" class="form-control" id="max_nominal" name="max_nominal" onkeyup="updateRupiah('max_nominal')" style="border:1px solid #ced4da;border-top-right-radius:5px;border-bottom-right-radius:5px;" placeholder="1.000">
						</div>
					</div>
				</form>
			</div>
