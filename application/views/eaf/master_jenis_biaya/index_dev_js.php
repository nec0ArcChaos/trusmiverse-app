...
<script>
    $(document).ready(function() {
      ...
      $('#dt_list_jenis_biaya').on('click', '.edit_jenis_biaya', function() {
        ...
        user_approval.setSelected(var_id_user_approval.toString());
      ...
      $('#update_jenis_biaya').on('click', function() {
        ...
        if (jenis.val() == "") {
          ...
          $.ajax({
            url: '<?php echo base_url() ?>eaf/master_jenis_biaya_dev/insert_jenis_biaya',
            type: 'POST',
            dataType: 'json',
