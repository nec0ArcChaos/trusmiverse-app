		...
		<div class="modal-content">
			<form id="form_keperluan" autocomplete="off">
				...
				<div class="modal-body">
						...
						<div class="row auto_pengajuan mb-3" style="display: none">
							<div class="col-12">
								<label class="mb-1">Tanggal Akhir Auto Pengajuan
									<span class="badge bg-info text-dark" style="cursor: pointer" onclick="openInfoAutoPengajuanModal()"> Info </span>
								</label>
								<input
									type="text"
									id="tgl_akhir_auto_pengajuan"
									class="form-control tanggal"
									placeholder="Tanggal"
									name="tgl_akhir_auto_pengajuan"
					...
					<label class="batik-tourleader-fields" style="display: none;"><strong>Integrasi Tour Leader</strong></label>
					...
					<div class="row batik-tourleader-fields mb-3" style="display: none;">
						<div class="col-lg-2 col-sm-2">
							...
							<select class="form-control" name="status_penerima_komisi" id="status_penerima_komisi" style="border: 1px solid #ddd;">
						...
						<div class="col-lg-2 col-sm-2">
							...
							<select class="form-control" name="jenis_komisi" id="jenis_komisi" style="border: 1px solid #ddd;">
						...
						<div class="col-lg-4 col-sm-2">
							...
							<select class="form-control" name="no_reservasi" id="no_reservasi" style="border: 1px solid #ddd;">
						...
						<div class="col-lg-4 col-sm-2">
							...
							<select class="form-control" name="pic_marketing" id="pic_marketing" style="border: 1px solid #ddd;">
					...
					<div class="row batik-tourleader-fields" style="display: none;">
						<div class="col-lg-6 col-sm-2" id="div_foto_buku_rekening">
							...
							<input type="file" style="padding: .4rem .75rem;" id="foto_buku_rekening" class="form-control batik-tourleader-file" onchange="validateFileUpload('#foto_buku_rekening', '#string_foto_rekening', '.fa_wait_foto_rekening', '.fa_done_foto_rekening')">
							<small class="form-text text-muted">Format: .pdf, .jpg, .jpeg, .png (Maks. 5MB)</small>
							<input type="hidden" class="form-control" name="foto_buku_rekening" id="string_foto_rekening">
							<div class="fa_wait_foto_rekening" style="display: none;"><i class="fa fa-spinner fa-pulse"></i> <label>Checking File ...</label></div>
							<div class="fa_done_foto_rekening" style="display: none;"><i class="fa fa-check-circle" style="color: #689f38;"></i> <label>File Complete.</label></div>
						</div>
						<div class="col-lg-6 col-sm-2">
							<label>Lampiran Reservasi (Opsional)</label><input type="file" style="padding: .4rem .75rem;" id="lampiran_reservasi" class="form-control batik-tourleader-file" onchange="validateFileUpload('#lampiran_reservasi', '#string_lampiran_reservasi', '.fa_wait_lampiran_reservasi', '.fa_done_lampiran_reservasi')">
							<small class="form-text text-muted">Format: .pdf, .jpg, .jpeg, .png (Maks. 5MB)</small>
							<input type="hidden" class="form-control" name="lampiran_reservasi" id="string_lampiran_reservasi">
							<div class="fa_wait_lampiran_reservasi" style="display: none;"><i class="fa fa-spinner fa-pulse"></i> <label>Checking File ...</label></div>
							<div class="fa_done_lampiran_reservasi" style="display: none;"><i class="fa fa-check-circle" style="color: #689f38;"></i> <label>File Complete.</label></div>
						</div>
					</div>
