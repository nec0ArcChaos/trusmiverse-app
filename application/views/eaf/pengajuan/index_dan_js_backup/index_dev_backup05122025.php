			...
			<form id="form_keperluan" autocomplete="off">
				...
				<div class="modal-body">
					...
					<div class="row d-flex">
						...
						<div class="col-lg-5 col-md-7 col-sm-12 col-xs-2">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-12 col-xs-2" id="jenis_komisi_container" style="display: none;">
                            ...
                            <select class="form-control" name="jenis_komisi" id="jenis_komisi" style="border: 1px solid #ddd;">
                                ...
                                <option value="komisi_tl">Komisi TL</option>
