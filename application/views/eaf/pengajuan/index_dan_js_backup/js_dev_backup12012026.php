      ...
      $('#dt_list_eaf').DataTable({
        ...
        "columns": [{
            ...
            "render": function(data, type, row) {
              ...
              //   print = '<a target="_blank" href="<?php echo base_url() ?>eaf/pengajuan_dev/save_pengajuan/' + data + '/' + row['id_kategori'] + '/' + row['flag'] + '" class="label label-info"><i class="ti-printer"></i></a>'
              // } else {
              //   print = ''
              // }
