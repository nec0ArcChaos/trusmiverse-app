                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-auto align-self-center">
                            <h6 class="fw-medium mb-0">Reject by Verificator EAF</h6>
                        </div>
        ...
        <div class="modal-content">
			<form id="form_approval" autocomplete="off">
                <div class="modal-header row align-items-center">
                    ...
                    <div class="col">
                        <h6 class="fw-medium mb-0" id="modalAddLabel">Detail Approves</h6>
                ...
                <div class="modal-body">
					...
					<input type="text" id="id_approval_hide" name="id_approval_hide" class="form-control" readonly>
					<div class="row">
