...
<script type="text/javascript"
    src="<?= base_url(); ?>assets/data-table/extensions/buttons/js/dataTables.buttons.min.js"></script>
...
<script>
    ...
    function e_get_status(id_status = '') {
        $.ajax({
            url: '<?= base_url() ?>tickets/main/get_status',
            type: 'POST',
            dataType: 'json',
...
<script>
    ...
    category_element.addEventListener("change", function() {
        if (category_element.value == "add_new") {
            ...
            if (id_type == 1 && id_sub_type_selected == 1) {
                get_impact()
            ...
            onOpen: function() {
                $.ajax({
                    ...
                    if (response.status == true) {
                        ...
                        e_get_status(response.detail.id_status);
                        activateTab('comment');
                    } else {
                        setTimeout(() => {
                            jconfirm.instances[0].close();
