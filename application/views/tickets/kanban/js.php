...
<script>
    ...
    function kanban_data(user_id=null) {
        ...
        $.ajax({
            url: "<?= base_url('tickets/kanban/kanban_data') ?>",
            type: "POST",
            dataType: 'json',
            data: {
                user_id: user_id,
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col">
                                                            <div class="float-start">
                                                                ...
                                                                <span class="badge badge-sm badge-link me-1 bg-light-grey text-white tippy mt-1" data-tippy-content="${value.type.trim()}">
                                                                    <small class="small">${truncateString(value.type.trim(), 15)}</small>
                                                                </span>
                                                            </div>
                                                            <div class="float-end">
                                                    ...
                                                    <div class="row mb-3 mt-3">
                                                        <div class="col">
                                                            ...
                                                            <span class="badge badge-sm badge-link me-1  bg-light-green text-green tippy mt-1" data-tippy-content="${value.object.trim()}">
                                                                <small class="small">${truncateString(value.object.trim(), 15)}</small>
                                                            </span>
