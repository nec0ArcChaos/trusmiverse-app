        ...
        $('#dt_tickets').DataTable({
            ...
            },
            {
                ...
                action: function ( e, dt, node, config ) {
                    $('#dt_tickets').DataTable().ajax.reload();
                }
            }],
            "ajax": {
                "dataType": 'json',
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "render": function(data, type, row, meta) {
                        // tikdev
                        users_it_spv_up = [1, 61, 64, 1161, 5840];
                        ...
                        if (users_it_spv_up.includes(parseInt(id_user))) {
                            ...
                            if (row['development'] == null) {
                                ...
                                return `<span class="small">.${row['id_task']}</span>
                            <a role="button" class="badge bg-light-blue tikdev" style="cursor:pointer; margin-leftx:10px;">
                            <i class="bi ${class_star}"></i>
                            </a>`;
                            }
                ...
                },
                {
                    "data": "tgl_diproses",
                    "render": function(data, type, row, meta) {
                        users_it = [1, 61, 62, 64, 1161, 2041, 2063, 2070, 2969, 5203, 5397, 5840, 5963, 7111, 7651, 8257, 8259];
