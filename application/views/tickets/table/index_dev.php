                            ...
                            <table id="dt_tickets" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-nowrap small th-goals">Ticket</th>
                                        ...
                                        <th class="text-nowrap small text-center">Type</th>
                                        <th class="text-nowrap small text-center">Sub Type</th>
                                        <th class="text-nowrap small text-center">Category</th>
                                        <th class="text-nowrap small text-center">Object</th>
                                        <th class="text-nowrap small text-center">Note Update</th>
                                        <th class="text-nowrap small text-center">UAT</th>
                                        <th class="text-nowrap small text-center">ID Ticket</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
