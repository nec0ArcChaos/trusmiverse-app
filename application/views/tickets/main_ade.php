<main class="main mainheight">
    ...
    <?php if ($this->uri->segment(4) != "") {
        $this->load->view('tickets/' . $this->uri->segment(4) . '/index_ade');
    } ?>
    <!-- /Content -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row mb-2">
                    ...
                    <div class="col-12 col-md-6 col-lg-6 mb-2 d-none" id="div_sub_type">
                        <div class="ui form">
                            <div class="field">
                                <label class="required">Sub Type</label>
                                <select name="id_sub_type" id="id_sub_type" class="ui search dropdown">
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-6 mb-2 d-none" id="div_impact">
                        <div class="ui form">
                            <div class="field">
                                <label class="required">Impact</label>
                                <select name="id_impact" id="id_impact" multiple="" class="ui search dropdown">
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <p style="text-align: justify;">Khusus Pengajuan <b>Ticket terkait Development</b>
                                        saat ini ditutup karena sudah melewati batas akhir pengajuan development (tgl 6)
                                        akan dibuka kembali di awal bulan selanjutnya.</p>
                                    <br>
                                    <p style="text-align: justify;">Untuk pengajuan <b>Ticket Lainnya</b> masih dapat
                                        dilakukan.</p>
                                    <br>
                                    <p style="text-align: justify;">Kami berusaha menyelesaikan proyek-proyek yang ada
                                        dengan sebaik mungkin. <br>
                                        Terima kasih atas pengertian dan kesabaran Anda. Kami akan memberitahukan segera
                                        ketika pengajuan development dibuka kembali.
                                    </p>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="input-group mb-3">
                                    <span class="input-group-text bi bi-file-earmark-font"
                                        style="background-color: #F5F5F5;border: 1px solid #ddd;"></span>
                                    <input type="text" class="form-control" name="task" id="task" placeholder="Title"
                                        style="border:1px solid #ced4da;border-top-right-radius:5px;border-bottom-right-radius:5px;">
                                </div>
                                ...
                                <div id="div_dod" class="d-none">
                                    <label class="form-label-custom required small" for="dod">Definition of
                                        Done</label><br>
                                    <small class="text-muted">kriteria yang digunakan untuk menentukan kapan suatu
                                        pekerjaan dianggap
                                        selesai dalam development</small>
                                    <textarea name="dod" id="dod" class="form-control"
                                        style="height: 100px;"></textarea>
                                </div>
...
<!-- Modal Add Type -->
<div class="modal fade" id="modal_add_type" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-labelledby="modal_add_type_label" aria-hidden="true">
...
<!-- Modal Add Category -->
<div class="modal fade" id="modal_add_category" tabindex="-1" aria-labelledby="modal_add_category_label"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
...
<!-- Modal Detail Task -->
<div class="modal fade" id="modal_detail_task" tabindex="-1" aria-labelledby="modal_detail_task_label"
    aria-hidden="true">
                        ...
                        <div class="card border-0 mb-4">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <i
                                            class="comingsoonbi bi-calendar-event h5 avatar avatar-40 bg-light-green text-green text-green rounded "></i>
                                    </div>
                                    <div class="col">
                                    ...
                                    <div class="col-auto" id="div_resend_notif">
                                        <a role="button" class="btn btn-link bg-light-green text-green"
                                            onclick="resend_notif()">
                                            Resend Notif <i
                                                class="bi bi-whatsapp h5 avatar avatar-30 bg-light-green text-green text-green rounded "></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-6 text-start mb-3">
                                        ...
                                        <span class="badge bg-light-purple text-dark" id="e_requested_company_text"
                                            class="small">-</span>
                                        <span class="badge bg-light-yellow text-dark" id="e_requested_department_text"
                                            class="small">-</span>
                                        <span class="badge bg-light-red text-dark" id="e_requested_designation_text"
                                            class="small">-</span>
                                    </div>
                                    ...
                                    <div class="col-12 mb-1" id="div_e_dod_text">
                                    </div>
                                </div>
                                <p>
                            ...
                            <div class="card-footer" id="footer-update">
                                ...
                                <div id="div_not_started">
                                    ...
                                    <div class="row g-3 mb-3 align-items-center">
                                        <div class="col-12 col-md-3">
                                            <label class="form-label-custom small" for="e_id_type"><i
                                                    class="bullhorn icon"></i> Type</label>
                                        </div>
                                    ...
                                    <div class="row g-3 mb-3 align-items-center">
                                        <div class="col-12 col-md-3">
                                            <label class="form-label-custom small" for="e_id_category"><i
                                                    class="tags icon"></i> Category</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <div class="ui form">
                                                <div class="field">
                                                    <select name="e_id_category" id="e_id_category"
                                    ...
                                    <div class="row g-3 mb-3 align-items-center">
                                        <div class="col-12 col-md-3">
                                            <label class="form-label-custom small" for="e_id_object"><i
                                                    class="crosshairs icon"></i> Object</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <div class="ui form">
                                                <div class="field">
                                                    <select name="e_id_object" id="e_id_object"
                                                        class="ui search dropdown">
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row g-3 mb-3 align-items-center">
                                        <div class="col-12 col-md-3">
                                            <label class="form-label-custom small" for="e_id_priority"><i
                                                    class="balance scale priority icon"></i> Priority</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <div class="ui form">
                                                <div class="field">
                                                    <select name="e_id_priority" id="e_id_priority"
                                                        class="ui search dropdown">
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row g-3 mb-3 align-items-center">
                                        <div class="col-12 col-md-3">
                                            <label class="form-label-custom small" for="e_id_level"><i
                                                    class="sort amount up icon"></i> Level</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <div class="ui form">
                                                <div class="field">
                                    ...
                                    <div class="row g-3 mb-3 align-items-center">
                                        <div class="col-12 col-md-3">
                                            <label class="form-label-custom small" for="e_id_pic"><i
                                                    class="user md icon"></i> PIC</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <div class="ui form">
                                                <div class="field">
                                                    <select name="e_id_pic" id="e_id_pic" class="ui search dropdown"
                                                        multiple>
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row g-3 mb-3 align-items-center">
                                        <div class="col-12 col-md-3">
                                            <label class="form-label-custom small" for="e_due_date"><i
                                                    class="clock outline icon"></i> Due Date</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <div class="row">
                                                <div class="col">
                                                    <input type="text" name="e_due_date" id="e_due_date"
                                    ...
                                    <div class="row g-3 mb-3 align-items-center">
                                        <div class="col-12 col-md-3">
                                            <label class="form-label-custom required small" for="e_start"><i
                                                    class="calendar alternate outline icon"></i> Start</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <input type="text" name="start_timeline"
                                                class="form-control border tanggal-menit" placeholder="Start Timeline"
                                                id="e_start_timeline" autocomplete="off" />
                                        </div>
                                    </div>
                                    <div class="row g-3 mb-3 align-items-center">
                                        <div class="col-12 col-md-3">
                                            <label class="form-label-custom required small" for="e_start"><i
                                                    class="calendar alternate outline icon"></i> End</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <input type="text" name="end_timeline"
                                                class="form-control border tanggal-menit" placeholder="End Timeline"
                                                id="e_end_timeline" autocomplete="off" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-3 mb-3 align-items-center">
                                    <div class="col-12 col-md-3">
                                        <label class="form-label-custom small required" for="e_id_status"><i
                                                class="spinner icon"></i> Status</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                        <div class="ui form">
                                            <div class="field">
                                ...
                                <div class="row g-3 mb-3 align-items-center d-none" id="leadtime_uat">
                                    <!-- Windu || 2024-08-09 -->
                                    <div class="col-12 col-md-3">
                                        <label class="form-label-custom small" for="uat_leadtime"><i
                                                class="clock outline icon"></i> Due Date UAT</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" name="uat_leadtime" id="uat_leadtime"
                                                    class="tanggal form-control">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row g-3 mb-3 align-items-center">
                                    <div class="col-12 col-md-3">
                                        <label class="form-label-custom required small" for="e_progress"><i
                                                class="chart bar outline icon"></i> Progress</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                        <input type="number" name="progress" id="e_progress" class="form-control mt-2"
                                            autocomplete="off" min="0" max="100">
                                    </div>
                                </div>
                                <div class="row g-3 mb-3 align-items-center">
                                    <div class="col-12 col-md-3">
                                        <label class="form-label-custom required small" for="e_note"><i
                                                class="sticky note outline icon"></i> Note Update</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                        <textarea name="e_note" id="e_note" class="form-control"
                                            style="height: 100px;"></textarea>
                                    </div>
                                </div>
                                <div class="row gx-2">
                    ...
                    <div class="col-12 col-md-12 col-lg-6">
                        <div class="row">
                            <div class="col">
                                <ul class="nav detail_tabs nav-WinDOORS">
                                    <li class="nav-item">
                                        <a class="nav-link" href="javascript:void(0)" id="nav_comment"
                                            onclick="activateTab('comment')">
                                            Comment
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class=" nav-item">
                                        <a class="nav-link" href="javascript:void(0)" id="nav_files"
                        ...
                        <div class="row detail_pages" id="activity_page">
                            <div class="col">
                                <div class="table-responsive" style="padding: 10px;">
                                    <table id="dt_log_history" class="table table-borderless table-striped footable"
                                        style="width:100%" data-filtering="false">
                                        <!-- <thead>
                                            <tr class="text-muted">
                                                <th></th>
                                                <th></th>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col text-end mt-2">
                                                <button class="btn btn-sm btn-theme" onclick="save_comment()"><i
                        ...
                        <div class="row detail_pages" id="files_page" style="display:none">
                            <div class="row align-items-center mb-3">
                                <div class="col-auto">
                                    <i
                                        class="bi bi-file-earmark-richtext h5 avatar avatar-40 bg-light-green text-green rounded"></i>
                                </div>
                                <div class="col">
                                ...
                                <div class="col-auto">
                                    <button type="button" class="btn btn-link text-secondary" data-bs-toggle="collapse"
                                        href="#collapseExample" role="button" aria-expanded="false"
                                        aria-controls="collapseExample">Attach New File <i
                                                ...
                                                <div class="input-group input-group-lg">
                                                    ...
                                                    <div class="form-floating">
                                                        <input type="text" name="nama_file" id="nama_file"
                                                            ...
                                                            onchange="remove_invalid('nama_file')"
                                                            oninput="remove_invalid('nama_file')">
                                            ...
                                            <div class="form-group mb-3 position-relative check-valid">
                                                <div class="input-group input-group-lg">
                                                    ...
                                                    <div class="form-floating">
                                                        ...
                                                        <input type="text" id="file_string"
                                                            placeholder="Click to select file"
                                                            class="form-control border-start-0" onclick="addFileInput()"
                                                            onchange="remove_invalid('file_string')"
                                                            oninput="remove_invalid('file_string')">
                                                        <label>Click to select file</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12 text-end">
                                                <button type="button" class="btn btn-theme" id="btn_save_upload"
                                                    onclick="upload_file()">Save</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <div class="position-fixed right-0 bottom-0 end-0 p-3" style="z-index: 99999999">
                            <div id="liveToast" class="toast hide" role="alert" aria-live="assertive"
                                ...
                                <div class="toast-header">
                                    <i class="bi bi-check-circle-fill text-success" id="upload_check"
                                        style="display:none"></i>
                                    <div class="spinner-border spinner_upload text-success" id="spinner_upload"
                                        role="status">
                                        <span class="visually-hidden">Loading...</span>
                                    </div>
                                    &nbsp;
                                ...
                                <div class="toast-body">
                                    ...
                                    <div class="mt-4">
                                        <div class="progress h-5 mb-1 bg-light-green">
                                            <div id="myProgressBar" class="progress-bar bg-green" role="progressbar"
...
<!-- Modal Edit tiket date tikdev by Ade -->
<div class="modal fade" id="modal_edit_ticket_date" aria-labelledby="modal_add_request_label" aria-hidden="true">
        ...
        <div class="modal-content">
            <form id="form_add_request">
                <div class="modal-header row align-items-center">
                    ...
                    <div class="col">
                        <h6 class="fw-medium mb-0" id="modal_add_request_label">Edit</h6>
                        <p class="text-secondary small">Ticket Date </p>
                    </div>
                    <div class="col-auto ps-0">
                        <div class="dropdown d-inline-block">
                ...
                <div class="modal-body">
                    <div class="col-12 col-lg-12 col-xl-12 mb-0">
                        <h6 class="title">Form Date</h6>
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 mb-2">
                                <input type="text" name="ed_id_task" id="ed_id_task" readonly>
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-calendar-event"></i></span>
                                        <div class="form-floating">
                                            <input type="text" placeholder="Date" name="ed_start_date" id="ed_start_date" value="2024-12-19" required class="form-control border-start-0 edit-date">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-calendar-event"></i></span>
                                        <div class="form-floating">
                                            <input type="text" placeholder="Date" name="ed_due_date" id="ed_due_date" value="2024-12-19" readonly class="form-control border-start-0">
                                            <label>Due Date (Dev)</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="invalid-feedback mb-3">Add valid data </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-calendar-event"></i></span>
                                        <div class="form-floating">
                                            <input type="text" placeholder="Date" name="ed_done_date" id="ed_done_date" value="2024-12-19" required class="form-control border-start-0 edit-date">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-md btn-primary" id="btn_save" onclick="update_date()">Update <i class="bi bi-floppy"></i></button>
...
<!-- Modal Add development tikdev by Ade -->
<div class="modal fade" id="modal_add_development" aria-labelledby="modal_add_request_label" aria-hidden="true">
        ...
        <div class="modal-content">
            <form id="form_add_request">
                <div class="modal-header row align-items-center">
                    ...
                    <div class="col">
                        <h6 class="fw-medium mb-0" id="modal_add_request_label">Assign</h6>
                        <p class="text-secondary small">Development & Week </p>
                    </div>
                    <div class="col-auto ps-0">
                        <div class="dropdown d-inline-block">
                            <a class="btn btn-link btn-square text-secondary dd-arrow-none dropdown-toggle" role="button" aria-expanded="false" data-bs-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-body">
                    <div class="col-12 col-lg-12 col-xl-12 mb-0">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 mb-2">
                                <input type="hidden" name="ad_id_task" id="ad_id_task" readonly>
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-calendar-event"></i></span>
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="develop_period" id="develop_period" value="2024-12">
                                            <!-- <input type="text" class="form-control" name="periode" id="periode" value="2024-12" /> -->
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        ...
                                        <div class="form-floating">
                                            <!-- <input type="text" placeholder="Date" name="develop_week" id="develop_week" value="2024-12-19" required class="form-control border-start-0"> -->
                                            <select name="develop_week" id="develop_week" class="form-control">
                                ...
                                <div class="invalid-feedback mb-0">Add valid data </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-md btn-outline-secondary" style="margin-right: 10px;" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-md btn-primary" id="btn_save_assign" onclick="assign_develop()">Save <i class="bi bi-floppy"></i></button>
                    <!-- <button type="button" style="display:none" class="btn btn-md btn-success" id="btn_update" onclick="update_request()">Update Request <i class="bi bi-floppy"></i></button> -->
                </div>
            </form>
        </div>
