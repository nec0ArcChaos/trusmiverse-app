<main class="main mainheight">
    ...
    <?php if ($this->uri->segment(4) != "") {
        $this->load->view('tickets/' . $this->uri->segment(4) . '/index_dev');
    } ?>
    <!-- /Content -->
                    ...
                    <div class="col-12 col-md-12 col-lg-6 col-xxl-6">
                        <div class="card border-0 mb-4">
                            ...
                            <div class="card-footer" id="footer-update">
                                ...
                                <div class="row g-3 mb-3 align-items-center d-none" id="leadtime_uat"> <!-- Windu || 2024-08-09 -->
                                    <div class="col-12 col-md-3">
                                        <label class="form-label-custom small" for="uat_leadtime"><i class="clock outline icon"></i> Due Date UAT</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" name="uat_leadtime" id="uat_leadtime" class="tanggal form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
