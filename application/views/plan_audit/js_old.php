...
<script>
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                res.dokumen.forEach((value, index) => {
                    dokumen += `<option value = "${value.no_dok} | ${value.jabatan} | ${value.tipe}">${value.no_dok}</option>`
                })
    ...
    function get_department() {
        ...
        if (company != '') {
            $.ajax({
                ...
                dataType: "JSON",
                success: function(res) {
                    let department = '<option value = "" selected disabled>--Pilih Departemen--</option>'
    ...
    function get_posisi() {
        ...
        if (company != '' && department != '') {
            $.ajax({
                ...
                dataType: "JSON",
                success: function(res) {
                    let designation = '<option value = "" selected disabled>--Pilih Posisi--</option>'
    ...
    $('#btn_send_wa').on('click', function() {
        $.ajax({
            url: "<?= base_url('plan_audit_dev/send_wa') ?>",
            dataType: "JSON",
            method: "POST",
            success: function(res) {
                console.log(res);
