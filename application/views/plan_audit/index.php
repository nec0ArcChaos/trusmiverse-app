                ...
                <form id="form_add_audit">
                    <div class="col-lg-12 d-lg-flex d-sm-block justify-content-between">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="input-group mb-3">
                                <select name="department" id="department" class=" select_permintaan" style="border:1px solid #ced4da;border-top-right-radius:5px;border-bottom-right-radius:5px;" multiple>
                                </select>
                                <input type="hidden" id="department_hidden" name="department_hidden">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="col-lg-2">
                                <label class="form-label-custom required small" for="target">Plan Start</label>
                                <div class="input-group mb-3">
                                    <input type="date" name="plan_start" id="plan_start" class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <label class="form-label-custom required small" for="target">Plan End</label>
                                <div class="input-group mb-3">
                                    <input type="date" name="plan_end" id="plan_end" class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <label class="form-label-custom required small" for="posisi">Posisi</label>
                                <div class="input-group mb-3">
                                    <select name="posisi" id="posisi" class=" select_permintaan" style="border:1px solid #ced4da;border-top-right-radius:5px;border-bottom-right-radius:5px;" multiple>
                                    </select>
                                    <input type="hidden" id="posisi_hidden" name="posisi_hidden">
                                </div>
                            </div>
                            <div class="col-lg-3">
                            ...
                            <!-- <div class="col-lg-3">
                                <label class="form-label-custom required small" for="dokumen">Dokumen</label>
                                <div class="input-group mb-3">
                                    <input type="text" name="nama_dokumen" id="nama_dokumen" class="form-control" placeholder="Nama Dokumen" style="border:1px solid #ced4da;border-top-right-radius:5px;border-bottom-right-radius:5px;">
                                </div>
                            </div> -->
                            <div class="col-lg-2">
