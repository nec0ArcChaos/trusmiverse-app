...
<script>
    ...
    function save_request() {
        ...
        $.ajax({
            url: '<?= base_url('overtime_request/save_request') ?>',
            type: 'POST',
            dataType: 'json',
            processData: false,
            contentType: false,
                                    ...
                                    <div class ="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <i class="text-secondary bi bi-buildings"></i> ${row['company_name']} <br>
                                                <i class="text-secondary bi bi-tag"></i> ${row['department_name']} <br>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <i class="text-secondary bi bi-clock"></i> ${row['in_time']} - ${row['out_time']} (Request Clock (in-out))<br>
                                            ...
                                            <div class="col-md-6 mt-2">
                                                <div class="form-group mb-3 position-relative check-valid">
                                                    <div class="input-group input-group-lg clockpicker">
                                                        ...
                                                        <div class="form-floating">
                                                            <input type="text" name="in_time_edit" id="in_time_${data}" class="form-control border-start-0 time_edit" value="${row['in_time']}" required placeholder="--:--">
                                                            <label>In Time</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6 mt-2">
                                                <div class="form-group mb-3 position-relative check-valid">
                                                    <div class="input-group input-group-lg clockpicker">
                                                        ...
                                                        <div class="form-floating">
                                                            <input type="text" name="out_time_edit" id="out_time_${data}" class="form-control border-start-0" value="${row['out_time']}" required placeholder="--:--">
    ...
    function approve_request(status, time_request_id, employee_name) {
        ...
        if (approval.includes(parseInt(user))) {
            if (in_time == '') {
                error_alert("In time is required!");
        ...
        $.confirm({
            ...
            buttons: {
                approve: {
                    ...
                    action: function() {
                        $.ajax({
                            url: "<?= base_url("overtime_request/approve_request") ?>",
                            type: "POST",
                            dataType: "json",
                            data: {
                                time_request_id: time_request_id,
