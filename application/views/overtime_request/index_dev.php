                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-12">
                            ...
                            $super_user = [1, 323, 979, 778];

                            $staff_helper_list = [7, 8]; // 7 : Staff, 8 : Helper
                            $user_role_id = $_SESSION['user_role_id'];

                            if (in_array($user_role_id, $staff_helper_list) || in_array($user_id, $super_user)) { ?>
                            ...
                            <?php } else if (in_array($user_id, $list_head) || in_array($user_id, $super_user)) { ?>
                    ...
                    <div class="col-12 col-lg-12 col-xl-12 mb-4">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12 mb-2">
                                ...
                                <div>
                                    <span style="font-size: small; font-style: italic;">- Ukuran <b>Maksimal</b> File <b>2 MB</b> </span><br>
