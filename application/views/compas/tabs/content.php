            ...
            <div class="card-body px-4 rounded-3">
                <div class="row">
                    <div class="col-auto d-flex align-items-center">
                        <h6 class="fw-bold text-dark mb-1">Content Team</h6>
                    </div>
                    <div class="ms-auto col-auto d-flex align-items-center">
                        <button class="btn btn-theme btn-sm rounded-1 px-3 d-flex align-items-center action-restricted"
                            data-bs-toggle="modal" data-bs-target="#inviteContentTeamModal">
                            <i class="bi bi-plus-lg me-1"></i> Invite Team
                        </button>
                    </div>
                    <div class="col-auto ps-0 avatar-group" id="avatar-content-team">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-8">
        ...
        <div class="card mb-4 rounded-3">
            <div class="card-header bg-transparent border-0 d-flex justify-content-between align-items-center py-3">
                <h6 class="mb-0 fw-bold">Content Plan</h6>
                <button type="button" id="btnAddPlanContent"
                    class="btn btn-theme btn-sm rounded-1 px-3 d-flex align-items-center action-restricted"
                    data-bs-toggle="modal" data-bs-target="#addContentPlanModal">
                    <i class="bi bi-plus-lg me-1"></i> Add Plan
                </button>
            </div>
            <div class="card-body p-2">
                <div class="table-responsive">
                    <table id="dt_content_plan" class="table table-bordered table-striped no-footer dataTable"
                        width="100%">
                        <thead class="bg-light text-secondary small text-uppercase fw-bold">
                            <tr>
                                <th class="ps-4" style="width: 40%">Content Plan</th>
        ...
        <div class="card rounded-3 p-3">
            ...
            <div class="card-body">
                <div id="comments-container-content"></div>
            </div>
        </div>
    </div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-6">
                        <div class="p-3 bg-white bg-opacity-10 rounded-3">
                            <h2 class="fw-bold mb-0" id="team_efficiency_content">-</h2>
                            <small class=" xx-small text-uppercase">Efficiency</small>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="p-3 bg-white bg-opacity-10 rounded-3">
                            <h2 class="fw-bold mb-0" id="team_done_content">-</h2>
