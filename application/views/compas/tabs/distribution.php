            ...
            <div class="card-body px-4 rounded-3">
                <div class="row">
                    <div class="col-auto d-flex align-items-center">
                        <h6 class="fw-bold text-dark mb-1">Distribution Team</h6>
                    </div>
                    <div class="ms-auto col-auto d-flex align-items-center">
                        <button class="btn btn-theme btn-sm rounded-1 px-3 d-flex align-items-center action-restricted"
                            data-bs-toggle="modal" data-bs-target="#inviteTeamDistributionModal">
                            <i class="bi bi-plus-lg me-1"></i> Invite Team
                        </button>
                    </div>
                    <div class="col-auto ps-0 avatar-group" id="avatar-distribution-team">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-8">
        ...
        <div class="card mb-4 rounded-3">
            <div class="card-header bg-transparent border-0 d-flex justify-content-between align-items-center py-3">
                <h6 class="mb-0 fw-bold">Distribution Plan</h6>
                <button type="button" id="btnAddPlanDistribution"
                    class="btn btn-theme btn-sm rounded-1 px-3 d-flex align-items-center action-restricted"
                    data-bs-toggle="modal" data-bs-target="#addDistributionPlanModal">
                    <i class="bi bi-plus-lg me-1"></i> Add Plan
                </button>
            </div>
            <div class="card-body p-2">
                <div class="table-responsive">
                    <table id="dt_distribution_plan" class="table table-bordered table-striped no-footer dataTable"
                        width="100%">
                        <thead class="bg-light text-secondary small text-uppercase fw-bold">
                            <tr>
                                <th class="text-center" style="width: 10%">ID</th>
                                <th class="ps-4" style="width: 40%">Distribution Plan</th>
