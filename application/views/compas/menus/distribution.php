...
<div class="row bg-gradient-theme-light mb-4 py-2">
    <div class="col text-center">
        <h4>Distribution Channel <span class="text-gradient">Management</span></h4>
        <p class="text-secondary">Streamline distribution processes and track logistics. Manage inventory, coordinate
            deliveries,
            and ensure timely market reach.</p>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-12 mb-4" id="distribution-stat-cards">
        <div class="row g-3">
            <!-- EFFICIENCY -->
                ...
                <div class="card border-0 rounded-4 h-100 overflow-hidden"
                    ...
                    <div class="card-body p-4 d-flex flex-column justify-content-between">
                        <p class="text-uppercase fw-bold mb-3 opacity-80"
                            ...
                            AVG SLA Time</p>
                        <div>
                            <h2 class="fw-bold mb-1" id="dist-stat-avg-lead"
                ...
                <div class="card border-0 rounded-4 h-100 overflow-hidden"
                    ...
                    <div class="card-body p-4 d-flex flex-column justify-content-between">
                        <p class="text-uppercase fw-bold mb-3 opacity-80"
                            ...
                            AVG AI Score</p>
                        <div>
                            <h2 class="fw-bold mb-1" id="dist-stat-avg-ai"
                ...
                <div class="card border-0 rounded-4 h-100 overflow-hidden"
                    ...
                    <div class="card-body p-4 d-flex flex-column justify-content-between">
                        <p class="text-uppercase fw-bold mb-3 opacity-80"
                            ...
                            Total Submissions</p>
                        <div>
                            <h2 class="fw-bold mb-1" id="dist-stat-total"
                                style="font-size: 2rem; letter-spacing: -1px;">—
                            </h2>
                ...
                <div class="card border-0 rounded-4 h-100 overflow-hidden"
                    ...
                    <div class="card-body p-4 d-flex flex-column justify-content-between">
                        <p class="text-uppercase fw-bold mb-3 opacity-80"
                            ...
                            Approved Plans</p>
                        <div>
                            <h2 class="fw-bold mb-1" id="dist-stat-approved"
                                style="font-size: 2rem; letter-spacing: -1px;">
                                —</h2>
