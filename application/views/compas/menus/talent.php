...
<div class="row bg-gradient-theme-light mb-4 py-2">
    <div class="col text-center">
        <h4>Talent Management <span class="text-gradient">Collaboration</span></h4>
        <p class="text-secondary">Manage influencers, KOLs, and talent collaborations. Track performance and costs.</p>
    </div>
</div>
...
<div class="row mb-3">
    <!-- ── Talent Stat Cards ──────────────────────────────────── -->
    <div class="col-12 mb-4" id="talent-stat-cards">
        <div class="row g-3">
            <!-- UNIQUE TALENTS -->
                ...
                <div class="card border-0 rounded-4 h-100 overflow-hidden"
                    ...
                    <div class="card-body p-4 d-flex flex-column justify-content-between">
                        <p class="text-uppercase fw-bold mb-3 opacity-80"
                            ...
                            Unique Talents</p>
                        <div>
                            <h2 class="fw-bold mb-1" id="talent-stat-unique"
                                style="font-size: 2rem; letter-spacing: -1px;">
                                —</h2>
                            <p class="mb-0 opacity-75" style="font-size: 11px;">Distinct creators</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0 rounded-4 h-100 overflow-hidden"
                    ...
                    <div class="card-body p-4 d-flex flex-column justify-content-between">
                        <p class="text-uppercase fw-bold mb-3 opacity-80"
                            ...
                            AVG AI Score</p>
                        <div>
                            <h2 class="fw-bold mb-1" id="talent-stat-avg-ai"
                                style="font-size: 2rem; letter-spacing: -1px;">
                                —</h2>
                ...
                <div class="card border-0 rounded-4 h-100 overflow-hidden"
                    ...
                    <div class="card-body p-4 d-flex flex-column justify-content-between">
                        <p class="text-uppercase fw-bold mb-3 opacity-80"
                            ...
                            Total Submissions</p>
                        <div>
                            <h2 class="fw-bold mb-1" id="talent-stat-total"
                                style="font-size: 2rem; letter-spacing: -1px;">—
                            </h2>
                ...
                <div class="card border-0 rounded-4 h-100 overflow-hidden"
                    ...
                    <div class="card-body p-4 d-flex flex-column justify-content-between">
                        <p class="text-uppercase fw-bold mb-3 opacity-80"
                            ...
                            Approved Plans</p>
                        <div>
                            <h2 class="fw-bold mb-1" id="talent-stat-approved"
