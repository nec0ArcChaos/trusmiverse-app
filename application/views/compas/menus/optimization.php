...
<div class="row bg-gradient-theme-light mb-4 py-2">
    <div class="col text-center">
        <h4>Performance Optimization <span class="text-gradient">Analytics</span></h4>
        <p class="text-secondary">Enhance campaign performance through data-driven insights. Track KPIs, analyze trends,
            and implement strategies for maximum ROI.</p>
    </div>
</div>

<!-- Navigation Bar -->
<div class="row mb-3">
    <!-- ── Optimization Stat Cards ────────────────────────────── -->
    <div class="col-12 mb-4" id="optimization-stat-cards">
        <div class="row g-3">
            <!-- AVG SLA Time -->
                ...
                <div class="card border-0 rounded-4 h-100 overflow-hidden"
                    ...
                    <div class="card-body p-4 d-flex flex-column justify-content-between">
                        <p class="text-uppercase fw-bold mb-3 opacity-80"
                            ...
                            AVG SLA Time</p>
                        <div>
                            <h2 class="fw-bold mb-1" id="opt-stat-avg-lead"
                ...
                <div class="card border-0 rounded-4 h-100 overflow-hidden"
                    ...
                    <div class="card-body p-4 d-flex flex-column justify-content-between">
                        <p class="text-uppercase fw-bold mb-3 opacity-80"
                            ...
                            AVG AI Score</p>
                        <div>
                            <h2 class="fw-bold mb-1" id="opt-stat-avg-ai"
                ...
                <div class="card border-0 rounded-4 h-100 overflow-hidden"
                    ...
                    <div class="card-body p-4 d-flex flex-column justify-content-between">
                        <p class="text-uppercase fw-bold mb-3 opacity-80"
                            ...
                            Total Submissions</p>
                        <div>
                            <h2 class="fw-bold mb-1" id="opt-stat-total" style="font-size: 2rem; letter-spacing: -1px;">
                                —
                            </h2>
                ...
                <div class="card border-0 rounded-4 h-100 overflow-hidden"
                    ...
                    <div class="card-body p-4 d-flex flex-column justify-content-between">
                        <p class="text-uppercase fw-bold mb-3 opacity-80"
                            ...
                            Approved Plans</p>
                        <div>
                            <h2 class="fw-bold mb-1" id="opt-stat-approved"
                                style="font-size: 2rem; letter-spacing: -1px;">—
                            </h2>
