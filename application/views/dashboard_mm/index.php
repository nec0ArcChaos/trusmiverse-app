...
<div class="row">
    ...
    <div class="row">
            ...
            <div class="card border-0 bg-theme h-100">
                <div class="card-header bg-none">
                    <div class="row align-items-center">
                        <div class="col">
                            <h6 class="fw-medium">
                                <i class="bi bi-person-badge-fill h5 me-1 avatar avatar-30 rounded"></i>
                                <!-- Profile -->
                            </h6>
                        </div>
                    </div>
                ...
                <div class="card-body bg-none text-white">
                    <div class="text-center mb-3">
                        ...
                        <h3 class="fw-normal mb-0 username">Muhammad Irfannudin</h3>
                        <h5 class="fw-medium">Manager Marketing</h5>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="row align-items-center">
                                ...
                                <div class="col ps-0">
                                    <p class="small text-muted mb-1">Tanggal Join</p>
                                    <p class="">26 Maret 2018</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-12 col-md-6 col-lg-6 col-xxl-9 mb-4 ">
                            ...
                            <table class="table table-borderless footable" data-show-toggle="true">
                                ...
                                <tbody>
                                    <tr>
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <figure class="avatar avatar-40 mb-0 coverimg rounded-circle">
                                                        <img src="https://getwindoors.com/html/assets/img/company6.png" alt="" />
                                                    </figure>
                                                </div>
                                                <div class="col ps-0">
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#edittable"><i class="bi bi-pencil"></i></button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <figure class="avatar avatar-40 mb-0 coverimg rounded-circle">
                                                        <img src="https://getwindoors.com/html/assets/img/company2.png" alt="" />
                                                    </figure>
                                                </div>
                                                <div class="col ps-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <figure class="avatar avatar-40 mb-0 coverimg rounded-circle">
                                                        <img src="https://getwindoors.com/html/assets/img/company3.jpg" alt="" />
                                                    </figure>
                                                </div>
                                                <div class="col ps-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <figure class="avatar avatar-40 mb-0 coverimg rounded-circle">
                                                        <img src="https://getwindoors.com/html/assets/img/company4.jpg" alt="" />
                                                    </figure>
                                                </div>
                                                <div class="col ps-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <figure class="avatar avatar-40 mb-0 coverimg rounded-circle">
                                                        <img src="https://getwindoors.com/html/assets/img/company5.png" alt="" />
                                                    </figure>
                                                </div>
                                                <div class="col ps-0">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto avatar-group">
                            <figure class="avatar avatar-40 rounded-circle coverimg overlay-ms-15" data-bs-toggle="tooltip" data-bs-placement="top" title="Just Demo">
                                <img src="https://getwindoors.com/html/assets/img/company2.png" alt="" />
                            </figure>
                            <figure class="avatar avatar-40 rounded-circle coverimg overlay-ms-15" data-bs-toggle="tooltip" data-bs-placement="top" title="Preview Purpose">
                                <img src="https://getwindoors.com/html/assets/img/company3.jpg" alt="" />
                            </figure>
                            <figure class="avatar avatar-40 rounded-circle coverimg overlay-ms-15" data-bs-toggle="tooltip" data-bs-placement="top" title="to look real">
                                <img src="https://getwindoors.com/html/assets/img/company4.jpg" alt="" />
                            </figure>
                        </div>
                    </div>
                ...
                <div class="card-body bg-none">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto ps-0 avatar-group">
                            <figure class="avatar avatar-40 rounded-circle coverimg overlay-ms-15" data-bs-toggle="tooltip" data-bs-placement="top" title="Shelvey Doe">
                                <img src="assets/img/user-2.jpg" alt="" />
                            </figure>
                            <figure class="avatar avatar-40 rounded-circle coverimg overlay-ms-15" data-bs-toggle="tooltip" data-bs-placement="top" title="Maria Smith">
                                <img src="assets/img/user-3.jpg" alt="" />
                            </figure>
                            <figure class="avatar avatar-40 rounded-circle coverimg overlay-ms-15" data-bs-toggle="tooltip" data-bs-placement="top" title="Steve Branden">
                                <img src="assets/img/user-4.jpg" alt="" />
                            </figure>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-3 position-relative">
                        <div class="dropdown d-inline-block position-absolute end-0 top-0 m-2">
                            <a class="btn btn-link bg-theme-light btn-square dd-arrow-none dropdown-toggle" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                                <i class="bi bi-columns"></i>
                            </a>
                            <div class="dropdown-menu dropdown-menu-end">
                                <div class="dropdown-item text-center">
                    ...
                    <div class="row gx-0 h-100">
                        <div class="col bg-light-theme text-center py-4">
                            ...
                            <div class="avatar avatar-100 coverimg mb-3 rounded">
                                <img src="https://getwindoors.com/html/assets/img/getwindoors-qr.png" alt="" class="w-100" />
                            </div>
                            <br>
                            <!-- <a class="btn btn-theme btn-md" href="https://getwindoors.com/html/payment.html">Pay online</a> -->
                        </div>
                        <div class="col position-relative text-white text-center">
                            <div class="coverimg position-absolute end-0 top-0 w-100 h-100">
                                <!-- <img src="https://getwindoors.com/html/assets/img/payment.png" alt=""> -->
                            </div>
                            <div class="row h-100">
                                <div class="col-12 align-self-center">
                                    ...
                                    <a class="btn btn-light btn-md p-0" href="finance-dashboard.html#">
                                        <!-- <img src="https://getwindoors.com/html/assets/img/Google-Pay-logo-1024x512.png" alt="" /> -->
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-check form-check-circle">
                                <input class="form-check-input" type="radio" name="priceupgrade" value="" id="priceupgrade1" checked>
                                <label class="form-check-label" for="priceupgrade1">
                                    <span class="h4">251.00 <small>USD</small></span><br />
                                    <span class="text-secondary small">5 Years <span class="text-green">13% Off</span></span>
                                </label>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-check form-check-circle">
                                <input class="form-check-input" type="radio" name="priceupgrade" value="" id="priceupgrade2">
                                <label class="form-check-label" for="priceupgrade2">
                                    <span class="h4">108.00 <small>USD</small></span><br />
                                    <span class="text-secondary small">2 Years <span class="text-green">10% Off</span></span>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="input-group border">
                                ...
                                <input type="text" class="form-control" placeholder="Coupon Code" value="13DISCNEW21">
                                <span class="input-group-text text-green"><i class="bi bi-patch-check h5"></i></span>
                            </div>
                        </div>
                        <div class="col-auto">
                            <a class="btn btn-theme btn-md" href="https://getwindoors.com/html/payment.html">Pay Now</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row mx-0">
                    ...
                    <div class="col-6 position-relative">
                        <figure class="coverimg position-absolute w-100 h-100 start-0 top-0 m-0">
                            <!-- <img src="https://getwindoors.com/html/assets/img/news-3.jpg" class="mw-100" alt="" /> -->
                        </figure>
                    </div>
                </div>
            </div>
