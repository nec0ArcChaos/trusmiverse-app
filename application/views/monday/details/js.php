...
<script>
    ...
    function save_add_sub_task() {
        ...
        let checklist_indicator = $("input[name='sub_type_indicator']").is(":checked");
        ...
        if (val_id_task == "") {
            ...
            } else if (checklist_indicator == true && val_sub_task_indicator == '') {
                $.confirm({
                    icon: 'fa fa-close',
                    title: 'Oops!',
                    theme: 'material',
                    type: 'red',
                    content: 'Oops, Indicator harus di isi',
                    buttons: {
                        close: {
                            actions: function(tutup) {}
                        },
            ...
            form_data_sub.append("id_mom", val_id_mom);
    ...
    function dt_sub_task_card(id_task) {
        ...
        $.ajax({
            ...
            for (let index = 0; index < response.data.length; index++) {
                $('#id_mom_text').val(response.data[0].id_mom);
                $('#id_mom').val(response.data[0].id_mom);
                                        ...
                                        <div class="row text-start">
                                            <div class="col-12 col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="hidden" name="id_mom" value="${response.data[index].id_mom}" id="id_mom_${response.data[index].id_mom}" class="form-control" readonly>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-12">
                                                <div class="mb-3">
                ...
                $.ajax({
                    ...
                    if (response.status == true) {
                        setTimeout(() => {
                            ...
                            $('#e_id_mom_text').text(response.detail.id_mom);
