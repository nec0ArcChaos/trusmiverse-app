                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-auto ms-auto ps-0">
                            <button type="button" class="btn btn-md btn-outline-success" onclick="list_verifikasi()">Verifikasi Perbaikan</button>
                            <button type="button" class="btn btn-md btn-outline-warning" onclick="list_perbaikan()">Proses Perbaikan</button>
                            <button type="button" class="btn btn-md btn-outline-info" onclick="list_deadline()">Deadline Perbaikan</button>
                            <button type="button" class="btn btn-md btn-outline-theme" data-bs-toggle="modal" data-bs-target="#modal_add_plan">Plan Gemba</button>
                            <button type="button" class="btn btn-md btn-outline-secondary" onclick="list_proses()">List Draft</button>
                        </div>
                    </div>
                </div>
                <div class="card-body">
...
<!-- Modal Add -->
<div class="modal fade" id="modal_add_plan" role="dialog">
                ...
                <div class="modal-body">
                    <div class="col-12 col-lg-12 col-xl-12 mb-4">
                        ...
                        <div class="row">
                                        ...
                                        <div class="form-floating">
                                            <select name="tipe_gemba" id="tipe_gemba" class="form-control">
                                                ...
                                                <?php foreach ($tipe as $row) : ?>
                                                    <option value="<?= $row->id ?>" data-department_id="<?= $row->department_id ?>"><?= $row->tipe_gemba ?></option>
                                                <?php endforeach; ?>
                                            </select>
                            ...
                            <div class="col-12 col-md-12 mb-2 d-none" id="lokasi_select_wrapper">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        ...
                                        <div class="form-floating">
                                            <select id="lokasi" name="lokasi" class="form-select border-start-0">
                                                <option value="">-- Pilih Project --</option>
                                                <?php foreach ($project_location as $p) : ?>
                                                    <option
                                                        value="<?= $p->project ?>"
                                                        data-lat="<?= $p->latitude ?>"
                            ...
                            <!-- INPUT TEXT (default tampil) -->
                            <div class="col-12 col-md-12 mb-2" id="lokasi_text_wrapper">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text text-theme bg-white border-end-0">
                            ...
                            <div class="col-12 col-md-12 mb-2">
                                <div class="form-group mb-3 position-relative check-valid">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text text-theme bg-white border-end-0"><i class="bi bi-file-earmark-word"></i></span>
                                        <div class="form-floating">
                                            <select name="dokumen" class="form-control" id="dokumen">
                                                <option value="#" selected disabled>-- Choose --</option>
                                            </select>
                                            <label>Dokumen atau SOP Pendukung</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <div class="form-floating">
                                            <select name="id_detail_pekerjaan[]" id="detail_pekerjaan" class="form-control ui search dropdown" multiple>
                                                <option value=" #" selected disabled>-- Pilih Tasklist --</option>
                                            </select>
...
<!-- Modal List Proses -->
<div class="modal fade" id="modal_list_proses" role="dialog">
...
<div class="modal fade" id="modal_list_verifikasi" role="dialog">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header row align-items-center">
                <div class="col-auto">
                ...
                <div class="col">
                    <h6 class="fw-medium mb-0" id="modalListVerifikasiLabel">List Verifikasi</h6>
                    <p class="text-secondary small">Verifikasi Gemba</p>
                </div>
                <div class="col-auto ps-0">
                    <div class="dropdown d-inline-block">
                        <a class="btn btn-link btn-square text-secondary dd-arrow-none dropdown-toggle" role="button" aria-expanded="false" data-bs-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <div class="col-12 col-lg-12 col-xl-12 col-xxl-12 position-relative column-set">
                    <div class="card border-0">
                        <div class="card-body">
                            <div class="" style="padding: 10px;">
                                <table id="dt_list_verifikasi" class="table table-striped dt-responsive" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>Id Genba</th>
                                            <th>Date Plan</th>
...
<div class="modal fade" id="modal_list_perbaikan" role="dialog">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header row align-items-center">
                <div class="col-auto">
                ...
                <div class="col">
                    <h6 class="fw-medium mb-0" id="modalListPerbaikanLabel">List Perbaikan</h6>
                    <p class="text-secondary small">Perbaikan Gemba</p>
                </div>
                <div class="col-auto ps-0">
                    <div class="dropdown d-inline-block">
                        <a class="btn btn-link btn-square text-secondary dd-arrow-none dropdown-toggle" role="button" aria-expanded="false" data-bs-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <div class="col-12 col-lg-12 col-xl-12 col-xxl-12 position-relative column-set">
                    <div class="card border-0">
                        <div class="card-body">
                            <div class="" style="padding: 10px;">
                                <table id="dt_list_perbaikan" class="table table-striped dt-responsive" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>Id Genba</th>
                                            <th>Date Plan</th>
...
<div class="modal fade" id="modal_list_deadline" role="dialog">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header row align-items-center">
                <div class="col-auto">
                ...
                <div class="col">
                    <h6 class="fw-medium mb-0" id="modalListdeadlineLabel">List Deadline</h6>
                    <p class="text-secondary small">Deadline Gemba</p>
                </div>
                <div class="col-auto ps-0">
                    <div class="dropdown d-inline-block">
                        <a class="btn btn-link btn-square text-secondary dd-arrow-none dropdown-toggle" role="button" aria-expanded="false" data-bs-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <div class="col-12 col-lg-12 col-xl-12 col-xxl-12 position-relative column-set">
                    <div class="card border-0">
                        <div class="card-body">
                            <div class="" style="padding: 10px;">
                                <table id="dt_list_deadline" class="table table-striped dt-responsive" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>Id Genba</th>
                                            <th>Date Plan</th>
...
<div class="modal fade" id="modalPerbaikanGemba" tabindex="-1">
    <div class="modal-dialog modal-fullscreen modal-dialog-scrollable">
        <div class="modal-content">

            <div class="modal-header">
                <h5 class="modal-title">Detail Perbaikan Gemba</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>

            <!-- WAJIB ADA -->
            <div class="modal-body">
                <form id="formPerbaikanGemba" enctype="multipart/form-data">

                    <!-- container dinamis -->
                    <div id="listPerbaikanContainer" class="row g-3"></div>
            ...
            <div class="modal-footer">
                ...
                <!-- <button type="button" class="btn btn-primary" id="btnSimpanPerbaikan">
          Simpan
        </button> -->
            </div>
...
<div class="modal fade" id="modalDeadlineGemba" tabindex="-1">
    <div class="modal-dialog modal-fullscreen modal-dialog-scrollable">
        <div class="modal-content">

            <div class="modal-header">
                <h5 class="modal-title">Detail Deadline Gemba</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>

            <!-- WAJIB ADA -->
            <div class="modal-body">
                <form id="formDeadlineGemba" enctype="multipart/form-data">

                    <!-- container dinamis -->
                    <div id="listDeadlineContainer" class="row g-3"></div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                <!-- <button type="button" class="btn btn-primary" id="btnSimpanDeadline">
          Simpan
        </button> -->
            </div>
...
<div class="modal fade" id="modalVerifikasiGemba" tabindex="-1">
    <div class="modal-dialog modal-fullscreen modal-dialog-scrollable">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">Detail Verifikasi Gemba</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>

            <!-- WAJIB ADA -->
            <div class="modal-body">
                <form id="formVerifikasiGemba" enctype="multipart/form-data">

                    <!-- container dinamis -->
                    <div id="listVerifikasiContainer" class="row g-3"></div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                <!-- <button type="button" class="btn btn-primary" id="btnSimpanVerifikasi">
          Simpan
        </button> -->
            </div>
...
<!-- Modal Proses Gemba -->
<div class="modal fade" id="modal_proses_gemba" role="dialog">
    <div class="modal-dialog modal-fullscreen modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header row align-items-center">
                <div class="col-auto">
                ...
                <div class="col">
                    <h6 class="fw-medium mb-0" id="modalProsesLabel">Proses</h6>
                    <p class="text-secondary small">Plan Genba</p>
                </div>
                <div class="col-auto ps-0">
                    <div class="dropdown d-inline-block">
            ...
            <div class="modal-body">
                ...
                <!-- <div id="list_detail_gemba" class="row" style="display: none;"></div> -->
...
<!-- Modal Edit Tgl Plan -->
<div class="modal fade" id="modal_edit_tgl_plan" role="dialog">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header row align-items-center">
                ...
                <div class="col">
                    <h6 class="fw-medium mb-0">Edit Tanggal Plan</h6>
                    <p class="text-secondary small" id="edit_tgl_id_label">ID Gemba</p>
                </div>
                <div class="col-auto ps-0">
                    <a class="btn btn-link btn-square text-secondary dd-arrow-none dropdown-toggle" role="button" data-bs-dismiss="modal" aria-label="Close">
                        <i class="bi bi-x-lg"></i>
                    </a>
                </div>
            </div>
            <div class="modal-body">
                <input type="hidden" id="edit_id_gemba">
                <div class="form-group mb-3">
                    <label class="small fw-semibold">Tanggal Plan Baru</label>
                    <input type="text" id="edit_tgl_plan" class="form-control" placeholder="Pilih Tanggal">
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-outline-secondary" data-bs-dismiss="modal">Batal</button>
                <button type="button" class="btn btn-sm btn-outline-theme" onclick="simpan_edit_tgl_plan()">Simpan</button>
            </div>
        </div>
    </div>
</div>
