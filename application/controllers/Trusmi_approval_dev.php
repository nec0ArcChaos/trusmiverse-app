...
class Trusmi_approval_dev extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('Model_trusmi_approval_dev', 'model_dev');
    ...
    {
        $data['pageTitle']        = "T-Approval DEV";
        $data['css']              = "trusmi_approval/css";
        $data['js']               = "trusmi_approval/js_dev";
        $data['content']          = "trusmi_approval/index_dev";
    ...
    public function dt_trusmi_approval()
    {
        ...
        $data['data'] = $this->model_dev->dt_trusmi_approval($id_status, $start, $end)->result();
    ...
    function resubmit()
    {
        ...
        $result['request_approval'] = $this->model_dev->save($request);
