...
class Dashboard_review_system extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('Model_dashboard_review_system', 'model');
    ...
    {
        $data['pageTitle']        = "Dashboard Review System";
        $data['css']              = "dashboard_review_system/css";
        $data['js']               = "dashboard_review_system/js";
        $data['content']          = "dashboard_review_system/index";
