...
class Ba_memo extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('model_ba_memo', 'model_rekap_absen');
    ...
    {
        $data['pageTitle']  = "BA Memo";
        $data['css']        = "ba_memo/css";
        $data['js']         = "ba_memo/js";
        $data['content']    = "ba_memo/index";
    ...
    public function get_rekap_absen()
    {
        ...
        $absensi        = $this->model_rekap_absen->get_absensi($start, $end, $company_id, $department_id, $employee_id, $sub_emp, $periode)->result();
    ...
    public function harus_hadir($company_id, $department_id, $employee_id, $periode)
    {
        $company_id     = ($company_id == 'undefined') ? $this->session->userdata('company_id') : $company_id;
        $department_id  = ($department_id == 'undefined') ? $this->session->userdata('department_id') : $department_id;
        $employee_id    = ($employee_id == 'undefined') ? $this->session->userdata('user_id') : $employee_id;
        ...
        if (!empty($_FILES['attachment']['tmp_name'])) {
            if (is_uploaded_file($_FILES['attachment']['tmp_name'])) {
                ...
                if (in_array($ext, $allowed)) {
                    ...
                    // $profile = "/opt/lampp/htdocs/apps/assets/harus_hadir/"; Change path after using cloud
