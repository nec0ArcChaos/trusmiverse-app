...
class Mom_khael extends CI_Controller
{
	function __construct()
	{
		...
		$this->load->model('Model_mom_khael', 'model');
	...
	function index()
	{
		$data['content'] 	= "mom_khael/index";
		$data['pageTitle'] 	= "Minutes of Meeting | New";
		$data['css'] 		= "mom_khael/css";
		$data['js'] 		= "mom_khael/js";
	...
	function resume()
	{
		$data['content'] 	= "mom_khael/resume/index";
		$data['pageTitle'] 	= "Minutes of Meeting";
		$data['css'] 		= "mom_khael/resume/css";
		$data['js'] 		= "mom_khael/resume/js";
		$data['karyawan']	= $this->model->get_employee();
		$data['pic']		= $this->model->get_employee();
		$data['kategori']	= $this->model->get_kategori_new2();
...
🔗 Detail : " . $mom['link'] . "";
	...
	// $this->load->view("mom_khael/print/print", $data);
	...
	function excel($id)
	{
		...
		$this->load->view("mom_khael/print/excel", $data);
	}
...
" . $plan['link'];
	...
	function excel_detail($start, $end)
	{
		...
		$this->load->view("mom_khael/print/excel_detail", $data);
	}
...
🔗 Detail : https://trusmiverse.com/apps/pr/mom_khael/$value->mom
