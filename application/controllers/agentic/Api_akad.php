...
class Api_akad extends CI_Controller
{
    function __construct()
    {
        ...
        $this->load->model("agentic/model_api_akad", 'model');
    ...
    function akad()
    {
        ...
        $response['detail'] = [
            'pemberkasan' => [
                'jumlah_berkas' => array_merge(
                $this->model->jumlah_berkas_bank($id_gm, $periode),
                    array('leadtime' => $this->model->leadtime_berkas_bank_lengkap($id_gm, $periode))
            ),
            ],
            'sp3k' => [
                'jumlah_sp3k' => array_merge(
                $this->model->jumlah_sp3k($id_gm, $periode),
                    array(
                    'leadtime' => $this->model->leadtime_sp3k($id_gm, $periode),
                    'usia_sp3k' => $this->model->usia_sp3k($id_gm, $periode)
                )
            ),
            ],
            'bangunan_dengan_progres_mencapai_30_persen' => $this->model->bangunan_under_30($id_gm, $periode),
            'customer_pelunasan_dp' => $this->model->pelunasan_dp($id_gm, $periode),
            'laporan_pemeriksaan_akhir' => $this->model->lpa($id_gm, $periode)
        ];
    ...
    function update_data_agentic()
    {
        ...
        $note = "Akad : " . $resume['akad']['actual'] . "/" . $resume['akad']['target'] . "";

        $this->db->trans_begin();

        // 1 KPI Data
        // Cek apakah data dengan id_gm sudah ada
        $query = $this->db->query("SELECT * FROM agentic.1_kpi_data WHERE type_agentic = 'akad' AND id_gm = '$id_gm' AND LEFT(periode, 7) = '$data[periode]'");
        if ($query->num_rows() > 0) {
            ...
            $update_data_kpi = [
                ...
                'target_value' => $resume['akad']['target_persentase'],
                'actual_value' => $resume['akad']['achieve_persentase'],
                'unit' => '',
                'note' => $note,
        ...
        if ($query_kpi_health->num_rows() > 0) {
            ...
            for ($i = 0; $i < COUNT($indikator_name); $i++) {
                ...
                if ($indikator_name[$i] == 'Jumlah Berkas Bank') {
                    $target_value = $detail['pemberkasan']['jumlah_berkas']['target_persentase'];
                    $actual_value = $detail['pemberkasan']['jumlah_berkas']['persentase_lengkap'];
                    $condition_rule = '=' . $detail['pemberkasan']['jumlah_berkas']['target_persentase'];
                    $note_rule = "(" . $detail['pemberkasan']['jumlah_berkas']['lengkap'] . "/" . $detail['pemberkasan']['jumlah_berkas']['total'] . ")";
                }
                else if ($indikator_name[$i] == 'Leadtime Berkas Bank') {
                    $target_value = $detail['pemberkasan']['jumlah_berkas']['target_persentase'];
                    $actual_value = $detail['pemberkasan']['jumlah_berkas']['leadtime']['persentase_ontime'];
                    $condition_rule = '=' . $detail['pemberkasan']['jumlah_berkas']['target_persentase'];
                    $note_rule = "(" . $detail['pemberkasan']['jumlah_berkas']['leadtime']['ontime'] . "/" . $detail['pemberkasan']['jumlah_berkas']['lengkap'] . ")";
                }
                else if ($indikator_name[$i] == 'Jumlah SP3K') {
                    $target_value = $detail['sp3k']['jumlah_sp3k']['target_persentase'];
                    $actual_value = $detail['sp3k']['jumlah_sp3k']['achieve_persentase'];
                    $condition_rule = '=' . $detail['sp3k']['jumlah_sp3k']['target_persentase'];
                    $note_rule = "(" . $detail['sp3k']['jumlah_sp3k']['actual'] . "/" . $detail['sp3k']['jumlah_sp3k']['target'] . ")";
                }
                else if ($indikator_name[$i] == 'Usia SP3K < 16 Hari') {
                    $target_value = $detail['sp3k']['jumlah_sp3k']['target_persentase'];
                    $actual_value = $detail['sp3k']['jumlah_sp3k']['usia_sp3k']['persentase_under_16_hari'];
                    $condition_rule = '= ' . $detail['sp3k']['jumlah_sp3k']['target_persentase'];
                    $note_rule = "(" . $detail['sp3k']['jumlah_sp3k']['usia_sp3k']['under_16_hari'] . "/" . $detail['sp3k']['jumlah_sp3k']['actual'] . ")";
                }
                else if ($indikator_name[$i] == 'Usia SP3K < 30 Hari') {
                    $target_value = $detail['sp3k']['jumlah_sp3k']['target_persentase'];
                    $actual_value = $detail['sp3k']['jumlah_sp3k']['usia_sp3k']['persentase_under_30_hari'];
                    $condition_rule = '= ' . $detail['sp3k']['jumlah_sp3k']['target_persentase'];
                    $note_rule = "(" . $detail['sp3k']['jumlah_sp3k']['usia_sp3k']['under_30_hari'] . "/" . $detail['sp3k']['jumlah_sp3k']['actual'] . ")";
                }
                else if ($indikator_name[$i] == 'Usia SP3K < 90 Hari') {
                    $target_value = $detail['sp3k']['jumlah_sp3k']['target_persentase'];
                    $actual_value = $detail['sp3k']['jumlah_sp3k']['usia_sp3k']['persentase_under_90_hari'];
                    $condition_rule = '= ' . $detail['sp3k']['jumlah_sp3k']['target_persentase'];
                    $note_rule = "(" . $detail['sp3k']['jumlah_sp3k']['usia_sp3k']['under_90_hari'] . "/" . $detail['sp3k']['jumlah_sp3k']['actual'] . ")";
                }
                else if ($indikator_name[$i] == 'Usia SP3K > 90 Hari') {
                    $target_value = $detail['sp3k']['jumlah_sp3k']['target_persentase'];
                    $actual_value = $detail['sp3k']['jumlah_sp3k']['usia_sp3k']['persentase_up_90_hari'];
                    $condition_rule = '= ' . $detail['sp3k']['jumlah_sp3k']['target_persentase'];
                    $note_rule = "(" . $detail['sp3k']['jumlah_sp3k']['usia_sp3k']['up_90_hari'] . "/" . $detail['sp3k']['jumlah_sp3k']['actual'] . ")";
                }
                else if ($indikator_name[$i] == 'Bangunan < 30%') {
                    $target_value = $detail['bangunan_dengan_progres_mencapai_30_persen']['target_persentase'];
                    $actual_value = $detail['bangunan_dengan_progres_mencapai_30_persen']['achieve_persentase'];
                    $condition_rule = '= ' . $detail['bangunan_dengan_progres_mencapai_30_persen']['target_persentase'];
                    $note_rule = "(" . $detail['bangunan_dengan_progres_mencapai_30_persen']['actual'] . "/" . $detail['bangunan_dengan_progres_mencapai_30_persen']['target'] . ")";
                }
                else if ($indikator_name[$i] == 'Pelunasan DP') {
                    $target_value = $detail['customer_pelunasan_dp']['target_persentase'];
                    $actual_value = $detail['customer_pelunasan_dp']['achieve_persentase'];
                    $condition_rule = '= ' . $detail['customer_pelunasan_dp']['target_persentase'];
                    $note_rule = "(" . $detail['customer_pelunasan_dp']['actual'] . "/" . $detail['customer_pelunasan_dp']['target'] . ")";
                }
                else if ($indikator_name[$i] == 'LPA') {
                    $target_value = $detail['laporan_pemeriksaan_akhir']['target_persentase'];
                    $actual_value = $detail['laporan_pemeriksaan_akhir']['achieve_persentase'];
                    $condition_rule = '= ' . $detail['laporan_pemeriksaan_akhir']['target_persentase'];
                    $note_rule = "(" . $detail['laporan_pemeriksaan_akhir']['actual'] . "/" . $detail['laporan_pemeriksaan_akhir']['target'] . ")";
                }
        ...
        if ($query_ringkasan_eks->num_rows() > 0) {
            ...
            foreach ($ringkasan_esklusif as $key => $value) {
                ...
                $insert_data_ringkasan_eks = [
                    'id' => $id_analysis,
                    'kpi_id' => $id_kpi,
                    'status_kpi' => $resume['akad']['actual'] >= $resume['akad']['target'] ? 'Ontime' : 'Delay',
                    'status_value' => $resume['akad']['actual'],
