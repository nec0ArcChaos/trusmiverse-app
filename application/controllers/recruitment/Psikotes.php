...
class Psikotes extends CI_Controller //Formulir Dokumen Karyawan
{
    ...
    function index()
    {
        ...
        $data['pageTitle']        = "Interview HR";
        $data['css']              = "recruitment/psikotes/css";
        $data['js']               = "recruitment/psikotes/js";
        $data['content']          = "recruitment/psikotes/index";
    ...
    function get_psikotes()
    {
        ...
        $data['psikotes_new'] = $this->model->detail_psikotes_new($id);
        echo json_encode($data);
    }
    function reset_tiu()
    {
    ...
    function save_status()
    {
        ...
        $psikotes2 = [
            ...
            'update_interview_hr_at' => date('Y-m-d H:i:s'),
            'update_interview_hr_by' => $this->session->userdata('user_id')
        ];
