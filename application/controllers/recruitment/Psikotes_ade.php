...
class Psikotes_ade extends CI_Controller //Formulir Dokumen Karyawan
{
    ...
    function index()
    {
        ...
        $data['css']              = "recruitment/psikotes_ade/css";
        $data['js']               = "recruitment/psikotes_ade/js";
        $data['content']          = "recruitment/psikotes_ade/index";
    ...
    function get_candidates()
    {
        ...
        $end = $_POST['end'];
        $id = $_POST['id'];
        $data['data'] = $this->model->get_candidates($start, $end, $id);
    ...
    function save_status()
    {
        ...
        if ($_POST['status'] == 3) {
            ...
            //     ];
            //     $this->db->where('application_id', $_POST['app_id']);
            //     $this->db->update('xin_job_applications', $update_xja);
            // }
        }
        echo json_encode($result);
    }
