...
class Trusmi_approval_handika extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('Model_trusmi_approval_handika', 'model');
    ...
    public function index()
    {
        ...
        $data['css']              = "trusmi_approval_handika/css";
        $data['js']               = "trusmi_approval_handika/js";
        $data['content']          = "trusmi_approval_handika/index";
    ...
    function verify_approval()
    {
        ...
        $data['pageTitle']        = "T-Approval";
        $data['css']              = "trusmi_approval_handika/css";
        $data['js']               = "trusmi_approval_handika/verify_approval_js";
        $data['content']          = "trusmi_approval_handika/verify_approval";
        $this->load->view('layout/main', $data);
    }
