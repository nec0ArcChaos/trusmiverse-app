...
class Mom_lutfie extends CI_Controller
{
	...
	function index()
	{
		$data['content'] 	= "mom_lutfie/index";
		$data['pageTitle'] 	= "Minutes of Meeting";
		$data['css'] 		= "mom_lutfie/css";
		$data['js'] 		= "mom_lutfie/js";
	...
	function resume()
	{
		$data['content'] 	= "mom_lutfie/resume/index";
		$data['pageTitle'] 	= "Minutes of Meeting";
		$data['css'] 		= "mom_lutfie/resume/css";
		$data['js'] 		= "mom_lutfie/resume/js";
		$data['karyawan']	= $this->model->get_employee();
		$data['pic']		= $this->model->get_employee();
...
🔗 Detail : " . $mom['link'] . "";
	...
	// $this->load->view("mom_lutfie/print/print", $data);
	...
	function excel($id)
	{
		...
		$this->load->view("mom_lutfie/print/excel", $data);
	}
...
" . $plan['link'];
	...
	function excel_detail($start, $end)
	{
		...
		$this->load->view("mom_lutfie/print/excel_detail", $data);
	}
