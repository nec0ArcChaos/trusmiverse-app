...
class Trusmi_wb_ade extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model("Model_trusmi_wb_ade", "model");
    ...
    public function index()
    {
        ...
        $data['js']               = "trusmi_wb/js_ade";
        $data['css']              = "trusmi_wb/css";
        $data['content']          = "trusmi_wb/index_ade";
        ...
        $arr_wb_pic = [];
        $get_pic_eskalasi = $this->db->query("SELECT user_id FROM xin_employees WHERE whistleblower = 1")->result();
    ...
    GROUP BY
        ...
        if ($data_wb['id_created_by'] == "8636") {
            ...
            $data_text = array(
                ...
                "phone" => "6285694447437", // Mas Lutfie
                "messageType" => "text",
                "body" => "🚨Alert!!! 
