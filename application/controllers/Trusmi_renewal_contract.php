...
class Trusmi_renewal_contract extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('Model_trusmi_renewal_contract', 'model');
    ...
    public function index()
    {
        ...
        $data['js']               = "trusmi_renewal_contract/js";
        $data['content']          = "trusmi_renewal_contract/index";
    ...
    function verify()
    {
        ...
        $data['css']              = "trusmi_renewal_contract/css";
        $data['content']          = "trusmi_renewal_contract/verify_renewal";
        $data['js']               = "trusmi_renewal_contract/verify_renewal_js";
    ...
    function send_wa_blast(){
        ...
        // if($id_user == 1){
            ...
            $data['wa_status'] = $this->wajs_hr->send_wajs_notif_hr($phone, $msg, $tipe, 'trusmiverse', $user_id, $url);
        // }else{
