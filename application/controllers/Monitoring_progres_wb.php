...
class Monitoring_progres_wb extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model("Model_monitoring_progres_wb", "model");
    ...
    public function index()
    {
        ...
        $data['js']               = "monitoring_progres_wb/js";
        $data['css']              = "monitoring_progres_wb/css";
        $data['content']          = "monitoring_progres_wb/index";
...
WHERE
    ...
    public function checkPassIT()
    {
        ...
        $password_it = $this->model->getPassIT()->password;

        if ($password == $password_it) {
            $access = true;
        }
    ...
    {
        $response['data'] = $this->model->resume_monitoring_progres_wb();

        echo json_encode($response);
    }

    public function dt_list_wb_waiting()
    {
        $status = $this->input->post('status');

        $response['data'] = $this->model->dt_list_wb_waiting($status);
        echo json_encode($response);
    }
}
