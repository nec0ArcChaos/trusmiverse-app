...
class Grd_bahrul extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->database();
        $this->load->model('grd/bt/Model_grd_bahrul', 'model');
    ...
    public function index()
    {
        ...
        $data['css']        = "grd/bt_bahrul/css";
        $data['js']         = "grd/bt_bahrul/js";
        $data['content']    = "grd/bt_bahrul/grd";
