        ...
        if ($this->model_activation->approve_activation($id)) {
            ...
            if (count($activations) >= $target) {
                $update_campaign = [
                    ...
                    'activation_approved_at' => date('Y-m-d H:i:s'),
                    'content_status' => '1',
                    'content_deadline' => date('Y-m-d 23:59:59', strtotime('+1 days')),
                ];
            ...
            if (count($activations) > 0) {
                $update_campaign['campaign_status'] = '3';
            } else {
                $update_campaign['campaign_status'] = '2';
            }

            $update_campaign['activation_actual'] = count($activations);
            $update_campaign['content_team'] = $content_team;
