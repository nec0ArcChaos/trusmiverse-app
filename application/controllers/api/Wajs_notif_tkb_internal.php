...
class Wajs_notif_tkb_internal extends CI_Controller{
    ...
    function __construct()
    {
        ...
        $this->load->model('Model_wajs_notif_tkb_internal', 'model');
    }
    ...
    public function register()
    {
        ...
        if ($user->registered == 1) {
            ...
            $this->db->update('xin_employees', ['wa_notif_retail' => 1]);
            $response = [
                'status' => 'success',
    ...
    public function update_log()
    {
        ...
        $update = $this->db->update('wa_notif_tkb_log', $data);
