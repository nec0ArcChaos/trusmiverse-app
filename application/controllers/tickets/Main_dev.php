...
class Main_dev extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('tickets/model_main_dev', 'model_main');
    ...
    public function view()
    {
        ...
        $data['content']          = "tickets/main_dev";
        $data['js']               = "tickets/_main_js_dev";
    ...
    {
        $type = $this->db->query("SELECT id AS id_category, `category`, `type` AS id_type FROM ticket_category ORDER BY category")->result();
        echo json_encode($type);
    }
    ...
    public function e_get_category()
    {
        ...
        $type = $this->db->query("SELECT id AS id_category, `category`, `type` AS id_type, sub_type AS id_sub_type FROM ticket_category $cond ORDER BY category")->result();
        echo json_encode($type);
    }
