...
class Trusmi_masa_kerja_engangement extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('Model_trusmi_masa_kerja_engangement', 'model');
    ...
    {
        $data['pageTitle']        = "T - Masa Kerja Engangement";
        $data['css']              = "trusmi_masa_kerja_engangement/css";
        $data['js']               = "trusmi_masa_kerja_engangement/js";
        $data['content']          = "trusmi_masa_kerja_engangement/index";
