...
class Master_jenis_biaya_old extends CI_Controller
{
	...
	function index()
	{
		...
		if (isset($user_id)) {
			...
			// $data['budget'] 		=  $this->model_master_jenis_biaya->get_budget();
	...
	function delete_jenis_biaya()
	{
		...
		$result['delete_jenis_biaya'] = $this->db->delete('e_eaf.e_jenis_biaya', array('id_jenis' => $id));
		echo json_encode($result);
	}
