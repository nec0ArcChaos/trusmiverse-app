...
class Dashboard_ade extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model("model_dashboard_ade", "model_dashboard");
    ...
    public function index()
    {
        ...
        $data['js']               = "dashboard/js_ade";
        $data['css']              = "dashboard/css";
        $data['content']          = "dashboard/index_ade";
    ...
    {
        die(date("Y-m-t", strtotime("2025-02")));

        $periode = '2025-02';

        // echo date('Y-m-01'); die;
        // echo strtotime($periode); die;
        $today = date("Y-m-01", strtotime($periode)); echo 'today: '.$today;
        echo '<br>';
        
        $start = date("Y-m-21", strtotime($today . " -1 months")); echo 'start: '.$start;
        echo '<br>';

        $end = date("Y-m-20", strtotime($periode)); echo 'end: '.$end;
    }
    ...
    public function resume_absen()
    {
        ...
        $response['total_hadir'] = $periode_cutoff['absensi']; // totalx
    ...
    // public function periode_cutoff($periode) // addnew cutoff
