...
class Trusmi_resignation_ade extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('Model_trusmi_resignation_ade', 'model');
    ...
    public function index()
    {
        ...
        $data['js']               = "trusmi_resignation/js_ade";
        $data['content']          = "trusmi_resignation/index_ade";
    ...
    {
        $contact_no = $this->model->get_contact_no(189);
    ...
    function detail_resignation()
    {
        ...
        $data['pageTitle']        = "T-Resignation";
        $data['css']              = "trusmi_resignation/css";
        $data['content']          = "trusmi_resignation/detail_resignation_ade";
        $data['js']               = "trusmi_resignation/detail_resignation_js_ade";
        $this->load->view('layout/main', $data);
    }
