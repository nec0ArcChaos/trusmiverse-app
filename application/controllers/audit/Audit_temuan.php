...
class Audit_temuan extends CI_Controller
{
	...
	function index()
	{
		$data['content'] 			= "audit_temuan/index";
		$data['pageTitle'] 			= "Audit Findings";
		$data['css'] 				= "audit_temuan/css";
		$data['js'] 				= "audit_temuan/js";
...
" . $dt['auditor'];
	...
	public function send_wa_temuan_manual($id_temuan)
	{
		$dt = $this->model->get_send_wa($id_temuan)->row_array();
