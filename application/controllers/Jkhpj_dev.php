...
class Jkhpj_dev extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model("model_jkhpj_dev", 'model');
    ...
    public function index()
    {
        ...
        $data['css']              = "jkhpj_dev/css";
        $data['content']          = "jkhpj_dev/index";
        $data['js']               = "jkhpj_dev/js";
    ...
    //     $data['css']              = "jkhpj_dev/css";
    //     $data['js']               = "jkhpj_dev/js";
    //     $data['content']          = "jkhpj_dev/list_task";
    ...
    public function list_task()
    {
        ...
        $data['css']              = "jkhpj_dev/css";
        $data['js']               = "jkhpj_dev/js";
        $data['content']          = "jkhpj_dev/list_task_kanban";
            ...
            if (!empty($_FILES['files']['tmp_name'])) {
                if (is_uploaded_file($_FILES['files']['tmp_name'])) {
                    ...
                    if (in_array($ext, $allowed)) {
                        ...
                        $profile = "/var/www/trusmiverse/files/jkhpj_dev/";
