...
class Model_trusmi_renewal_contract_ade extends CI_Model
{
    ...
    function list_renewal()
    {
        ...
        $query = "SELECT
                        ...
                        c.contract_end,
                        -- c.deadline,
                        (DATE(c.contract_end) - INTERVAL 21 DAY) AS deadline,
                        c.dept_head,
                        c.created_at,
                        c.status,
                        c.feedback,
                        ...
                        DATEDIFF(contract_end,CURRENT_DATE) AS sisa_hari,
						IF(DATEDIFF(contract_end,CURRENT_DATE) <= 21, 1, 0) AS wajib_feedback,
