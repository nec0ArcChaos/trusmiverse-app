...
class Model_trusmi_resignation_ade extends CI_Model
{
    ...
    public function dt_trusmi_resignation($start, $end, $user_role_id, $user_id)
    {
        ...
        $super_admin = [1, 2063, 61, 2903, 1, 979, 3388, 2951, 778];
    ...
    public function get_pic_clearance()
    {
        ...
        $query = "SELECT
                ...
                FROM
                    ...
                    -- 77 bu fani
                    LEFT JOIN xin_employees pic_bt_finance ON pic_bt_finance.user_id = 77
                GROUP BY
                    c.pic";
        return $this->db->query($query)->result();
    }
