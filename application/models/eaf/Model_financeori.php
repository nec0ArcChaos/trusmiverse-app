...
class Model_finance extends CI_Model
{
    ...
    function get_detail_list_approval_lpj($id)
    {
        return $this->db->query("SELECT
                                ...
                                FROM
                                    ...
                                    LEFT JOIN e_biaya ON e_biaya.id_biaya = e_detail_keperluan.id_biaya_lpj
                                    LEFT JOIN e_photo_acc ON e_photo_acc.id_pengajuan = e_pengajuan.id_pengajuan
        ...
        $query1      = "SELECT
                        ...
                        FROM
                            ...
                            LEFT JOIN ( 
                                ...
                                FROM e_approval WHERE `level` = 5 AND `status` IS NULL 
                            ...
                            LEFT JOIN ( SELECT id_approval, id_pengajuan, id_user_approval, note_approve, update_approve FROM e_approval WHERE `level` = 10 AND `status` = 'Approve' ) AS verify ON verify.id_pengajuan = e_pengajuan.id_pengajuan
                            LEFT JOIN (SELECT id_approval, id_pengajuan, id_user_approval, note_approve, update_approve FROM e_approval WHERE id_user_approval = 737 AND level is null ) AS fnc ON fnc.id_pengajuan = e_pengajuan.id_pengajuan
                            LEFT JOIN e_photo_acc ON e_photo_acc.id_pengajuan = e_pengajuan.id_pengajuan
                            LEFT JOIN e_jenis_biaya ON e_jenis_biaya.id_jenis = e_pengajuan.jenis
    ...
    function get_subbiaya($id)
    {
        return $this->db->query("SELECT
            e_jenis_biaya.id_jenis,
            CONCAT( e_jenis_biaya.jenis, ' (', e_m_akun.nama_akun, ')' ) AS jenis,
            e_jenis_biaya.id_tipe_biaya 
        FROM
            e_jenis_biaya
            JOIN e_m_akun ON e_jenis_biaya.id_akun = e_m_akun.id_akun 
        WHERE
    ...
    function get_subbiaya_all()
    {
        return $this->db->query("SELECT
            ...
            CONCAT(
                ...
                ' - ',
            IF
                ( e_jenis_biaya.id_user_approval = 61, 'Hendra Arya Cahyadi', `user`.employee_name ),
                ')' 
            ) AS jenis,
            e_jenis_biaya.id_tipe_biaya 
        FROM
            ...
            JOIN e_m_akun ON e_jenis_biaya.id_akun = e_m_akun.id_akun")->result();
    ...
    {
        return $this->db->query("SELECT id_biaya, budget FROM e_biaya WHERE id_biaya = '$id'")->row_array();
    }
    ...
    function get_approval_for_wa($id)
    {
        return $this->db->query("SELECT
                                ...
                                FROM
                                    ...
                                    LEFT JOIN e_approval ON e_approval.id_user_approval = 737 AND e_approval.`level` = 5
                                    AND e_approval.id_pengajuan = e_pengajuan.id_pengajuan
                                    JOIN `user` AS usr ON usr.id_user = e_approval.id_user
                                    LEFT JOIN hris.xin_employees AS apr ON apr.user_id = usr.id_hr
                                    JOIN hris.xin_employees AS emp ON emp.user_id = e_pengajuan.pengaju 
                                WHERE
                                    e_pengajuan.id_pengajuan = '$id' LIMIT 1")->row();
    }
    ...
    function get_lpj_for_wa($id)
    {
        return $this->db->query("SELECT
                                ...
                                FROM
                                    e_pengajuan AS lpj
                                    LEFT JOIN e_kategori AS kat ON lpj.id_kategori = kat.id_kategori
                                    LEFT JOIN e_header_lpj AS det ON det.id_lpj = lpj.id_pengajuan
                                    LEFT JOIN e_approval AS fin ON fin.id_pengajuan = lpj.id_pengajuan 
                                    AND fin.`level` = 5 
    ...
    function cek_lpj($id_lpj)
    {
        return $this->db->query("SELECT
                                ...
                                FROM
                                    e_pengajuan AS lpj 
                                    JOIN e_pengajuan AS aju ON aju.temp = lpj.id_pengajuan
                                    JOIN e_approval AS apr ON apr.id_pengajuan = lpj.id_pengajuan AND apr.`status` IS NULL
                                    JOIN e_jenis_biaya AS jns ON jns.id_jenis = aju.id_sub_biaya
                                    JOIN e_header_lpj as det_lpj ON det_lpj.id_lpj = lpj.id_pengajuan
                                    JOIN e_biaya AS bya ON bya.id_biaya = aju.id_biaya
                                    JOIN e_tipe_biaya AS tp ON tp.id_tipe_biaya = jns.id_tipe_biaya
                                WHERE
