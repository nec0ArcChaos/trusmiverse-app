...
class Model_budget extends CI_Model
{
    ...
    function insert_budget()
    {
        ...
        if ($_POST['nominal_budget1'] == '') {
            $nominal_budget1 = null;
        } else {
            $nom_budget1 = $_POST['nominal_budget1'];
            $nominal_budget1 = str_replace('.', '', $nom_budget1);
        }
        // if ($_POST['nominal_budget2'] == '') {
        //     $nominal_budget2 = null;
        // } else {
        //     $nom_budget2 = $_POST['nominal_budget2'];
        //     $nominal_budget2 = str_replace('.', '', $nom_budget2);
        // }
        ...
        if ($cek > 0) {
            $data1 = array(
                'budget_awal'    => $nominal_budget1,
                'budget'        => $nominal_budget1,
                // 'budget2'        => $nominal_budget2,
                'updated_at'    => $tanggal,
