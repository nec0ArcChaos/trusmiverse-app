...
class Model_main extends CI_Model
{
    ...
    public function get_ticket_uat($id_task, $id)
    {
        $query = "SELECT
                    CONCAT(xe.first_name,' ',xe.last_name) as requester,
                    t.id_task,
                    t.type,
                    t.task,
                    t.description,
                ...
                FROM
                    ticket_task t
                    JOIN xin_employees xe ON xe.user_id = $id 
                WHERE
                    id_task = '$id_task';";
